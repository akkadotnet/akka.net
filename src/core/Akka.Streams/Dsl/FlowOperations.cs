...
namespace Akka.Streams.Dsl
{
    public static class FlowOperations
    {
        ...
        {
            return (Flow<TIn, TOut, TMat>)InternalFlowOperations.TakeWhile(flow, predicate);
        }
        ...
        /// </summary> 
        public static Flow<TIn, Tuple<IEnumerable<TOut>, Source<TOut, Unit>>, TMat> PrefixAndTail<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, int n)
        {
            return (Flow<TIn, Tuple<IEnumerable<TOut>, Source<TOut, Unit>>, TMat>)InternalFlowOperations.PrefixAndTail(flow, n);
        }
        ...
        /// </summary>
        public static Flow<TIn, Source<TVal, TMat>, TMat> SplitWhen<TIn, TOut, TMat, TVal>(this Flow<TIn, TOut, TMat> flow, Predicate<TOut> predicate) where TVal : TOut
        {
            return (Flow<TIn, Source<TVal, TMat>, TMat>)InternalFlowOperations.SplitWhen<TOut, TMat, TVal>(flow, predicate);
        }
