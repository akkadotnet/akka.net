...
namespace Akka.Streams.Tests.Dsl
{
    ...
    {
        public class MultiplesOfTwo : Akka.TestKit.Xunit.v3.TestKit
        {
        ...
        public class IndexedStringPages : Akka.TestKit.Xunit.v3.TestKit
        {
        ...
        public class LinkedIntPages : Akka.TestKit.Xunit.v3.TestKit
        {
