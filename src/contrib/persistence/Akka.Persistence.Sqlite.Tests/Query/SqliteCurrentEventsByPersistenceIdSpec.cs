...
public class SqliteCurrentEventsByPersistenceIdSpec : CurrentEventsByPersistenceIdSpec
{
    ...
    public SqliteCurrentEventsByPersistenceIdSpec(ITestOutputHelper output) : base(Config(Counter.GetAndIncrement()),
        nameof(SqliteCurrentEventsByPersistenceIdSpec), output)
    {
