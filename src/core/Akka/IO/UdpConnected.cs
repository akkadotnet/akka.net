...
public class UdpConnected : ExtensionIdProvider<UdpConnectedExt>
{
    ...
    {
        /// <summary>
        ///     Creates a new send request to be executed via UDP socket to a addressed to an endpoint known by the connected UDP
        ///     actor.
        ...
        /// </summary>
        /// <param name="payload">Binary payload to be send.</param>
        public static Send Create(ByteString payload)
        {
            return new Send(payload, NoAck.Instance);
        }
    }
...
public class UdpConnectedExt : IOExtension, INoSerializationVerificationNeeded
{
    ...
    public UdpConnectedExt(ExtendedActorSystem system, UdpSettings settings)
    {
        ...
        Manager = system.SystemActorOf(
            Props.Create(() => new UdpConnectedManager(this)).WithDeploy(Deploy.Local),
            "IO-UDP-CONN");
    }
