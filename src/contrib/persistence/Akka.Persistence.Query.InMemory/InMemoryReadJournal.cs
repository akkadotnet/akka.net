    ...
    IAllEventsQuery
{
    ...
    public Source<EventEnvelope, NotUsed> AllEvents(Offset offset = null)
    {
        ...
        return Source.ActorPublisher<EventEnvelope>(AllEventsPublisher.Props(checked((int)seq.Value), _refreshInterval,
                _maxBufferSize, _writeJournalPluginId))
    ...
    public Source<EventEnvelope, NotUsed> CurrentAllEvents(Offset offset)
    {
        ...
        return Source.ActorPublisher<EventEnvelope>(AllEventsPublisher.Props(checked((int)seq.Value), null,
                _maxBufferSize, _writeJournalPluginId))
            .MapMaterializedValue(_ => NotUsed.Instance)
    ...
    public Source<EventEnvelope, NotUsed> CurrentEventsByPersistenceId(string persistenceId, long fromSequenceNr,
        long toSequenceNr)
    {
        return Source.ActorPublisher<EventEnvelope>(EventsByPersistenceIdPublisher.Props(persistenceId,
                fromSequenceNr, toSequenceNr, null, _maxBufferSize, _writeJournalPluginId))
            .MapMaterializedValue(_ => NotUsed.Instance)
    ...
    public Source<EventEnvelope, NotUsed> CurrentEventsByTag(string tag, Offset offset)
    {
        ...
        return Source.ActorPublisher<EventEnvelope>(EventsByTagPublisher.Props(tag, checked((int)seq.Value),
                int.MaxValue, null, _maxBufferSize, _writeJournalPluginId))
            .MapMaterializedValue(_ => NotUsed.Instance)
    ...
    ///     <para>
    ///         You can retrieve a subset of all events by specifying <paramref name="fromSequenceNr" /> and
    ...
    {
        return Source.ActorPublisher<EventEnvelope>(EventsByPersistenceIdPublisher.Props(persistenceId,
                fromSequenceNr, toSequenceNr, _refreshInterval, _maxBufferSize, _writeJournalPluginId))
            .MapMaterializedValue(_ => NotUsed.Instance)
    ...
    ///     <para></para>
    ///     In addition to the <paramref name="offset" /> the <see cref="EventEnvelope" /> also provides `persistenceId` and
    ///     `sequenceNr`
    ...
    public Source<EventEnvelope, NotUsed> EventsByTag(string tag, Offset offset)
    {
        ...
        return Source.ActorPublisher<EventEnvelope>(EventsByTagPublisher.Props(tag, checked((int)seq.Value),
                int.MaxValue, _refreshInterval, _maxBufferSize, _writeJournalPluginId))
            .MapMaterializedValue(_ => NotUsed.Instance)
