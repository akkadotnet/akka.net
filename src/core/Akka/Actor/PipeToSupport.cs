...
public static class PipeToSupport
{
    ...
    /// <param name="sender">
    ///     The IActorRef that will be used as the sender of the result. Defaults to
    ///     <see cref="ActorRefs.Nobody" />
    /// </param>
    ...
    {
        return PipeTo(taskToPipe, recipient, false, sender, success, failure);
    }
