...
public static class SourceOperations
{
    ...
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> Recover<TOut, TMat>(this Source<TOut, TMat> flow,
    ...
    ///     behave exactly the same as  <see cref="RecoverWithRetries{TOut,TMat}" />.
    ///     <para>
    ///         Since the underlying failure signal onError arrives out-of-band, it might jump over existing elements.
    ///         This stage can recover the failure signal, but not the skipped elements, which will be dropped.
    ///     </para>
    ...
    /// <summary>
    ///     While similar to <see cref="Recover{TOut,TMat}" /> this stage can be used to transform an error signal to a
    ...
    ///     should be applied
    /// </param>
    public static Source<TOut, TMat> SelectError<TOut, TMat>(this Source<TOut, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat> SelectMany<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> SelectAsync<TIn, TOut, TMat>(this Source<TIn, TMat> flow, int parallelism,
    ...
    /// <param name="asyncMapper">TBD</param>
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> SelectAsyncUnordered<TIn, TOut, TMat>(this Source<TIn, TMat> flow, int parallelism,
        Func<TIn, Task<TOut>> asyncMapper)
    {
    ...
    ///     </para>
    ///     <seealso cref="Limit{T, TMat}(Source{T, TMat}, long)" />
    ///     <seealso cref="LimitWeighted{T, TMat}(Source{T, TMat}, long, Func{T, long})" />
    /// </summary>
    /// <typeparam name="TOut">TBD</typeparam>
    /// <typeparam name="TMat">TBD</typeparam>
    /// <param name="flow">TBD</param>
    ...
    public static Source<TOut2, TMat> Collect<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat> Scan<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow, TOut2 zero,
    ...
    /// <param name="scan">TBD</param>
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat> ScanAsync<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow, TOut2 zero,
    ...
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat> Aggregate<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow, TOut2 zero,
    ...
    /// </exception>
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> Intersperse<TOut, TMat>(this Source<TOut, TMat> flow, TOut start, TOut inject,
        TOut end)
    {
    ...
    /// </exception>
    /// <returns>TBD</returns>
    public static Source<IEnumerable<TOut>, TMat> GroupedWithin<TOut, TMat>(this Source<TOut, TMat> flow, int n,
        TimeSpan timeout)
    {
    ...
    /// <returns>TBD</returns>
    public static Source<IEnumerable<TOut>, TMat> GroupedWeightedWithin<TOut, TMat>(this Source<TOut, TMat> flow,
        long maxWeight, TimeSpan interval, Func<TOut, long> costFn)
    {
        return (Source<IEnumerable<TOut>, TMat>)InternalFlowOperations.GroupedWeightedWithin(flow, maxWeight,
            int.MaxValue, interval, costFn);
    }
    ...
    /// <returns>TBD</returns>
    public static Source<IEnumerable<TOut>, TMat> GroupedWeightedWithin<TOut, TMat>(this Source<TOut, TMat> flow,
        long maxWeight, int maxNumber, TimeSpan interval, Func<TOut, long> costFn)
    {
        return (Source<IEnumerable<TOut>, TMat>)InternalFlowOperations.GroupedWeightedWithin(flow, maxWeight, maxNumber,
            interval, costFn);
    }
    ...
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> Delay<TOut, TMat>(this Source<TOut, TMat> flow, TimeSpan of,
    ...
    ///     be different than the input type. See <see cref="Conflate{T,TMat}" /> for a simpler version that does not change
    ///     types.
    ...
    /// <returns>TBD</returns>
    public static Source<TSeed, TMat> ConflateWithSeed<TOut, TMat, TSeed>(this Source<TOut, TMat> flow,
    ...
    ///     <see cref="ConflateWithSeed{T,TMat,TSeed}" />
    ...
    /// <param name="aggregate">Takes the currently aggregated value and the current pending element to produce a new aggregate</param>
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> Conflate<TOut, TMat>(this Source<TOut, TMat> flow,
    ...
    /// <param name="aggregate">Takes the currently batched value and the current pending element to produce a new aggregate</param>
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat> BatchWeighted<TOut, TOut2, TMat>(this Source<TOut, TMat> flow, long max,
    ...
    /// </param>
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat> Expand<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow,
    ...
    /// <param name="strategy">Strategy that is used when incoming elements cannot fit inside the buffer</param>
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> Buffer<TOut, TMat>(this Source<TOut, TMat> flow, int size,
    ...
    public static Source<TOut2, TMat> Transform<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow,
    ...
    /// <param name="n">TBD</param>
    /// <returns>TBD</returns>
    public static Source<(IImmutableList<TOut>, Source<TOut, NotUsed>), TMat> PrefixAndTail<TOut, TMat>(
        this Source<TOut, TMat> flow, int n)
    {
        return (Source<(IImmutableList<TOut>, Source<TOut, NotUsed>), TMat>)InternalFlowOperations.PrefixAndTail(flow,
            n);
    }
    ...
    /// <returns>TBD</returns>
    public static SubFlow<TOut, TMat, IRunnableGraph<TMat>> GroupBy<TOut, TMat, TKey>(this Source<TOut, TMat> flow,
    ...
    ///     <see cref="SplitWhen{TOut,TMat}(Source{TOut,TMat},SubstreamCancelStrategy,Func{TOut,bool})" />
    ...
    /// <param name="predicate">TBD</param>
    /// <returns>TBD</returns>
    public static SubFlow<TOut, TMat, IRunnableGraph<TMat>> SplitWhen<TOut, TMat>(this Source<TOut, TMat> flow,
    ...
    ///     It is important to note that the substreams also propagate back-pressure as
    ///     any other stream, which means that blocking one substream will block the
    ///     <see cref="SplitAfter{TOut,TMat}(Source{TOut,TMat},SubstreamCancelStrategy,Func{TOut,bool})" />
    ...
    /// <param name="predicate">TBD</param>
    /// <returns>TBD</returns>
    public static SubFlow<TOut, TMat, IRunnableGraph<TMat>> SplitAfter<TOut, TMat>(this Source<TOut, TMat> flow,
        SubstreamCancelStrategy substreamCancelStrategy, Func<TOut, bool> predicate)
    {
    ...
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat> ConcatMany<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow,
    ...
    /// <param name="flatten">TBD</param>
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat> MergeMany<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow, int breadth,
        Func<TOut1, IGraph<SourceShape<TOut2>, TMat>> flatten)
    {
    ...
    /// <returns>TBD</returns>
    public static Source<TInjected, TMat> KeepAlive<TOut, TInjected, TMat>(this Source<TOut, TMat> flow,
    ...
    /// </exception>
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> Throttle<TOut, TMat>(this Source<TOut, TMat> flow, int elements, TimeSpan per,
    ...
    /// <param name="mode">TBD</param>
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> Throttle<TOut, TMat>(this Source<TOut, TMat> flow, int cost, TimeSpan per,
        int maximumBurst, Func<TOut, int> calculateCost, ThrottleMode mode)
    {
    ...
    /// <param name="that">TBD</param>
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> AlsoTo<TOut, TMat>(this Source<TOut, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> AlsoTo<TOut, TMat>(this Source<TOut, TMat> flow,
        IGraph<SinkShape<TOut>, TMat> that, bool propagateFailure)
    {
    ...
    ///     <para>
    ///         Cancels when downstream cancels; Note that failures of the <paramref name="action" /> delegate will not cause
    ///         cancellation
    ///     </para>
    /// </summary>
    /// <typeparam name="TOut">TBD</typeparam>
    ...
    {
        return (Source<TOut, TMat>)InternalFlowOperations.WireTap(flow, action);
    }
    ...
    /// </summary>
    public static Source<TOut, TMat> WireTap<TOut, TMat>(this Source<TOut, TMat> flow,
        IGraph<SinkShape<TOut>, TMat> that)
    {
        return (Source<TOut, TMat>)InternalFlowOperations.WireTap(flow, that);
    }
    ...
    ///     </para>
    ///     <para>
    ///         It is similar to <seealso cref="AlsoToMaterialized{TOut,TMat,TMat2,TMat3}" /> which does backpressure instead
    ///         of dropping elements.
    ///     </para>
    ///     It is recommended to use the internally optimized <seealso cref="Keep.Left{TLeft,TRight}" /> and
    ///     <seealso cref="Keep.Right{TLeft,TRight}" /> combiners
    ///     where appropriate instead of manually writing functions that pass through one of the values.
    /// </summary>
    public static Source<TOut, TMat3> WireTapMaterialized<TOut, TMat, TMat2, TMat3>(this Source<TOut, TMat> flow,
        IGraph<SinkShape<TOut>, TMat2> that, Func<TMat, TMat2, TMat3> materializerFunction)
    {
        return (Source<TOut, TMat3>)InternalFlowOperations.WireTapMaterialized(flow, that, materializerFunction);
    }
    ...
    public static Source<TOut, TMat3> DivertToMaterialized<TOut, TMat, TMat2, TMat3>(
        ...
        Func<TMat, TMat2, TMat3> materializerFunction)
    {
        return (Source<TOut, TMat3>)InternalFlowOperations.DivertToMaterialized(flow, that, when, materializerFunction);
    }
    ...
    /// <param name="that">TBD</param>
    /// <param name="when">TBD</param>
    public static Source<TOut, TMat> DivertTo<TOut, TMat>(this Source<TOut, TMat> flow,
        IGraph<SinkShape<TOut>, TMat> that, Func<TOut, bool> when)
    {
        return (Source<TOut, TMat>)InternalFlowOperations.DivertTo(flow, that, when);
    }
    ...
    /// <param name="materializerFunction">TBD</param>
    /// <returns>TBD</returns>
    public static Source<TOut, TMat2> WatchTermination<TOut, TMat, TMat2>(this Source<TOut, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> Log<TOut, TMat>(this Source<TOut, TMat> flow, string name,
    ...
    /// <returns>TBD</returns>
    public static Source<(T1, T2), TMat> Zip<T1, T2, TMat>(this Source<T1, TMat> flow,
    ...
    /// <param name="combine">TBD</param>
    /// <returns>TBD</returns>
    public static Source<T3, TMat> ZipWith<T1, T2, T3, TMat>(this Source<T1, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Source<T2, TMat> Interleave<T1, T2, TMat>(this Source<T1, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat> Merge<TOut1, TOut2, TMat>(this Source<TOut1, TMat> flow,
    ...
    /// <param name="combine">TBD</param>
    /// <returns>TBD</returns>
    public static Source<TOut2, TMat3> MergeMaterialized<TOut1, TOut2, TMat, TMat2, TMat3>(
        this Source<TOut1, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> MergeSorted<TOut, TMat>(this Source<TOut, TMat> flow,
    ...
    /// <param name="other">TBD</param>
    /// <returns>TBD</returns>
    public static Source<TOut, TMat> Concat<TOut, TMat>(this Source<TOut, TMat> flow,
        IGraph<SourceShape<TOut>, TMat> other)
    {
    ...
    /// <summary>
    ///     Combines the given <see cref="Source{TOut, TMat}" /> to this <see cref="Source{TOut,TMat}" /> with fan-in strategy
    ///     like <see cref="Merge{TIn,TOut}" /> or <see cref="Concat{TIn,TOut}" /> and returns <see cref="Source{TOut,TMat}" />
    ...
    /// <returns>TBD</returns>
    public static Source<TOut2, TMatOut> CombineMaterialized<T, TOut2, TMat1, TMat2, TMatOut>(
        this Source<T, TMat1> flow, Source<T, TMat2> other,
    ...
    {
        return (Source<T, TMat>)InternalFlowOperations.OrElse(flow, secondary);
    }
    ...
    /// <returns>TBD</returns>
    public static Source<T, TMat3> OrElseMaterialized<T, TMat, TMat2, TMat3>(this Source<T, TMat> flow,
        IGraph<SourceShape<T>, TMat2> secondary, Func<TMat, TMat2, TMat3> materializedFunction)
    {
        return (Source<T, TMat3>)InternalFlowOperations.OrElseMaterialized(flow, secondary, materializedFunction);
    }
    ...
    {
        return new SourceWithContext<TOut, TCtx, TMat>(flow.Select(x => (x, fn(x))));
    }
    ...
    {
        return (Source<T, TMat>)InternalFlowOperations.Watch(flow, actorRef);
    }
    ...
    /// </summary>
    /// <param name="source">The previous <see cref="Source{TOut,TMat}" /> stage in this stream.</param>
    /// <param name="onItemUpdated">
    ///     A <see cref="Action{T,T}" /> function that allows the stage to perform clean-up operations when the previously
    ///     repeated
