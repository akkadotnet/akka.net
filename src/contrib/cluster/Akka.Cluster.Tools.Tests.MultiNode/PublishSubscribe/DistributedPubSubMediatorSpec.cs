...
public class DistributedPubSubMediatorSpec : MultiNodeClusterSpec
{
    ...
    public void DistributedPubSubMediator_must_keep_track_of_added_users()
    {
        Within(TimeSpan.FromSeconds(15), () =>
        {
            ...
            RunOn(() => { AwaitCount(3); }, _first, _second);
            ...
            RunOn(() => { AwaitCount(4); }, _first, _second);
    ...
    public void DistributedPubSubMediator_must_replicate_users_to_new_node()
    {
        Within(TimeSpan.FromSeconds(20), () =>
        {
            ...
            RunOn(() => { ChatUser("u5").Tell(new Whisper("/user/u4", "go")); }, _third);
    ...
    public void DistributedPubSubMediator_must_keep_track_of_removed_users()
    {
        Within(TimeSpan.FromSeconds(15), () =>
        {
            ...
            RunOn(() => { Mediator.Tell(new Remove("/user/u6")); }, _first);
            AwaitCount(5);
    ...
    public void DistributedPubSubMediator_must_remove_terminated_users()
    {
        ...
        {
            RunOn(() => { ChatUser("u3").Tell(PoisonPill.Instance); }, _second);
    ...
    public void DistributedPubSubMediator_must_publish()
    {
        Within(TimeSpan.FromSeconds(15), () =>
        {
            ...
            RunOn(() => { ChatUser("u5").Tell(new Talk("/user/u7", "hi")); }, _third);
            ...
            RunOn(() => { ExpectNoMsg(TimeSpan.FromSeconds(2)); }, _third);
    ...
    public void DistributedPubSubMediator_must_publish_to_topic()
    {
        Within(TimeSpan.FromSeconds(15), () =>
        {
            ...
            RunOn(() => { ChatUser("u5").Tell(new Shout("topic1", "hello all")); }, _third);
    ...
    public void DistributedPubSubMediator_must_demonstrate_usage_of_Publish()
    {
        Within(TimeSpan.FromSeconds(15), () =>
        {
            RunOn(() => { Sys.ActorOf(Props.Create<Subscriber>(), "subscriber1"); }, _first);
    ...
    public void DistributedPubSubMediator_must_demonstrate_usage_of_Send()
    {
        Within(TimeSpan.FromSeconds(15), () =>
        {
            RunOn(() => { Sys.ActorOf(Props.Create<Destination>(), "destination"); }, _first);

            RunOn(() => { Sys.ActorOf(Props.Create<Destination>(), "destination"); }, _second);
    ...
    public void DistributedPubSubMediator_must_SendAll_to_all_other_nodes()
    {
        Within(TimeSpan.FromSeconds(15), () =>
        {
            ...
            RunOn(() => { ChatUser("u5").Tell(new TalkToOthers("/user/u11", "hi")); }, _third);
    ...
    public void DistributedPubSubMediator_must_send_one_message_to_each_group()
    {
        Within(TimeSpan.FromSeconds(20), () =>
        {
            ...
            RunOn(() => { ChatUser("u12").Tell(new ShoutToGroup("topic2", "hi")); }, _first);
    ...
    public void DistributedPubSubMediator_must_transfer_delta_correctly()
    {
        ...
        RunOn(() =>
        {
            Mediator.Tell(new Status(ImmutableDictionary<Address, long>.Empty, false));
        ...
        RunOn(() =>
        {
            for (var i = 1; i <= many; i++) Mediator.Tell(new Put(CreateChatUser("u" + (1000 + i))));
            ...
            Mediator.Tell(new Status(versions1, false));
            var deltaBuckets2 = ExpectMsg<Delta>().Buckets;
            deltaBuckets2.Sum(x => x.Content.Count).Should().Be(500);

            Mediator.Tell(new Status(
                versions1.SetItems(deltaBuckets2.ToImmutableDictionary(b => b.Owner, b => b.Version)), false));
    ...
    public class Sender : UntypedActor
    {
        ...
        protected override void OnReceive(object message)
        {
            ...
            if (str != null) _mediator.Tell(new Send("/user/destination", str.ToUpperInvariant(), true));
        }
    }
    ...
    protected DistributedPubSubMediatorSpec(DistributedPubSubMediatorSpecConfig config) : base(config,
        typeof(DistributedPubSubMediatorSpec))
    {
        _first = config.First;
