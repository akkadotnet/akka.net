...
/// <summary>
///     This class represents a configuration object used in the deployment of an
///     <see cref="Akka.Actor.ActorBase">actor</see>.
/// </summary>
public class Deploy : IEquatable<Deploy>, ISurrogated
{
    ...
    ///     The <see cref="Akka.Routing.RouterConfig" /> used to configure the new
    ///     <see cref="Akka.Actor.Deploy" />.
    /// </param>
