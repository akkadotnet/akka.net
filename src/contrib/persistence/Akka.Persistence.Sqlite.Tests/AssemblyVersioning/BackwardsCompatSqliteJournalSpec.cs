...
{
    public BackwardsCompatSqliteJournalSpec(ITestOutputHelper output) : base(
        CreateSpecConfig(@"Filename=file:AssemblyVersioning/samples/memdb-journal-1-v123-altered.db;"),
