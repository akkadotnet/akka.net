...
internal abstract class TcpHandlers : CommonHandlers
{
    ...
    protected override void RegisterListener(IChannel channel, IHandleEventListener listener, object msg,
...
internal sealed class TcpServerHandler : TcpHandlers
{
    ...
    public TcpServerHandler(DotNettyTransport transport, ILoggingAdapter log,
...
internal sealed class TcpAssociationHandle : AssociationHandle
{
    ...
    public TcpAssociationHandle(Address localAddress, Address remoteAddress, DotNettyTransport transport,
        IChannel channel)
