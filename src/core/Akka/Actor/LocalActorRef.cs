...
public class LocalActorRef : ActorRefWithCell, ILocalRef
{
    ...
    public override ICell Underlying => Cell;

    /// <inheritdoc />
    public ActorCell Cell { get; }

    /// <inheritdoc cref="IActorRefProvider" />
    public override IActorRefProvider Provider => Cell.SystemImpl.Provider;


    public override IInternalActorRef Parent => Cell.Parent;


    public override IEnumerable<IActorRef> Children => Cell.GetChildren();
