...
public class Udp : ExtensionIdProvider<UdpExt>
{
    ...
    public abstract class Command : Message
    {
        ...
        ///     TBD
        /// </summary>
        public object FailureMessage => _failureMessage = _failureMessage ?? new CommandFailed(this);
    }
    ...
    public sealed class Send : Command
    {
        ...
        /// <param name="ack">
        ///     Acknowledgement send back to the sender, once <paramref name="payload" /> has been send through a
        ///     socket.
        /// </param>
    ...
    public sealed class Bind : Command
    {
        ...
        public override string ToString()
        {
            return $"Bind(addr: {LocalAddress}, handler: {Handler})";
        }
    }
    ...
    public sealed class Received : Event
    {
        ...
        public override string ToString()
        {
            return $"Received(bytes: {Data.Count}, from: {Sender})";
        }
    }
    ...
    public sealed class Bound : Event
    {
        ...
        public override string ToString()
        {
            return $"Bound(local: {LocalAddress})";
        }
    }
    ...
    public UdpExt(ExtendedActorSystem system, UdpSettings settings)
    {
        ...
        if (bufferPoolConfig.IsNullOrEmpty())
            throw new ConfigurationException(
                $"Cannot retrieve UDP buffer pool configuration: {settings.BufferPoolConfigPath} configuration node not found");

        Setting = settings;
        Manager = system.SystemActorOf(
            Props.Create(() => new UdpManager(this)).WithDeploy(Deploy.Local),
            "IO-UDP-FF");
