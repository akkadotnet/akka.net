...
public abstract partial class TestKitBase
{
    /// <summary>
    ///     <para>
    ///         Await until the given assertion does not throw an exception or the timeout
    ///         expires, whichever comes first. If the timeout expires the last exception
    ///         is thrown.
    ///     </para>
    ///     <para>
    ///         The action is called, and if it throws an exception the thread sleeps
    ///         the specified interval before retrying.
    ///     </para>
    ///     <para>
    ...
    ///     </para>
    ///     <para>
    ///         Note that the timeout is scaled using <see cref="Dilated" />,
