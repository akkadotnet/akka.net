...
public sealed class ShardedDaemonProcessSettings
{
    ...
    private ShardedDaemonProcessSettings Copy(TimeSpan? keepAliveInterval = null,
        ClusterShardingSettings? shardingSettings = null, string? role = null)
    {
        return new ShardedDaemonProcessSettings(keepAliveInterval ?? KeepAliveInterval,
            shardingSettings ?? ShardingSettings, role ?? Role);
    }
    ...
    {
        return Copy(shardingSettings: shardingSettings);
    }
