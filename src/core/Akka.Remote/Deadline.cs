...
namespace Akka.Remote
{
    ...
    public sealed class Deadline : IEquatable<Deadline>
    {
        ...
        /// <inheritdoc/>
        public bool Equals(Deadline other) => When.Equals(other.When);

        public override bool Equals(object o) => o is Deadline deadline && Equals(deadline);
        ...
        public static Deadline operator +(Deadline deadline, TimeSpan duration) => new Deadline(deadline.When.Add(duration));
