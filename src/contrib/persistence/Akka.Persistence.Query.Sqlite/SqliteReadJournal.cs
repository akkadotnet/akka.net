...
{
    public class SqliteReadJournal : IReadJournal,
    ...
    {
        public static string Identifier = "akka.persistence.query.journal.sqlite";
        ...
        public Source<string, Unit> AllPersistenceIds => 
            Source.ActorPublisher<string>(AllPersistenceIdsPublisher.Props(true, _maxBufferSize, _writeJournalPluginId))
            .MapMaterializedValue(_ => Unit.Instance)
            .Named("AllPersistenceIds") as Source<string, Unit>;
        ...
        public Source<string, Unit> CurrentPersistenceIds => 
            Source.ActorPublisher<string>(AllPersistenceIdsPublisher.Props(false, _maxBufferSize, _writeJournalPluginId))
            .MapMaterializedValue(_ => Unit.Instance)
            .Named("CurrentPersistenceIds") as Source<string, Unit>;
        ...
        public Source<EventEnvelope, Unit> EventsByPersistenceId(string persistenceId, long fromSequenceNr, long toSequenceNr) =>
                Source.ActorPublisher<EventEnvelope>(EventsByPersistenceIdPublisher.Props(persistenceId, fromSequenceNr, toSequenceNr, _refershInterval, _maxBufferSize, _writeJournalPluginId))
                    .MapMaterializedValue(_ => Unit.Instance)
                    .Named("EventsByPersistenceId-" + persistenceId) as Source<EventEnvelope, Unit>;
        ...
        /// </summary>
        public Source<EventEnvelope, Unit> CurrentEventsByPersistenceId(string persistenceId, long fromSequenceNr, long toSequenceNr) =>
                Source.ActorPublisher<EventEnvelope>(EventsByPersistenceIdPublisher.Props(persistenceId, fromSequenceNr, toSequenceNr, null, _maxBufferSize, _writeJournalPluginId))
                    .MapMaterializedValue(_ => Unit.Instance)
                    .Named("CurrentEventsByPersistenceId-" + persistenceId) as Source<EventEnvelope, Unit>;
        ...
        public Source<EventEnvelope, Unit> EventsByTag(string tag, long offset) =>
            Source.ActorPublisher<EventEnvelope>(EventsByTagPublisher.Props(tag, offset, long.MaxValue, _refershInterval, _maxBufferSize, _writeJournalPluginId))
                .MapMaterializedValue(_ => Unit.Instance)
                .Named("EventsByTag-" + tag) as Source<EventEnvelope, Unit>;
