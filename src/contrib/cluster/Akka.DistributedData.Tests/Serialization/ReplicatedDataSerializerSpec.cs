...
public class ReplicatedDataSerializerSpec : TestKit.Xunit2.TestKit
{
    ...
    public ReplicatedDataSerializerSpec(ITestOutputHelper output) : base(BaseConfig, "ReplicatedDataSerializerSpec",
        output)
    {
    ...
    public void ReplicatedDataSerializer_should_serialize_ORSet()
    {
        ...
        CheckSerialization(ORSet.Create<object>(_address1, "a").Add(_address2, 2).Add(_address3, 3L)
            .Add(_address3, _address3));
    ...
    public void ReplicatedDataSerializer_should_serialize_LWWDictionary()
    {
        ...
        CheckSerialization(LWWDictionary<string, object>.Empty.SetItem(_address1, "a", "value1")
            .SetItem(_address2, "b", 17));
    }
    ...
    public void ReplicatedDataSerializer_should_serialize_ORMultiDictionary()
    {
        ...
        var m1 = ORMultiValueDictionary<string, string>.Empty.AddItem(_address1, "a", "A1")
            .AddItem(_address2, "a", "A2");
        var m2 = ORMultiValueDictionary<string, string>.Empty.SetItems(_address2, "b",
            ImmutableHashSet.CreateRange(new[] { "B1", "B2", "B3" }));
