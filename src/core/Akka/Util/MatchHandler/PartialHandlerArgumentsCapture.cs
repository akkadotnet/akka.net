...
internal sealed class PartialHandlerArgumentsCapture<T, T1, T2, T3> : IPartialHandlerArgumentsCapture<T>
{
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3);
    }
}
...
internal sealed class PartialHandlerArgumentsCapture<T, T1, T2, T3, T4> : IPartialHandlerArgumentsCapture<T>
{
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4);
    }
}
...
internal sealed class PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5> : IPartialHandlerArgumentsCapture<T>
{
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5);
    }
}
...
internal sealed class PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6> : IPartialHandlerArgumentsCapture<T>
{
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6);
    }
}
...
internal sealed class PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6, T7> : IPartialHandlerArgumentsCapture<T>
{
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6, _7);
    }
}
...
internal sealed class
    PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6, T7, T8> : IPartialHandlerArgumentsCapture<T>
{
    private T1 _1;
    private T2 _2;
    private T3 _3;
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6, _7, _8);
    }
}
...
internal sealed class
    PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IPartialHandlerArgumentsCapture<T>
{
    private T1 _1;
    private T2 _2;
    private T3 _3;
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6, _7, _8, _9);
    }
}
...
internal sealed class
    PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IPartialHandlerArgumentsCapture<T>
{
    private T1 _1;
    private T10 _10;
    private T2 _2;
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10);
    }
}
...
internal sealed class
    PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IPartialHandlerArgumentsCapture<T>
{
    private T1 _1;
    private T10 _10;
    private T11 _11;
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11);
    }
}
...
internal sealed class
    PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> :
    IPartialHandlerArgumentsCapture<
        T>
{
    private T1 _1;
    private T10 _10;
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12);
    }
}
...
internal sealed class
    PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12,
        T13> : IPartialHandlerArgumentsCapture<T>
{
    private T1 _1;
    private T10 _10;
    private T11 _11;
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13);
    }
}
...
internal sealed class
    PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13,
        T14> : IPartialHandlerArgumentsCapture<T>
{
    private T1 _1;
    private T10 _10;
    private T11 _11;
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14);
    }
}
...
internal sealed class PartialHandlerArgumentsCapture<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14,
    T15> : IPartialHandlerArgumentsCapture<T>
{
    private T1 _1;
    private T10 _10;
    private T11 _11;
    ...
    public bool Handle(T value)
    {
        return _handler(value, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15);
    }
}