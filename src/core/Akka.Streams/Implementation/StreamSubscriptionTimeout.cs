...
/// <summary>
///     A subscriber who calls <see cref="ISubscription.Cancel" /> directly from <see cref="OnSubscribe" /> and ignores all
///     other callbacks.
/// </summary>
...
///     and are cancelled subscribing an <see cref="CancellingSubscriber{T}" /> to the publisher, or by calling onError on
///     the timed-out subscriber.
...
internal interface IStreamSubscriptionTimeoutSupport
{
    ...
    /// <summary>
    ///     Called by the actor when a subscription has timed out. Expects the actual <see cref="IUntypedPublisher" /> or
    ///     <see cref="IProcessor{T1,T2}" /> target.
    /// </summary>
