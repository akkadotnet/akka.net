...
#pragma warning restore CS0809
        ...
        switch (message)
        {
            ...
            case ActorSelectionMessage actorSelectionMessage:
                ...
                else
                {
                    ...
                    {
                        _eventStream.Publish(new DeadLetter(actorSelectionMessage.Message, sender.IsNobody() ? Provider.DeadLetters : sender, this));
                    }
                }
                return true;
        }
    ...
    {
        _eventStream.Publish(new SuppressedDeadLetter(msg, sender.IsNobody() ? Provider.DeadLetters : sender, this));
    }
}