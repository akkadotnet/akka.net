...
public static class StashFactory
{
    ...
    ///     This exception is thrown if the given <paramref name="actorType" /> implements an unrecognized subclass of
    ///     <see cref="IActorStash" />.
    /// </exception>
    /// <returns>TBD</returns>
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        throw new ArgumentException(
            $"Actor {actorType} implements an unrecognized subclass of {typeof(IActorStash)} - cannot instantiate",
            nameof(actorType));
    }
}