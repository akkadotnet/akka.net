...
public class MaterializationBenchmark
{
    ...
    public void Flow_with_1_map()
    {
        FlowWithMapBuilder(1).Run(_materializer);
    }
    ...
    public void Flow_with_10_map()
    {
        FlowWithMapBuilder(10).Run(_materializer);
    }
    ...
    public void Flow_with_100_map()
    {
        FlowWithMapBuilder(100).Run(_materializer);
    }
    ...
    public void Flow_with_1000_map()
    {
        FlowWithMapBuilder(1000).Run(_materializer);
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 2)]
    public void Graph_with_1_junction()
    {
        GraphWithJunctionsBuilder(1).Run(_materializer);
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 5)]
    public void Graph_with_10_junction()
    {
        GraphWithJunctionsBuilder(10).Run(_materializer);
    }
    ...
    public void Graph_with_100_junction()
    {
        GraphWithJunctionsBuilder(100).Run(_materializer);
    }
    ...
    public void Graph_with_1000_junction()
    {
        GraphWithJunctionsBuilder(1000).Run(_materializer);
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 2)]
    public void Graph_with_1_nested_imports()
    {
        GraphWithNestedImportsBuilder(1).Run(_materializer);
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 5)]
    public void Graph_with_10_nested_imports()
    {
        GraphWithNestedImportsBuilder(10).Run(_materializer);
    }


    [PerfBenchmark(
        Description = "Test the performance of the materialization phase for a graph with 100 nested imports",
        RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3)]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 5)]
    public void Graph_with_100_nested_imports()
    {
        GraphWithNestedImportsBuilder(100).Run(_materializer);
    }


    [PerfBenchmark(
        Description = "Test the performance of the materialization phase for a graph with 1000 nested imports",
        RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Skip = "Throws StackOverflowException by around 200 nested imports")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 1000)]
    public void Graph_with_1000_nested_imports()
    {
        GraphWithNestedImportsBuilder(1000).Run(_materializer);
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 2)]
    public void Graph_with_1_imported_flow()
    {
        GraphWithImportedFlowBuilder(1).Run(_materializer);
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 5)]
    public void Graph_with_10_imported_flows()
    {
        GraphWithImportedFlowBuilder(10).Run(_materializer);
    }


    [PerfBenchmark(
        Description = "Test the performance of the materialization phase for a graph with 100 imported flows",
        RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3)]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 10)]
    public void Graph_with_100_imported_flows()
    {
        GraphWithImportedFlowBuilder(100).Run(_materializer);
    }


    [PerfBenchmark(
        Description = "Test the performance of the materialization phase for a graph with 1000 imported flows",
    ...
    public void Graph_with_1000_imported_flows()
    {
        GraphWithImportedFlowBuilder(1000).Run(_materializer);
    }
