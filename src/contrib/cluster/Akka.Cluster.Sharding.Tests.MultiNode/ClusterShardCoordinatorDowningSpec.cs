...
public class PersistentClusterShardCoordinatorDowningSpec : ClusterShardCoordinatorDowningSpec
{
    public PersistentClusterShardCoordinatorDowningSpec()
        : base(new PersistentClusterShardCoordinatorDowningSpecConfig(),
            typeof(PersistentClusterShardCoordinatorDowningSpec))
    {
    }
}
...
public abstract class
    ClusterShardCoordinatorDowningSpec : MultiNodeClusterShardingSpec<ClusterShardCoordinatorDowningSpecConfig>
{
    [MultiNodeFact]
    ...
    private void Cluster_sharding_with_down_member_scenario_1_must_recover_after_downing_coordinator_node()
    {
        Within(TimeSpan.FromSeconds(20), () =>
        {
            ...
            RunOn(() => { TestConductor.Blackhole(Config.First, Config.Second, Direction.Both).Wait(); },
                Config.Controller);
