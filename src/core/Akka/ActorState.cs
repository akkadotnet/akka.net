...
/// <summary>
///     This interface represents the parts of the internal actor state; the behavior stack, watched by, watching and
///     termination queue.
/// </summary>
...
/// <summary>
///     Represents the full state of an actor, this is used whenever an actor need more state than the `DefaultActorState`
///     container can contain
/// </summary>
internal class FullActorState : IActorState
{
    private readonly Dictionary<IActorRef, Option<object>>
        _terminatedQueue = new(); //terminatedqueue should never be used outside the message loop
