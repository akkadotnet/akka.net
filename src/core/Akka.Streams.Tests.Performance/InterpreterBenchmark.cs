...
public class InterpreterBenchmark
{
    ...
    public void Graph_interpreter_100k_elements_with_1_identity()
    {
        Execute(1);
    }
    ...
    public void Graph_interpreter_100k_elements_with_5_identity()
    {
        Execute(5);
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 1000)]
    public void Graph_interpreter_100k_elements_with_10_identity()
    {
        Execute(10);
    }
