...
public class GraphBuilderBenchmark
{
    ...
    {
        MaterializationBenchmark.FlowWithMapBuilder(1);
    }
    ...
    {
        MaterializationBenchmark.FlowWithMapBuilder(10);
    }
    ...
    {
        MaterializationBenchmark.FlowWithMapBuilder(100);
    }
    ...
    {
        MaterializationBenchmark.FlowWithMapBuilder(1000);
    }
    ...
    {
        MaterializationBenchmark.GraphWithJunctionsBuilder(1);
    }
    ...
    {
        MaterializationBenchmark.GraphWithJunctionsBuilder(10);
    }
    ...
    {
        MaterializationBenchmark.GraphWithJunctionsBuilder(100);
    }
    ...
    {
        MaterializationBenchmark.GraphWithJunctionsBuilder(1000);
    }
    ...
    {
        MaterializationBenchmark.GraphWithNestedImportsBuilder(1);
    }
    ...
    {
        MaterializationBenchmark.GraphWithNestedImportsBuilder(10);
    }
    ...
    {
        MaterializationBenchmark.GraphWithNestedImportsBuilder(100);
    }
    ...
    {
        MaterializationBenchmark.GraphWithNestedImportsBuilder(1000);
    }
    ...
    {
        MaterializationBenchmark.GraphWithImportedFlowBuilder(1);
    }
    ...
    {
        MaterializationBenchmark.GraphWithImportedFlowBuilder(10);
    }
    ...
    {
        MaterializationBenchmark.GraphWithImportedFlowBuilder(100);
    }
    ...
    {
        MaterializationBenchmark.GraphWithImportedFlowBuilder(1000);
    }
}