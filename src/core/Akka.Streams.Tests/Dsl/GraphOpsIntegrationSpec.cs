...
public class GraphOpsIntegrationSpec : AkkaSpec
{
    ...
    public void GraphDSLs_must_support_wikipedia_Topological_sorting_2()
    {
        ...
        var t = RunnableGraph.FromGraph(GraphDsl.Create(seqSink, seqSink, seqSink, ValueTuple.Create,
    ...
    private static class Shuffle
    {
        ...
        internal class ShufflePorts : Shape
        {
            ...
            {
                return new ShufflePorts(_in1.CarbonCopy(), _in2.CarbonCopy(), _out1.CarbonCopy(),
                    _out2.CarbonCopy());
            }
