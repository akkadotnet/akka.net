...
/// <summary>
///     Message queue for supporting <see cref="IDequeBasedMessageQueueSemantics" /> within <see cref="Mailbox" />
///     instances.
...
public class DequeWrapperMessageQueue : IMessageQueue, IDequeBasedMessageQueueSemantics
{
    ...
    /// </summary>
    public int Count => MessageQueue.Count + _prependBuffer.Count;
    ...
    {
        while (TryDequeue(out var msg)) deadletters.Enqueue(owner, msg);
    }
}