...
internal static class TimedOps
{
    ...
    /// <returns>TBD</returns>
    [InternalApi]
    public static Source<TOut, TMat2> Timed<TIn, TOut, TMat, TMat2>(Source<TIn, TMat> source,
    ...
    /// <param name="onComplete">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat2> Timed<TIn, TOut, TOut2, TMat, TMat2>(Flow<TIn, TOut, TMat> flow,
...
internal static class TimedIntervalBetweenOps
{
    ...
    /// <returns>TBD</returns>
    [InternalApi]
    public static IFlow<TIn, TMat> TimedIntervalBetween<TIn, TMat>(IFlow<TIn, TMat> flow, Func<TIn, bool> matching,
