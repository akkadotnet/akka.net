...
public partial class TestKitBase
{
    ...
    /// <param name="name">Optional: The name.</param>
    /// <returns>TBD</returns>
    public TestActorRef<TActor> ActorOfAsTestActorRef<TActor>(Expression<Func<TActor>> factory, IActorRef supervisor,
        string name = null) where TActor : ActorBase
    {
    ...
    ///     and returns it as <see cref="TestFSMRef{TActor,TState,TData}" /> to enable inspecting and modifying the FSM
    ///     directly.
    /// </summary>
    ...
    /// <param name="supervisor">The supervisor</param>
    /// <param name="name">Optional: The name.</param>
    /// <param name="withLogging">
    ///     Optional: If set to <c>true</c> logs state changes of the FSM as Debug messages. Default is
    ///     <c>false</c>.
    /// </param>
    /// <returns>TBD</returns>
    ...
    ///     directly.
    /// </summary>
    /// <typeparam name="TFsmActor">
    ///     The type of the actor. It must be a <see cref="FSM{TState,TData}" /> and have a public
    ...
    /// <returns>TBD</returns>
    public TestFSMRef<TFsmActor, TState, TData> ActorOfAsTestFSMRef<TFsmActor, TState, TData>(Props props,
        string name = null, bool withLogging = false)
        where TFsmActor : FSM<TState, TData>
    {
    ...
    /// </param>
    /// <returns>TBD</returns>
    public TestFSMRef<TFsmActor, TState, TData> ActorOfAsTestFSMRef<TFsmActor, TState, TData>(IActorRef supervisor,
        string name = null, bool withLogging = false)
    ...
    /// </param>
    /// <returns>TBD</returns>
    public TestFSMRef<TFsmActor, TState, TData> ActorOfAsTestFSMRef<TFsmActor, TState, TData>(string name = null,
        bool withLogging = false)
        where TFsmActor : FSM<TState, TData>, new()
    {
        return new TestFSMRef<TFsmActor, TState, TData>(Sys, Props.Create<TFsmActor>(), NoSupervisor, name,
            withLogging);
    }
    ...
    public TestFSMRef<TFsmActor, TState, TData> ActorOfAsTestFSMRef<TFsmActor, TState, TData>(
        Expression<Func<TFsmActor>> factory, IActorRef supervisor, string name = null, bool withLogging = false)
        where TFsmActor : FSM<TState, TData>
    {
    ...
    /// <returns>TBD</returns>
    public TestFSMRef<TFsmActor, TState, TData> ActorOfAsTestFSMRef<TFsmActor, TState, TData>(
        Expression<Func<TFsmActor>> factory, string name = null, bool withLogging = false)
        where TFsmActor : FSM<TState, TData>
    {
