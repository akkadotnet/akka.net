...
public sealed class DistributedPubSubSettings : INoSerializationVerificationNeeded
{
    ...
    /// <param name="sendToDeadLettersWhenNoSubscribers">
    ///     When a message is published to a topic with no subscribers send it to
    ///     the dead letters.
    /// </param>
    /// <exception cref="ArgumentException">
    ///     Thrown if a user tries to use a <see cref="ConsistentHashingRoutingLogic" /> with
    ///     routingLogic.
    /// </exception>
    ...
    /// <summary>
    ///     Creates cluster publish subscribe settings from provided configuration with the same layout as
