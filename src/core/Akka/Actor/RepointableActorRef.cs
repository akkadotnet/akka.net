...
public class RepointableActorRef : ActorRefWithCell, IRepointableRef
{
    ...
    public RepointableActorRef(ActorSystemImpl system, Props props, MessageDispatcher dispatcher,
    ...
    ///     TBD
    /// </summary>
    public override ICell Underlying => _underlying_DoNotCallMeDirectly;

    /// <summary>
    ///     TBD
    /// </summary>
    public ICell Lookup => _lookup_DoNotCallMeDirectly;
    ...
    ///     TBD
    /// </summary>
    public override IInternalActorRef Parent => Underlying.Parent;
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    ///     TBD
    /// </summary>
    public override bool IsLocal => Underlying.IsLocal;
...
public class UnstartedCell : ICell
{
    ...
    private void SendMessage(object message, IActorRef sender)
    {
        ...
        {
            SystemImpl.EventStream.Publish(new Warning(_self.Path.ToString(), GetType(),
                "Dropping message of type" + message.GetType() + " due to lock timeout"));
