...
namespace Akka.Tests.Actor
{
    ...
    public class RootGuardianActorRef_Tests : AkkaSpec
    {
        ...
        public void Path_Should_be_the_same_path_as_specified()
        {
            ...
            var rootGuardianActorRef = new RootGuardianActorRef((ActorSystemImpl) sys, props, _dispatcher, () => sys.Mailboxes.FromConfig(""), ActorRef.Nobody, _rootActorPath, _deadLetters, _emptyExtraNames);
        ...
        public void Getting_a_child_that_exists_in_extraNames_Should_return_the_child()
        {
            ...
            var props = Props.Create<GuardianActor>(new OneForOneStrategy(e => Directive.Stop));
            var rootGuardianActorRef = new RootGuardianActorRef((ActorSystemImpl) sys, props, _dispatcher, () => sys.Mailboxes.FromConfig(""), ActorRef.Nobody, _rootActorPath, _deadLetters, extraNames);
