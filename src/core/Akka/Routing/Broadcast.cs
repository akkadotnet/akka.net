...
/// <summary>
///     This class contains logic used by a <see cref="Router" /> to route a message to multiple
///     <see cref="Routee">routees</see>.
/// </summary>
public sealed class BroadcastRoutingLogic : RoutingLogic
{
    /// <summary>
    ///     Picks all the <see cref="Routee">routees</see> in <paramref name="routees" /> to receive the
    ...
    /// <returns>
    ///     A <see cref="Routee" /> that contains all the given <paramref name="routees" /> that receives the
    ///     <paramref name="message" />.
    /// </returns>
...
/// <summary>
///     This class represents a <see cref="Pool" /> router that sends messages it receives to all of its
///     <see cref="Routee">routees</see>.
/// </summary>
public sealed class BroadcastPool : Pool
{
    ...
    ///     <note>
    ///         A <see cref="BroadcastPool" /> configured in this way uses the <see cref="Pool.DefaultSupervisorStrategy" />
    ///         supervisor strategy.
    ///     </note>
    /// </summary>
    ...
    public BroadcastPool(int nrOfInstances, Resizer resizer, SupervisorStrategy supervisorStrategy,
...
public sealed class BroadcastGroup : Group
{
    ...
    public override ISurrogate ToSurrogate(ActorSystem system)
    {
        return new BroadcastGroupSurrogate { Paths = InternalPaths, RouterDispatcher = RouterDispatcher };
    }
