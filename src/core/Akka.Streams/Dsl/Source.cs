...
namespace Akka.Streams.Dsl
{
    ...
    public static class Source
    {
        ...
        public static Source<T, NotUsed> AsyncEnumerableAsRun<T>(IAsyncEnumerable<T> enumerable)
            => FromGraph(new AsyncEnumerable<T>(enumerable)).WithAttributes(DefaultAttributes.EnumerableSource);
