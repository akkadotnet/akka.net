...
public class SinkSpec : AkkaSpec
{
    ...
    private TestSubscriber.ManualProbe<int>[] CreateProbes()
    {
        return new[]
        {
            this.CreateManualSubscriberProbe<int>(), this.CreateManualSubscriberProbe<int>(),
    ...
    [Fact]
    public void
        Sink_prematerialization_must_materialize_the_sink_and_wrap_its_exposed_fanout_publisher_in_a_Source_twice()
    {
