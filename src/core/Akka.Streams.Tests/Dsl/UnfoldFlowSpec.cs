...
public class UnfoldFlowSpec
{
    ...
    private static readonly int[] _outputs =
    {
    ...
    public class WithSimpleFlow : Akka.TestKit.Xunit2.TestKit
    {
        ...
        {
            var controlledFlow =
                Flow.FromSinkAndSource(this.SinkProbe<int>(), this.SourceProbe<(int, int)>(), Keep.Both);
        ...
        [Fact]
        public void
            UnfoldFlow_should_increment_integers_and_handle_KillSwitch_and_fail_when_inner_stream_is_canceled_and_pulled_before_completion()
        {
            var t = _source.ToMaterialized(this.SinkProbe<int>(), Keep.Both).Run(Sys.Materializer());
        ...
        [Fact]
        public void
            UnfoldFlow_should_increment_integers_and_handle_KillSwitch_and_fail_when_inner_stream_is_canceled_pulled_before_completion_and_finally_aborted()
        {
            var t = _source.ToMaterialized(this.SinkProbe<int>(), Keep.Both).Run(Sys.Materializer());
        ...
        [Fact]
        public void
            UnfoldFlow_should_increment_integers_and_handle_KillSwitch_and_complete_gracefully_instantly_when_stopped()
        {
            var t = _source.ToMaterialized(this.SinkProbe<int>(), Keep.Both).Run(Sys.Materializer());
        ...
        public void
            UnfoldFlow_should_increment_integers_and_handle_KillSwitch_and_complete_gracefully_after_timeout_when_stopped()
        {
            var t = _source.ToMaterialized(this.SinkProbe<int>(), Keep.Both).Run(Sys.Materializer());
        ...
        [Fact]
        public void
            UnfoldFlow_should_increment_integers_and_handle_KillSwitch_and_complete_gracefully_after_3_elements_when_stopped()
        {
            var t = _source.ToMaterialized(this.SinkProbe<int>(), Keep.Both).Run(Sys.Materializer());
