...
namespace Akka.Cluster.Sharding.Tests
{
    public class ClusterShardingMessageSerializerSpec : AkkaSpec
    {
        ...
        {
            var serializer = Sys.Serialization.FindSerializerFor(obj).AsV1<ClusterShardingMessageSerializer>();
        ...
        public void ClusterShardingMessageSerializer_must_be_able_to_deserialize_old_entity_started_event_into_entities_started()
        {
            ...
            var serializer = Sys.Serialization.FindSerializerForType(typeof(EventSourcedRememberEntitiesShardStore.EntitiesStarted)).AsV1<ClusterShardingMessageSerializer>();
