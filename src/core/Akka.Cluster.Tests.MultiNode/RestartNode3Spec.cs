...
{
    private static UniqueAddress secondUniqueAddress;

    private readonly RestartNode3SpecConfig _config;
    private readonly Lazy<ActorSystem> restartedSecondSystem;
    private readonly Lazy<ActorSystem> secondSystem;
    ...
    public void Cluster_nodes_must_be_able_to_restart_and_join_again_when_down_before_up()
    {
        Within(TimeSpan.FromSeconds(60), () =>
        {
            ...
            RunOn(() => { Shutdown(secondSystem.Value, Remaining); }, _config.Second);
