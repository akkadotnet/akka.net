...
///     **Mutable** framing implementation that given any number of <see cref="ByteString" /> chunks, can emit JSON objects
///     contained within them.
///     Typically JSON objects are separated by new-lines or commas, however a top-level JSON Array can also be understood
///     and chunked up
...
public class JsonObjectParser
{
    ...
    ///     May throw a <see cref="Framing.FramingException" /> if the contained JSON is invalid or max object size is
    ///     exceeded.
    /// </summary>
