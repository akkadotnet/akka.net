...
{
    public ActorServiceProviderPropsWithScopesSpecs(AkkaDiFixture fixture, ITestOutputHelper output) : base(
    ...
    [Fact(DisplayName =
        "DI: actors who receive an IServiceScope through Props should dispose of their dependencies upon termination")]
    public void ActorsWithScopedDependenciesShouldDisposeUponStop()
    {
        ...
        AwaitAssert(() => { deps1.Dependencies.All(x => x.Disposed).Should().BeTrue(); });
    ...
    public void ActorsWithScopedDependenciesShouldDisposeAndRecreateUponRestart()
    {
        ...
        // crash + restart it
        EventFilter.Exception<ApplicationException>().ExpectOne(() => { scoped1.Tell(new Crash()); });
    ...
    public void ActorsWithMixedDependenciesShouldDisposeAndRecreateScopedUponRestart()
    {
        ...
        AwaitAssert(() =>
        {
            deps1.Dependencies.Where(x => !(x is AkkaDiFixture.ISingletonDependency)).All(x => x.Disposed).Should()
                .BeTrue();
        });
    ...
    public void ServiceProvider_Props_should_support_copying()
    {
        ...
        var arg1 = "foo";
        var arg2 = "bar";
        var props = spExtension.Props<NonDiArgsActor>(arg1, arg2).WithRouter(
            new RoundRobinPool(10).WithSupervisorStrategy(new OneForOneStrategy(
                ex =>
                {
                    TestActor.Tell(ex);
    ...
    public class MixedActor : ReceiveActor
    {
        ...
        public MixedActor(AkkaDiFixture.ISingletonDependency singleton, IServiceProvider sp)
        {
            ...
            {
                Sender.Tell(
                    new CurrentDependencies(new AkkaDiFixture.IDependency[] { _transient, _scoped, _singleton }));
            });
    ...
    public class NonDiArgsActor : ReceiveActor
    {
        ...
        public NonDiArgsActor(AkkaDiFixture.ISingletonDependency singleton, IServiceProvider sp, string arg1,
            string arg2)
        {
            _singleton = singleton;
            _scope = sp.CreateScope();
