...
public class BatchingSqliteEventsByPersistenceIdSpec : EventsByPersistenceIdSpec
{
    ...
    public BatchingSqliteEventsByPersistenceIdSpec(ITestOutputHelper output) : base(Config(Counter.GetAndIncrement()),
        nameof(BatchingSqliteEventsByPersistenceIdSpec), output)
    {
