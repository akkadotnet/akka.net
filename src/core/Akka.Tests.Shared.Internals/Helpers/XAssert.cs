...
public static class XAssert
{
    ...
    public static T Throws<T>(Action action) where T : Exception
    {
        ...
        {
            if (ex is T exception1) return exception1;
            exception = ex;
        }
    ...
    ///     Equivalent of
    ///     http://msdn.microsoft.com/en-us/library/microsoft.visualstudio.testtools.unittesting.collectionassert.areequivalent.aspx
    /// </summary>
