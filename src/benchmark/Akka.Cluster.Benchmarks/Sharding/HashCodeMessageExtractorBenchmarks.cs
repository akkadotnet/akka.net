...
{
    private readonly IMessageExtractor _extractor = new ShardMessageExtractor();
    private readonly ShardingEnvelope _m1 = new("foo", 1);
    private readonly ShardedMessage _m2 = new("foo", 1);
