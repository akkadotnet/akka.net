...
public abstract class LoggingAdapterBase : ILoggingAdapter
{
    ...
    ///     This exception is thrown when the given <paramref name="logMessageFormatter" />
    ///     is undefined.
    /// </exception>
    protected LoggingAdapterBase(ILogMessageFormatter logMessageFormatter)
    {
        Formatter = logMessageFormatter ??
                    throw new ArgumentNullException(nameof(logMessageFormatter),
                        "The message formatter must not be null.");
    }
    ...
    ///     This exception is thrown when the given <paramref name="logLevel" /> is
    ///     unknown.
    /// </exception>
