...
public static partial class TestSubscriber
{
    ...
    /// <summary>
    ///     Implementation of Reactive.Streams.ISubscriber{T} that allows various assertions. All timeouts are dilated
    ///     automatically,
...
#pragma warning restore CS0420
        ...
        {
            TestProbe.Ref.Tell(new OnSubscribe(subscription));
        }

        public void OnError(Exception cause)
        {
            TestProbe.Ref.Tell(new OnError(cause));
        }
        ...
        {
            TestProbe.Ref.Tell(new OnNext<T>(element));
        }
        ...
        {
            return ExpectSubscriptionTask(this, cancellationToken)
        ...
        {
            return await ExpectSubscriptionTask(this, cancellationToken)
                .ConfigureAwait(false);
        }

        /// <summary>
        ///     Expect and return <see cref="ISubscriberEvent" /> (any of: <see cref="OnSubscribe" />, <see cref="OnNext" />,
        ///     <see cref="OnError" /> or <see cref="OnComplete" />).
        /// </summary>
        public ISubscriberEvent ExpectEvent(CancellationToken cancellationToken = default)
        {
            return ExpectEventTask(TestProbe, (TimeSpan?)null, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        {
            return await ExpectEventTask(TestProbe, (TimeSpan?)null, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        {
            return ExpectEventTask(TestProbe, max, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        {
            return await ExpectEventTask(TestProbe, max, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        {
            return ExpectNextTask(TestProbe, null, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        {
            return ExpectNextTask(TestProbe, timeout, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        {
            return await ExpectNextTask(TestProbe, null, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        {
            return await ExpectNextTask(TestProbe, timeout, cancellationToken)
                .ConfigureAwait(false);
        }

        public async Task ExpectNextAsync(T element, CancellationToken cancellationToken = default)
        {
            await ExpectNextTask(TestProbe, element, null, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        public IEnumerable<T> ExpectNextN(
            ...
            CancellationToken cancellationToken = default)
        {
            return ExpectNextNTask(TestProbe, n, timeout, cancellationToken)
        ...
        /// </summary>
        public async Task ExpectNextNAsync(IEnumerable<T> all, TimeSpan? timeout = null,
            CancellationToken cancellationToken = default)
        {
        ...
        {
            return ExpectErrorTask(TestProbe, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        {
            return await ExpectErrorTask(TestProbe, cancellationToken)
                .ConfigureAwait(false);
        }

        /// <summary>
        ///     Expect subscription to be followed immediately by an error signal. By default single demand will be signaled in
        ///     order to wake up a possibly lazy upstream.
        ...
        {
            return ExpectSubscriptionAndErrorTask(this, true, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        {
            return await ExpectSubscriptionAndErrorTask(this, true, cancellationToken)
                .ConfigureAwait(false);
        }

        /// <summary>
        ///     Expect subscription to be followed immediately by an error signal. Depending on the `signalDemand` parameter demand
        ///     may be signaled
        ///     immediately after obtaining the subscription in order to wake up a possibly lazy upstream.You can disable this by
        ///     setting the `signalDemand` parameter to `false`.
        ...
        public Exception ExpectSubscriptionAndError(
            ...
            CancellationToken cancellationToken = default)
        {
            return ExpectSubscriptionAndErrorTask(this, signalDemand, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public async Task<Exception> ExpectSubscriptionAndErrorAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            return await ExpectSubscriptionAndErrorTask(this, signalDemand, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        {
            return ExpectNextOrErrorTask(TestProbe, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        {
            return await ExpectNextOrErrorTask(TestProbe, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        {
            return ExpectNextOrCompleteTask(TestProbe, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        {
            return await ExpectNextOrCompleteTask(TestProbe, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        {
            return ExpectNextTask(TestProbe, predicate, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public async Task<TOther> ExpectNextAsync<TOther>(
            ...
            CancellationToken cancellationToken = default)
        {
            return await ExpectNextTask(TestProbe, predicate, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        public TOther ExpectEvent<TOther>(
            ...
            CancellationToken cancellationToken = default)
        {
            return ExpectEventTask(TestProbe, func, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public async Task<TOther> ExpectEventAsync<TOther>(
            ...
            CancellationToken cancellationToken = default)
        {
            return await ExpectEventTask(TestProbe, func, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        public IAsyncEnumerable<TOther> ReceiveWhileAsync<TOther>(
            ...
            CancellationToken cancellationToken = default)
        {
            return TestProbe.ReceiveWhileAsync(max, idle, filter, msgs, cancellationToken);
        }
        ...
        public IEnumerable<TOther> ReceiveWithin<TOther>(TimeSpan? max, int messages = int.MaxValue,
            CancellationToken cancellationToken = default)
        {
            return ReceiveWithinTask<TOther>(TestProbe, max, messages, cancellationToken)
                .ToListAsync(cancellationToken).ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        ///     <paramref name="max" />. <see cref="Within{TOther}(TimeSpan,TimeSpan,Func{TOther},CancellationToken)" /> blocks may
        ///     be nested.
        ///     All methods in this class which take maximum wait times are available in a version which implicitly uses
        ///     the remaining time governed by the innermost enclosing
        ///     <see cref="Within{TOther}(TimeSpan,TimeSpan,Func{TOther},CancellationToken)" /> block.
        ///     <para />
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public TOther Within<TOther>(TimeSpan min, TimeSpan max, Func<TOther> execute,
            CancellationToken cancellationToken = default)
        {
            return TestProbe.Within(min, max, execute, cancellationToken: cancellationToken);
        }

        public async Task<TOther> WithinAsync<TOther>(TimeSpan min, TimeSpan max, Func<Task<TOther>> execute,
            CancellationToken cancellationToken = default)
        {
            return await TestProbe.WithinAsync(min, max, execute, cancellationToken: cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        {
            return TestProbe.Within(max, execute, cancellationToken: cancellationToken);
        }

        /// <summary>
        ///     Sane as calling WithinAsync(TimeSpan.Zero, max, function).
        /// </summary>
        public async Task<TOther> WithinAsync<TOther>(TimeSpan max, Func<Task<TOther>> execute,
            CancellationToken cancellationToken = default)
        {
            return await TestProbe.WithinAsync(max, execute, cancellationToken: cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <remarks>
        ///     Use with caution: Be warned that this may not be a good idea if the stream is infinite or its elements are very
        ///     large!
        /// </remarks>
        public IList<T> ToStrict(TimeSpan atMost, CancellationToken cancellationToken = default)
        {
            return ToStrictTask(this, atMost, cancellationToken).ToListAsync(cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public IAsyncEnumerable<T> ToStrictAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            return ToStrictTask(this, atMost, cancellationToken);
        }
    }
    ...
    public struct OnSubscribe : ISubscriberEvent
    {
        ...
        {
            return $"TestSubscriber.OnSubscribe({Subscription})";
        }
    }
    ...
    public struct OnNext<T> : ISubscriberEvent, IEquatable<OnNext<T>>
    {
        ...
        public override string ToString()
        {
            return $"TestSubscriber.OnNext({Element})";
        }
    ...
    public sealed class OnComplete : ISubscriberEvent
    {
        ...
        public override string ToString()
        {
            return "TestSubscriber.OnComplete";
        }
    }
    ...
    public struct OnError : ISubscriberEvent
    {
        ...
        public override string ToString()
        {
            return $"TestSubscriber.OnError({Cause.Message})";
        }
    }
