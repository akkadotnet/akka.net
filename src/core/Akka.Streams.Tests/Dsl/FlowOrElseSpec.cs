...
public class FlowOrElseSpec : AkkaSpec
{
    ...
    [Fact]
    public async Task
        An_OrElse_flow_should_pass_elements_from_the_second_input_if_the_first_completes_with_no_elements_emitted()
    {
    ...
    [Fact]
    public void
        An_OrElse_flow_should_pass_elements_from_input_two_when_input_1_has_completed_without_elements_LazyEmpty()
    {
    ...
    [Fact]
    public void
        An_OrElse_flow_should_pass_all_available_requested_elements_from_input_two_when_input_1_has_completed_without_elements()
    {
        OrElseProbedFlow((inProbe1, inProbe2, outProbe) =>
        {
            outProbe.Request(5);
    ...
    [Fact]
    public void
        An_OrElse_flow_should_complete_when_both_inputs_completes_without_emitting_elements_regardless_of_order()
    {
        OrElseProbedFlow((inProbe1, inProbe2, outProbe) =>
        {
            outProbe.EnsureSubscription();
    ...
    private void OrElseProbedFlow(
        Action<TestPublisher.Probe<char>, TestPublisher.Probe<char>, TestSubscriber.Probe<char>> assert)
    {
