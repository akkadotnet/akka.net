...
public class LeaseProvider : IExtension
{
    ...
    private ILoggingAdapter Log => _log ??= Logging.GetLogger(_system, "LeaseProvider");
    ...
    private class LeaseKey : IEquatable<LeaseKey>
    {
        ...
        public bool Equals(LeaseKey other)
        {
            ...
            return Equals(LeaseName, other.LeaseName) && Equals(ConfigPath, other.ConfigPath) &&
                   Equals(ClientName, other.ClientName);
        }

        public override bool Equals(object obj)
        {
            return obj is LeaseKey lk && Equals(lk);
        }
        ...
        {
            return $"LeaseKey({LeaseName}, {ConfigPath}, {ClientName})";
        }
    }
}