...
public class Parser
{
    ...
    ///     This exception is thrown if an unresolved substitution or an unknown token is
    ///     encountered.
    /// </exception>
    /// <exception cref="Exception">
    ///     This exception is thrown if the end of the file has been reached while trying to read a
    ///     value.
    /// </exception>
            ...
            switch (t.Type)
            {
                ...
                case TokenType.LiteralValue:
                    if (owner.IsObject())
                        ...
                        owner.Clear();
                    var lit = new HoconLiteral { Value = t.Value };
    ...
    private void ParseTrailingWhitespace(HoconValue owner)
    {
        ...
        {
            var wsLit = new HoconLiteral { Value = ws.Value };
