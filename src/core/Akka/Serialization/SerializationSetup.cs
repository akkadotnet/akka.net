// -----------------------------------------------------------------------
//  <copyright file="SerializationSetup.cs" company="Akka.NET Project">
...
public sealed class SerializerDetails
{
    ...
    /// <param name="useFor">
    ///     A set of types (classes, base classes, or interfaces) that will be bound to this serializer.
    ///     This is the programmatic equivalent of the `akka.actor.serialization.serialization-bindings` HOCON section.
    /// </param>
