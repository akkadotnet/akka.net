...
#pragma warning restore CS0420
        ...
        {
            return ExpectSubscriptionTask(Probe, cancellationToken)
        ...
        public async Task<StreamTestKit.PublisherProbeSubscription<T>> ExpectSubscriptionAsync(
            CancellationToken cancellationToken = default)
        {
            return await ExpectSubscriptionTask(Probe, cancellationToken)
        ...
        {
            return ReceiveWhileTask(Probe, max, idle, filter, msgCount, cancellationToken)
        ...
        {
            return ExpectEventTask(Probe, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        {
            return await ExpectEventTask(Probe, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        public TOther Within<TOther>(
            ...
            CancellationToken cancellationToken = default)
        {
            return WithinAsync(min, max, () => Task.FromResult(execute()), cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public async Task<TOther> WithinAsync<TOther>(
            ...
            CancellationToken cancellationToken = default)
        {
            return await Probe.WithinAsync(min, max, actionAsync, cancellationToken: cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        {
            return WithinAsync(max, () => Task.FromResult(execute()), cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }
    ...
    public partial class Probe<T> : ManualProbe<T>
    {
        ...
        {
            return ExpectRequestTask(this, cancellationToken)
                .ConfigureAwait(false).GetAwaiter().GetResult();
        }

        public async Task<long> ExpectRequestAsync(CancellationToken cancellationToken = default)
        {
            return await ExpectRequestTask(this, cancellationToken)
                .ConfigureAwait(false);
        }
