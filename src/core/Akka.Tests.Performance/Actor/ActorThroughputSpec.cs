...
public class ActorThroughputSpec
{
    ...
    private readonly SimpleData dataExample = new("John", 25);
    private readonly int intExample = 343;
    private readonly string stringExample = "just_string";
    ...
    public void Setup(BenchmarkContext context)
    {
        ...
        _untypedActorRef =
            System.ActorOf(BenchmarkUntypedActor.Props(_mailboxThroughput, MailboxMessageCount * 3, _resetEvent));
        _receiveActorRef =
            System.ActorOf(BenchmarkReceiveActor.Props(_mailboxThroughput, MailboxMessageCount * 3, _resetEvent));
    ...
    internal class BenchmarkUntypedActor : UntypedActor
    {
        ...
        public static Props Props(Counter counter, long maxExpectedMessages, ManualResetEventSlim resetEvent)
        {
