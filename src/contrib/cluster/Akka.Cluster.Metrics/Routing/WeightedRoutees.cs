...
public class WeightedRoutees
{
    ...
    private readonly IImmutableDictionary<Address, int> _weights;

    public WeightedRoutees(ImmutableArray<Routee> routees, Address selfAddress,
        IImmutableDictionary<Address, int> weights)
    {
        _routees = routees;
