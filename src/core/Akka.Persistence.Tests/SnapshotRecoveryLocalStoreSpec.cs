...
public class SnapshotRecoveryLocalStoreSpec : PersistenceSpec
{
    ...
    [Fact]
    public void
        PersistentActor_which_is_persisted_at_the_same_time_as_another_actor_whose_PersistenceId_is_an_extension_of_the_first_should_recover_state_only_from_its_own_correct_snapshot_file()
    {
        ...
        var recoveringActor =
            Sys.ActorOf(Props.Create(() => new LoadSnapshotTestPersistentActor(PersistenceId, TestActor)));
