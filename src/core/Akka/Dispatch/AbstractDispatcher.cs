...
internal sealed class ForkJoinExecutorServiceFactory : ExecutorServiceConfigurator
{
    ...
    ///     This exception is thrown if either 'dedicated-thread-pool' OR 'fork-join-executor' is not defined in
...
public abstract class MessageDispatcher
{
    ...
    ///     how long it will wait until it shuts itself down, defaulting to your Akka.NET config's
...
#pragma warning restore CS0162
    ...
    /// <summary>
    ///     INTERNAL API
    ///     Called one time every time an actor is detached from this dispatcher and this dispatcher has no actors left
    ///     attached
    /// </summary>
    /// <remarks>
    ///     MUST BE IDEMPOTENT
...
#pragma warning disable CS0162 // Disabled since the flag can be set while debugging
    /// <summary>
    ///     INTERNAL API
    ///     If you override it, you must still call the base method. But only ever once. See <see cref="Attach" /> for only
    ///     invocation.
    /// </summary>
...
#pragma warning restore CS0162
    ...
    private sealed class ShutdownAction : IRunnable
    {
