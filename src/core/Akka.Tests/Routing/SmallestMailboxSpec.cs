...
public class SmallestMailboxSpec : AkkaSpec
{
    ...
    public void Smallest_mailbox_pool_must_deliver_messages_to_idle_actor()
    {
        ...
        var router =
            Sys.ActorOf(new SmallestMailboxPool(3).Props(Props.Create(() => new SmallestMailboxActor(usedActors))));
    ...
    {
        private readonly ConcurrentDictionary<int, string> usedActors;
