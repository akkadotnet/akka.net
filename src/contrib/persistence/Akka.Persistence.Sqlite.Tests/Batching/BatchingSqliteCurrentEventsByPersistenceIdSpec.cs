...
public class BatchingSqliteCurrentEventsByPersistenceIdSpec : CurrentEventsByPersistenceIdSpec
{
    ...
    public BatchingSqliteCurrentEventsByPersistenceIdSpec(ITestOutputHelper output) : base(
        Config(Counter.GetAndIncrement()), nameof(BatchingSqliteCurrentEventsByPersistenceIdSpec), output)
    {
