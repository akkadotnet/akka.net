...
/// <summary>
///     This class represents an <see cref="ActorSystem" /> provider used to create the
///     <see cref="AddressTerminatedTopic" /> extension.
/// </summary>
...
internal sealed class AddressTerminatedTopic : IExtension
{
    ...
    public void Publish(AddressTerminated msg)
    {
        ...
        foreach (var subscriber in subscribers) subscriber.Tell(msg, ActorRefs.NoSender);
    }
}