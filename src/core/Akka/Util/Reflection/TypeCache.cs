...
{
    private static readonly ConcurrentDictionary<string, Type> TypeMap = new(new[]
    {
        new KeyValuePair<string, Type>("null", null)
    });

    /// <summary>
    ///     Gets the <see cref="T:System.Type" /> with the specified name, performing a case-sensitive search and throw an
