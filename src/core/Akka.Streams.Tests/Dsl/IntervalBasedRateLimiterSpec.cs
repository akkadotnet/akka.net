...
public class IntervalBasedRateLimiterSpec : Akka.TestKit.Xunit2.TestKit
{
    ...
    [LocalFact(SkipLocal = "Racy on Azure DevOps")]
    public void
        IntervalBasedRateLimiter_should_limit_rate_of_messages_when_frequency_is_moderate_20_elements_per_100ms()
    {
        TestCase(_infiniteSource,
            600,
            20,
    ...
    [LocalFact(SkipLocal = "Racy on Azure DevOps")]
    public void
        IntervalBasedRateLimiter_should_limit_rate_of_messages_when_frequency_is_moderate_200_elements_per_1000ms()
    {
        TestCase(_infiniteSource,
            600,
            200,
    ...
    [LocalFact(SkipLocal = "Racy on Azure DevOps")]
    public void
        IntervalBasedRateLimiter_should_limit_rate_of_messages_when_frequency_is_high_2_000_elements_per_1000ms()
    {
        TestCase(_infiniteSource,
            6000,
            2000,
    ...
    [Fact]
    public void
        IntervalBasedRateLimiter_should_limit_rate_of_messages_when_frequency_is_very_high_50_000_elements_per_1000ms()
    {
        TestCase(_infiniteSource,
            150000,
            50000,
        ...
        TimeSpan minInterval)
    {
        ...
        batches.SelectMany(x => x).Should()
            .BeEquivalentTo(Enumerable.Range(1, numOfElements), o => o.WithStrictOrdering());
