...
public class OptionalSnapshotStoreSpec : PersistenceSpec
{
    ...
    [Fact]
    public void
        Persistence_extension_should_fail_if_PersistentActor_tries_to_SaveSnapshot_without_snapshot_store_available()
    {
    ...
    [Fact]
    public void
        Persistence_extension_should_successfully_save_a_snapshot_when_no_default_snapshot_store_configured_yet_PersistentActor_picked_one_explicitly()
    {
