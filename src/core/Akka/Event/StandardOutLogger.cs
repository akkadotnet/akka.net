...
public abstract class MinimalLogger : MinimalActorRef
{
    ...
    ///     This exception is automatically thrown since <see cref="MinimalLogger" />
    ///     does not support this property.
    /// </exception>
    public sealed override IActorRefProvider Provider =>
        throw new NotSupportedException("This logger does not provide.");
    ...
    internal static void PrintLogEvent(LogEvent logEvent, LogFilterEvaluator filter)
    {
        ...
        catch (FormatException ex)
        {
            ...
            sb.AppendFormat("[ERROR][{0}]", logEvent.Timestamp)
                ...
                .AppendFormat("Encountered System.FormatException while recording log: [{0}]",
