...
public class Poco : ISurrogated
{
    ...
    {
        return new Surrogate { TheName = Name };
    }
...
";
    ...
    public void CanSerializeTailChoppingPool()
    {
        ...
        var message = new TailChoppingPool(10, null, supervisor, "abc", TimeSpan.FromSeconds(10),
...
my-settings{
    ...
    {
        var message = new SomeMessage { ActorRef = TestActor };
    ...
    public void CanSerializeActorPathContainer()
    {
        ...
        var deserialized =
            (ContainerMessage<ActorPath>)serializer.FromBinary(serialized, typeof(ContainerMessage<ActorPath>));
    ...
    public void CanSerializeFutureActorRef()
    {
        ...
        var message = new SomeMessage { ActorRef = f };
