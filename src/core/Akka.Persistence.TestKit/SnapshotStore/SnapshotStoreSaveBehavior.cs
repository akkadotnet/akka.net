...
using InterceptorPredicate = Func<string, SnapshotSelectionCriteria, bool>;
using AsyncInterceptorPredicate = Func<string, SnapshotSelectionCriteria, Task<bool>>;
...
public class SnapshotStoreSaveBehavior
{
    ...
    public Task Pass()
    {
        return SetInterceptorAsync(SnapshotStoreInterceptors.Noop.Instance);
    }
    ...
    ///     </para>
    ///     <para>
    ///         Use this snapshot store behavior when it is needed to verify how well a persistent actor will handle network
    ///         problems
    ...
    public Task Fail()
    {
        return SetInterceptorAsync(SnapshotStoreInterceptors.Failure.Instance);
    }
    ...
    public Task FailIf(InterceptorPredicate predicate)
    {
        ...
        return SetInterceptorAsync(
            new SnapshotStoreInterceptors.OnCondition(predicate, SnapshotStoreInterceptors.Failure.Instance));
    }
    ...
    public Task FailUnless(InterceptorPredicate predicate)
    {
        ...
        return SetInterceptorAsync(
            new SnapshotStoreInterceptors.OnCondition(predicate, SnapshotStoreInterceptors.Failure.Instance, true));
    }
