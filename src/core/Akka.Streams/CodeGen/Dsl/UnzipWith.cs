...
public abstract class
    UnzipWithCreator<TIn, TOut0, TOut1> : IUnzipWithCreator<TIn, (TOut0, TOut1), UnzipWith<TIn, TOut0, TOut1>>
{
    /// <summary>
    ///     TBD
    /// </summary>
...
public abstract class
    UnzipWithCreator<TIn, TOut0, TOut1, TOut2> : IUnzipWithCreator<TIn, (TOut0, TOut1, TOut2),
    UnzipWith<TIn, TOut0, TOut1, TOut2>>
{
    /// <summary>
    ///     TBD
    /// </summary>
...
public abstract class UnzipWithCreator<TIn, TOut0, TOut1, TOut2, TOut3> : IUnzipWithCreator<TIn, (TOut0, TOut1, TOut2,
    TOut3), UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3>>
{
    /// <summary>
    ///     TBD
    /// </summary>
...
public abstract class UnzipWithCreator<TIn, TOut0, TOut1, TOut2, TOut3, TOut4> : IUnzipWithCreator<TIn, (TOut0, TOut1,
    TOut2, TOut3, TOut4), UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3, TOut4>>
{
    /// <summary>
    ///     TBD
    /// </summary>
    /// <param name="unzipper">TBD</param>
    /// <returns>TBD</returns>
    public virtual UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3, TOut4> Create(
        Func<TIn, (TOut0, TOut1, TOut2, TOut3, TOut4)> unzipper)
    {
...
public abstract class UnzipWithCreator<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5> : IUnzipWithCreator<TIn, (TOut0,
    TOut1, TOut2, TOut3, TOut4, TOut5), UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5>>
{
    /// <summary>
    ///     TBD
    /// </summary>
    /// <param name="unzipper">TBD</param>
    /// <returns>TBD</returns>
    public virtual UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5> Create(
        Func<TIn, (TOut0, TOut1, TOut2, TOut3, TOut4, TOut5)> unzipper)
    {
...
public abstract class UnzipWithCreator<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6> : IUnzipWithCreator<TIn, (
    TOut0, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6), UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>>
{
    /// <summary>
    ///     TBD
    /// </summary>
    /// <param name="unzipper">TBD</param>
    /// <returns>TBD</returns>
    public virtual UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6> Create(
        Func<TIn, (TOut0, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6)> unzipper)
    {
...
public partial class UnzipWith
{
    ...
    /// <returns>TBD</returns>
    public static UnzipWith<TIn, TOut0, TOut1> Apply<TIn, TOut0, TOut1>(Func<TIn, (TOut0, TOut1)> unzipper,
        UnzipWithCreator<TIn, TOut0, TOut1> creator)
    {
    ...
    public static UnzipWith<TIn, TOut0, TOut1, TOut2> Apply<TIn, TOut0, TOut1, TOut2>(
        Func<TIn, (TOut0, TOut1, TOut2)> unzipper, UnzipWithCreator<TIn, TOut0, TOut1, TOut2> creator)
    {
        return creator.Create(unzipper);
    }
    ...
    /// <param name="creator">TBD</param>
    /// <returns>TBD</returns>
    public static UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3> Apply<TIn, TOut0, TOut1, TOut2, TOut3>(
        Func<TIn, (TOut0, TOut1, TOut2, TOut3)> unzipper, UnzipWithCreator<TIn, TOut0, TOut1, TOut2, TOut3> creator)
    {
        return creator.Create(unzipper);
    }
    ...
    /// <param name="creator">TBD</param>
    /// <returns>TBD</returns>
    public static UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3, TOut4> Apply<TIn, TOut0, TOut1, TOut2, TOut3, TOut4>(
        Func<TIn, (TOut0, TOut1, TOut2, TOut3, TOut4)> unzipper,
        UnzipWithCreator<TIn, TOut0, TOut1, TOut2, TOut3, TOut4> creator)
    {
        return creator.Create(unzipper);
    }
    ...
    /// <param name="creator">TBD</param>
    /// <returns>TBD</returns>
    public static UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5>
        Apply<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5>(
            Func<TIn, (TOut0, TOut1, TOut2, TOut3, TOut4, TOut5)> unzipper,
            UnzipWithCreator<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5> creator)
    {
        return creator.Create(unzipper);
    }
    ...
    /// <param name="creator">TBD</param>
    /// <returns>TBD</returns>
    public static UnzipWith<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>
        Apply<TIn, TOut0, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>(
            Func<TIn, (TOut0, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6)> unzipper,
