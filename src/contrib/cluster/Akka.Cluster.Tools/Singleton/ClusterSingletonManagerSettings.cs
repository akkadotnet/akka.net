...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public static ClusterSingletonManagerSettings Create(Config config)
    {
        ...
        return new ClusterSingletonManagerSettings(
            ...
            RoleOption(config.GetString("role")),
            TimeSpan.Zero, // defaults to ClusterSettings.DownRemovalMargin
            config.GetTimeSpan("hand-over-retry-interval"),
            lease,
            config.GetBoolean("consider-app-version"));
    }
