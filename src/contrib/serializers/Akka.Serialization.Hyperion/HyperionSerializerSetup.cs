...
{
    public static readonly HyperionSerializerSetup Empty = new(null, null, null, null, null, null, null);
    ...
    public static HyperionSerializerSetup Create(
        ...
        Type knownTypesProvider)
    {
        return new HyperionSerializerSetup(preserveObjectReferences, versionTolerance, knownTypesProvider, null, null,
            null,
    ...
    public static HyperionSerializerSetup Create(
        ...
        IEnumerable<Func<string, string>> packageNameOverrides)
    {
        return new HyperionSerializerSetup(preserveObjectReferences, versionTolerance, knownTypesProvider,
            packageNameOverrides, null, null,
            DisabledTypeFilter.Instance);
    }
    ...
    {
        return new HyperionSerializerSetup(preserveObjectReferences, versionTolerance, knownTypesProvider,
            packageNameOverrides, surrogates,
            null, DisabledTypeFilter.Instance);
    }
    ...
    internal HyperionSerializerSettings ApplySettings(HyperionSerializerSettings settings)
    {
        ...
        if (DisallowUnsafeType is not null)
    ...
    {
        return new HyperionSerializerSetup(
            preserveObjectReferences ?? PreserveObjectReferences,
            versionTolerance ?? VersionTolerance,
            knownTypesProvider ?? KnownTypesProvider,
            packageNameOverrides ?? PackageNameOverrides,
