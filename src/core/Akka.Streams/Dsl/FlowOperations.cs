...
namespace Akka.Streams.Dsl
{
    ...
    public static class FlowOperations
    {
        ...
        /// </para>
        /// <para>
        /// Completes when <paramref name="predicate"/> returned true or upstream completes
        /// </para>
        /// <para>
        /// Cancels when downstream cancels
        /// </para>
        ...
        /// <param name="predicate">TBD</param>
        /// <returns>TBD</returns>
        public static Flow<TIn, TOut, TMat> TakeUntil<TIn, TOut, TMat>(this IFlow<TOut, TMat> flow, Predicate<TOut> predicate)
        {
            return (Flow<TIn, TOut, TMat>)InternalFlowOperations.TakeUntil(flow, predicate);
        }
