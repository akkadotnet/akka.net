...
public class PNCounterSpec
{
    ...
    {
        _address1 = new UniqueAddress(new Address("akka.tcp", "PNCounterSpec", "some.host.org", 112), 1);
        _address2 = new UniqueAddress(new Address("akka.tcp", "PNCounterSpec2", "other.host.org", 112), 2);
    }
    ...
    [Fact]
    public void
        PNCounter_must_be_able_to_summarize_the_history_to_the_correct_aggregated_value_of_increments_and_decrements()
    {
        var c1 = new PNCounter();
