...
public class Sample<T> : GraphStage<FlowShape<T, T>>
{
    ...
    /// </summary>
    /// <param name="maxStep">
    ///     must > 0, default 1000, the randomly step will be between 1 (inclusive) and
    ///     <paramref name="maxStep" /> (inclusive)
    /// </param>
    ...
    private sealed class Logic : GraphStageLogic
    {
        ...
        public Logic(Sample<T> sample) : base(sample.Shape)
        {
            ...
            SetHandler(sample.Out, () => { Pull(sample.In); });
        }
