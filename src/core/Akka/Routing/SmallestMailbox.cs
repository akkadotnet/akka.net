...
public sealed class SmallestMailboxPool : Pool
{
    ...
    ///     Initializes a new instance of the <see cref="SmallestMailboxPool" /> class.
    ///     <note>
    ///         A <see cref="SmallestMailboxPool" /> configured in this way uses the
    ...
    public class SmallestMailboxPoolSurrogate : ISurrogate
    {
        ...
        {
            return new SmallestMailboxPool(NrOfInstances, Resizer, SupervisorStrategy, RouterDispatcher,
                UsePoolDispatcher);
        }
    }
}