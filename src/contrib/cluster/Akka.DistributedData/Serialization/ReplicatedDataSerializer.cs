    ...
    public sealed class ReplicatedDataSerializer : SerializerWithStringManifest
    {
        ...
        public override byte[] ToBinary(object o)
        {
            switch (o)
            {
                ...
                case VersionVector vector: return SerializationSupport.VersionVectorToProto(vector).ToByteArray();
                case GCounter counter: return ToProto(counter).ToByteArray();
                case PNCounter counter: return ToProto(counter).ToByteArray();
                case Flag flag: return ToProto(flag).ToByteArray();
