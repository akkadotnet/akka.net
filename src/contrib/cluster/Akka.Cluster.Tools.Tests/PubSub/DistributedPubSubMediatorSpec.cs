...
namespace Akka.Cluster.Tools.Tests.PubSub
{
    ...
    public abstract class DistributedPubSubMediatorSpec : MultiNodeClusterSpec
    {
        ...
        public class TestChatUser : ReceiveActor
        {
            ...
            {
                Receive<Whisper>(w => mediator.Tell(new DistributedPubSubMediator.Send(w.Path, w.Message, true)));
                Receive<Talk>(t => mediator.Tell(new DistributedPubSubMediator.SendToAll(t.Path, t.Message)));
                Receive<TalkToOthers>(t => mediator.Tell(new DistributedPubSubMediator.SendToAll(t.Path, t.Message, true)));
                Receive<Shout>(s => mediator.Tell(new DistributedPubSubMediator.Publish(s.Topic, s.Message)));
                Receive<ShoutToGroup>(s => mediator.Tell(new DistributedPubSubMediator.Publish(s.Topic, s.Message, true)));
                Receive<JoinGroup>(j => mediator.Tell(new DistributedPubSubMediator.Subscribe(j.Topic, Self, j.Group)));
                Receive<ExitGroup>(j => mediator.Tell(new DistributedPubSubMediator.Unsubscribe(j.Topic, Self, j.Group)));
        ...
        public class Publisher : ReceiveActor
        {
            public Publisher()
            {
                ...
                Receive<string>(input => mediator.Tell(new DistributedPubSubMediator.Publish("content", input.ToUpperInvariant())));
            }
        }
        ...
        public class Subscriber : UntypedActor
        {
            ...
            public Subscriber()
            {
                ...
                _mediator.Tell(new DistributedPubSubMediator.Subscribe("content", Self));
            }

            protected override void OnReceive(object message)
            {
                var ack = message as DistributedPubSubMediator.SubscribeAck;
        ...
        public void DistributedPubSubMediator_should_keep_track_of_added_users()
        {
            ...
            Within(TimeSpan.FromSeconds(15), () =>
            {
                RunOn(() =>
                {
                    ...
                    Mediator.Tell(new DistributedPubSubMediator.Put(u1));
                    var u2 = CreateChatUser("u2");
                    Mediator.Tell(new DistributedPubSubMediator.Put(u2));
                ...
                RunOn(() =>
                {
                    ...
                    Mediator.Tell(new DistributedPubSubMediator.Put(u3));
                }, _second);
                ...
                RunOn(() =>
                {
                    ...
                    Mediator.Tell(new DistributedPubSubMediator.Put(u4));
                }, _second);
        ...
        public void DistributedPubSubMediator_should_replicate_users_to_new_node()
        {
            ...
            Within(TimeSpan.FromSeconds(20), () =>
            {
                ...
                RunOn(() =>
                {
                    ...
                    Mediator.Tell(new DistributedPubSubMediator.Put(u5));
                }, _third);
        ...
        public void DistributedPubSubMediator_should_keep_track_of_removed_users()
        {
            ...
            Within(TimeSpan.FromSeconds(15), () =>
            {
                ...
                Mediator.Tell(new DistributedPubSubMediator.Put(u6));
            });
            AwaitCount(6);
            ...
            RunOn(() =>
            {
                Mediator.Tell(new DistributedPubSubMediator.Remove("/user/u6"));
            }, _first);
            AwaitCount(5);
        ...
        public void DistributedPubSubMediator_should_publish()
        {
            ...
            Within(TimeSpan.FromSeconds(15), () =>
            {
                RunOn(() =>
                {
                    ...
                    Mediator.Tell(new DistributedPubSubMediator.Put(u7));
                }, _first, _second);
                AwaitCount(6);
        ...
        public void DistributedPubSubMediator_should_publish_to_topic()
        {
            ...
            Within(TimeSpan.FromSeconds(15), () =>
            {
                RunOn(() =>
                {
                    var s8 = new DistributedPubSubMediator.Subscribe("topic1", CreateChatUser("u8"));
                    Mediator.Tell(s8);
                    ExpectMsg<DistributedPubSubMediator.SubscribeAck>(x => x.Subscribe.Equals(s8));
                    var s9 = new DistributedPubSubMediator.Subscribe("topic1", CreateChatUser("u9"));
                    Mediator.Tell(s9);
                    ExpectMsg<DistributedPubSubMediator.SubscribeAck>(x => x.Subscribe.Equals(s9));
                }, _first);

                RunOn(() =>
                {
                    var s10 = new DistributedPubSubMediator.Subscribe("topic1", CreateChatUser("u10"));
                    Mediator.Tell(s10);
                    ExpectMsg<DistributedPubSubMediator.SubscribeAck>(x => x.Subscribe.Equals(s10));
                }, _second);
        ...
        public void DistributedPubSubMediator_should_SendAll_to_all_other_nodes()
        {
            ...
            Within(TimeSpan.FromSeconds(15), () =>
            {
                RunOn(() =>
                {
                    ...
                    Mediator.Tell(new DistributedPubSubMediator.Put(u11));
        ...
        public void DistributedPubSubMediator_should_send_one_message_to_each_group()
        {
            ...
            Within(TimeSpan.FromSeconds(20), () =>
            {
                RunOn(() =>
                {
                    ...
                    ExpectMsg<DistributedPubSubMediator.SubscribeAck>(s => s.Subscribe.Topic == "topic2"
                ...
                RunOn(() =>
                {
                    ...
                    ExpectMsg<DistributedPubSubMediator.UnsubscribeAck>(s => s.Unsubscribe.Topic == "topic2"
        ...
        public void DistributedPubSubMediator_should_transfer_delta_correctly()
        {
            ...
            RunOn(() =>
            {
                Mediator.Tell(new Tools.PubSub.Internal.Status(new Dictionary<Address, long>()));
            ...
            RunOn(() =>
            {
                ...
                {
                    Mediator.Tell(new DistributedPubSubMediator.Put(CreateChatUser("u" + (i + 1000))));
                }
                ...
                Mediator.Tell(new Tools.PubSub.Internal.Status(deltaBuckets1.ToDictionary(b => b.Owner, b => b.Version)));
                var deltaBuckets2 = ExpectMsg<Delta>().Buckets;
                Assert.Equal(500, deltaBuckets2.Sum(x => x.Content.Count));

                Mediator.Tell(new Tools.PubSub.Internal.Status(deltaBuckets2.ToDictionary(b => b.Owner, b => b.Version)));
        ...
        public void DistributedPubSubMediator_should_receive_proper_UnsubscribeAck_message()
        {
            ...
            Within(TimeSpan.FromSeconds(15), () =>
            {
                RunOn(() =>
                {
                    ...
                    var s1 = new DistributedPubSubMediator.Subscribe(topic, user);
                    Mediator.Tell(s1);
                    ExpectMsg<DistributedPubSubMediator.SubscribeAck>(x => x.Subscribe.Equals(s1));
                    var uns = new DistributedPubSubMediator.Unsubscribe(topic, user);
                    Mediator.Tell(uns);
                    ExpectMsg<DistributedPubSubMediator.UnsubscribeAck>(x => x.Unsubscribe.Equals(uns));
                }, _first);
        ...
        public void DistributedPubSubMediator_should_get_topics_after_simple_publish()
        {
            ...
            Within(TimeSpan.FromSeconds(15), () =>
            {
                RunOn(() =>
                {
                    var s1 = new DistributedPubSubMediator.Subscribe("topic_a1", CreateChatUser("u14"));
                    Mediator.Tell(s1);
                    ExpectMsg<DistributedPubSubMediator.SubscribeAck>(x => x.Subscribe.Equals(s1));

                    var s2 = new DistributedPubSubMediator.Subscribe("topic_a1", CreateChatUser("u15"));
                    Mediator.Tell(s2);
                    ExpectMsg<DistributedPubSubMediator.SubscribeAck>(x => x.Subscribe.Equals(s2));

                    var s3 = new DistributedPubSubMediator.Subscribe("topic_a2", CreateChatUser("u16"));
                    Mediator.Tell(s3);
                    ExpectMsg<DistributedPubSubMediator.SubscribeAck>(x => x.Subscribe.Equals(s3));

                }, _first);

                RunOn(() =>
                {
                    var s3 = new DistributedPubSubMediator.Subscribe("topic_a1", CreateChatUser("u17"));
                    Mediator.Tell(s3);
                    ExpectMsg<DistributedPubSubMediator.SubscribeAck>(x => x.Subscribe.Equals(s3));
                ...
                RunOn(() =>
                {
                    Mediator.Tell(DistributedPubSubMediator.GetTopics.Instance);
                    ExpectMsg<DistributedPubSubMediator.CurrentTopics>(
                ...
                RunOn(() =>
                {
                    ...
                    {
                        Mediator.Tell(DistributedPubSubMediator.GetTopics.Instance);
                        var topics = ExpectMsg<DistributedPubSubMediator.CurrentTopics>().Topics;
