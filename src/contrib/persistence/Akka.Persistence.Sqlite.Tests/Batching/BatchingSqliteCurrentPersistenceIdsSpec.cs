...
public class BatchingSqliteCurrentPersistenceIdsSpec : CurrentPersistenceIdsSpec
{
    ...
    public BatchingSqliteCurrentPersistenceIdsSpec(ITestOutputHelper output) : base(Config(Counter.GetAndIncrement()),
        nameof(BatchingSqliteCurrentPersistenceIdsSpec), output)
    {
