...
public interface ITellScheduler
{
    ...
    ///     A cancelable used to cancel sending the message. Once the message has been sent, it cannot be
    ///     canceled.
    /// </param>
    ...
    /// <param name="message">The message that is being sent.</param>
    /// <param name="sender">The actor that sent the message.</param>
    void ScheduleTellRepeatedly(TimeSpan initialDelay, TimeSpan interval, ICanTell receiver, object message,
        IActorRef sender);
    ...
    /// <param name="sender">The actor that sent the message.</param>
    /// <param name="cancelable">
    ///     An cancelable used to cancel sending the message. Once the message has been sent, it cannot be
    ///     canceled.
    /// </param>
    void ScheduleTellRepeatedly(TimeSpan initialDelay, TimeSpan interval, ICanTell receiver, object message,
