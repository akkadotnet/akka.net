...
public class SnapshotSpec : PersistenceSpec
{
    ...
    public void PersistentActor_should_recover_state_starting_from_the_most_recent_snapshot()
    {
        ...
        var offer = ExpectMsg<SnapshotOffer>(o =>
            o.Metadata.PersistenceId == persistenceId && o.Metadata.SequenceNr == 4);
    ...
    [Fact]
    public void
        PersistentActor_should_recover_state_starting_from_the_most_recent_snapshot_matching_an_upper_sequence_number_bound()
    {
        ActorOf(() => new LoadSnapshotTestActor(Name, new Recovery(SnapshotSelectionCriteria.Latest, 3), TestActor));
        var persistenceId = Name;

        var offer = ExpectMsg<SnapshotOffer>(o =>
            o.Metadata.PersistenceId == persistenceId && o.Metadata.SequenceNr == 2);
    ...
    [Fact]
    public void
        PersistentActor_should_recover_state_starting_from_the_most_recent_snapshot_matching_an_upper_sequence_number_bound_without_further_replay()
    {
        var pref = ActorOf(() =>
            new LoadSnapshotTestActor(Name, new Recovery(SnapshotSelectionCriteria.Latest, 4), TestActor));
        var persistenceId = Name;
    ...
    [Fact]
    public void
        PersistentActor_should_recover_state_starting_from_the_most_recent_snapshot_matching_criteria_and_an_upper_sequence_number_bound()
    {
    ...
    public void PersistentActor_should_support_single_snapshot_deletions()
    {
        ...
        var pref = ActorOf(() =>
            new DeleteSnapshotTestActor(Name, new Recovery(SnapshotSelectionCriteria.Latest, 4), TestActor));
        var persistenceId = Name;
        ...
        var offer2 =
            ExpectMsg<SnapshotOffer>(o => o.Metadata.PersistenceId == persistenceId && o.Metadata.SequenceNr == 2);
    ...
    internal class SaveSnapshotTestActor : NamedPersistentActor
    {
        ...
        protected override bool ReceiveCommand(object message)
        {
            ...
            {
                case string payload:
                    Persist(payload, _ => { State = State.AddFirst(payload + "-" + LastSequenceNr); });
                    return true;
                case TakeSnapshot _:
                    SaveSnapshot(State);
                    return true;
