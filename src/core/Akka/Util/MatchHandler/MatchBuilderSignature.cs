...
///     Two signatures are equal if they contain the same <see cref="Type">Types</see> and
///     <see cref="HandlerKind">HandlerKinds</see>
///     in the same order.
/// </summary>
internal class MatchBuilderSignature : IEquatable<MatchBuilderSignature>
{
    ...
    public override int GetHashCode()
    {
        ...
        for (var i = 1; i < count; i++) hashCode = (hashCode * 397) ^ _list[i].GetHashCode();
        return hashCode;
    }
