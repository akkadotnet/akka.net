...
public partial class ReceiveActorTests : AkkaSpec
{
    ...
    [Fact]
    public async Task
        Given_an_actor_which_uses_predicates_When_sending_different_messages_Then_correct_handler_should_be_invoked()
    {
        //Given
        var system = ActorSystem.Create("test");
    ...
    [Fact]
    public async Task
        Given_an_actor_that_uses_non_generic_and_predicates_When_sending_different_messages_Then_correct_handler_should_be_invoked()
    {
        //Given
        var system = ActorSystem.Create("test");
    ...
    [Fact]
    public async Task
        Given_an_actor_with_ReceiveAny_When_sending_different_messages_Then_correct_handler_should_be_invoked()
    {
        //Given
        var system = ActorSystem.Create("test");
    ...
    [Fact]
    public async Task
        Given_an_actor_which_overrides_PreStart_When_sending_a_message_Then_the_message_should_be_handled()
    {
        //Given
    ...
    private class TypePredicatesActor : ReceiveActor
    {
        public TypePredicatesActor()
        {
            ...
            Receive(typeof(int), i => Sender.Tell("int<10:" + i, Self),
            ...
            Receive(typeof(int), i => Sender.Tell("int:" + i, Self)); //Null predicate,  when i >= 15
            Receive(typeof(int),
