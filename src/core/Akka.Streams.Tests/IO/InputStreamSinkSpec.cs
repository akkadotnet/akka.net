...
namespace Akka.Streams.Tests.IO
{
    public class InputStreamSinkSpec : AkkaSpec
    {
        ...
        [Fact]
        public Task InputStreamSink_should_fail_to_materialize_with_zero_sized_input_buffer()
        {
        ...
        [Fact]
        public Task InputStreamSink_should_throw_from_inputstream_read_if_terminated_abruptly()
        {
            var materializer = ActorMaterializer.Create(Sys);
