...
/// </summary>
[InternalApi]
internal class CachingConfig : Config
{
    ...
    ///     TBD
    /// </summary>
    public override HoconValue Root => _config.Root;

    /// <summary>
    ///     TBD
    /// </summary>
    public override bool IsEmpty => _config.IsEmpty;
                ...
                if (_config.HasPath(path)) //found something
                    try
                    {
                        ...
                        if (configValue == null) //empty
                            ...
                            pathEntry = new StringPathEntry(true, true, configValue.AtKey("cached"),
    ...
    private static readonly IPathEntry InvalidPathEntry = new ValuePathEntry(false, true);
    private static readonly IPathEntry NonExistingPathEntry = new ValuePathEntry(true, false);
    private static readonly IPathEntry EmptyPathEntry = new ValuePathEntry(true, true);
