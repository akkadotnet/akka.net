    ...
    ICurrentAllEventsQuery
{
    ...
    private static readonly AtomicCounter _idCounter = new(0);
    ...
    public Source<EventEnvelope, NotUsed> CurrentAllEvents(Offset offset)
    {
        ...
        return Source
            .ActorPublisher<EventEnvelope>(AllEventsPublisher.Props(seq.Value, null, _maxBufferSize, _journalRef,
                _throttlerRef))
            .MapMaterializedValue(_ => NotUsed.Instance)
    ...
    {
        return Source.ActorPublisher<string>(CurrentPersistenceIdsPublisher.Props(_journalRef, _throttlerRef))
            .MapMaterializedValue(_ => NotUsed.Instance)
    ...
    public Source<EventEnvelope, NotUsed> EventsByPersistenceId(string persistenceId, long fromSequenceNr,
        long toSequenceNr)
    {
        return Source.ActorPublisher<EventEnvelope>(EventsByPersistenceIdPublisher.Props(persistenceId, fromSequenceNr,
