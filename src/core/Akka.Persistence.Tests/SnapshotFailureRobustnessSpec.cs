...
{
    public SnapshotFailureRobustnessSpec() : base(Configuration("SnapshotFailureRobustnessSpec", "off",
        @"
...
"))
    ...
    [Fact]
    public void
        PersistentActor_with_a_failing_snapshot_should_recover_state_starting_from_the_most_recent_complete_snapshot()
    {
    ...
    [Fact]
    public void
        PersistentActor_with_a_failing_snapshot_should_fail_recovery_and_stop_actor_when_no_snapshot_could_be_loaded()
    {
        var spref = Sys.ActorOf(Props.Create(() => new SaveSnapshotTestActor(Name, TestActor)));
    ...
    [Fact]
    public void
        PersistentActor_with_a_failing_snapshot_should_receive_failure_message_when_deleting_a_single_snapshot_fails()
    {
    ...
    [Fact]
    public void
        PersistentActor_with_a_failing_snapshot_should_receive_failure_message_when_bulk_deleting_snapshots_fails()
    {
        var pref = Sys.ActorOf(Props.Create(() => new DeleteSnapshotTestActor(Name, TestActor)));
