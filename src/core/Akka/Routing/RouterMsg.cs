...
/// <summary>
///     This class represents a message used to carry information about what routees a <see cref="Router" /> is currently
///     using.
/// </summary>
...
///     it to increase or decrease the number of allotted routees the router can use. It may be handled after other
///     messages.
///     <remarks>
