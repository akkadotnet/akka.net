...
public static class FlowOperations
{
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Recover<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
    ...
    ///     behave exactly the same as  <see cref="RecoverWithRetries{TIn,TOut,TMat}" />.
    ///     <para>
    ///         Since the underlying failure signal onError arrives out-of-band, it might jump over existing elements.
    ///         This stage can recover the failure signal, but not the skipped elements, which will be dropped.
    ///     </para>
    ...
    /// <summary>
    ///     While similar to <see cref="Recover{TIn,TOut,TMat}" /> this stage can be used to transform an error signal to a
    ...
    ///     should be applied
    /// </param>
    public static Flow<TIn, TOut, TMat> SelectError<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
    ...
    {
        return (Flow<TIn, TOut, TMat>)InternalFlowOperations.WireTap(flow, action);
    }
    ...
    /// <returns>TBD</returns>
    public static Flow<T, TOut, TMat> SelectMany<T, TIn, TOut, TMat>(this Flow<T, TIn, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Flow<T, TOut, TMat> SelectAsync<T, TIn, TOut, TMat>(this Flow<T, TIn, TMat> flow, int parallelism,
    ...
    ///     the first argument to <see cref="SelectAsyncUnordered{T,TIn,TOut,TMat}" />. Each processed element will be emitted
    ///     dowstream
    ...
    /// <param name="asyncMapper">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<T, TOut, TMat> SelectAsyncUnordered<T, TIn, TOut, TMat>(this Flow<T, TIn, TMat> flow,
        int parallelism, Func<TIn, Task<TOut>> asyncMapper)
    {
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Where<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
    ...
    /// <param name="predicate">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> WhereNot<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        Predicate<TOut> predicate)
    {
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> TakeWhile<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
    ...
    /// <param name="predicate">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> SkipWhile<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        Predicate<TOut> predicate)
    {
    ...
    public static Flow<TIn, TOut2, TMat> Collect<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow,
    ...
    /// <summary>
    ///     Transform this stream by applying the given function <paramref name="collector" /> to each of the elements
    ///     on which the function is defined (read: <paramref name="isDefined" /> returns true) as they pass through this
    ///     processing step.
    ///     Non-matching elements are filtered out.
    ///     <para>
    ///         Emits when the provided function <paramref name="collector" /> is defined for the element
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> LimitWeighted<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, long max,
        Func<TOut, long> costFunc)
    {
    ...
    /// </exception>
    /// <returns>TBD</returns>
    public static Flow<TIn, IEnumerable<TOut>, TMat> Sliding<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, int n,
        int step = 1)
    {
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat> Scan<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow, TOut2 zero,
    ...
    /// <param name="scan">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat> ScanAsync<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow,
        TOut2 zero, Func<TOut2, TOut1, Task<TOut2>> scan)
    {
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat> Aggregate<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow,
        TOut2 zero, Func<TOut2, TOut1, TOut2> fold)
    {
    ...
    /// <param name="fold">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat> AggregateAsync<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow,
        TOut2 zero,
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Sum<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
    ...
    /// </exception>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Intersperse<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, TOut start,
        TOut inject, TOut end)
    {
    ...
    /// </exception>
    /// <returns>TBD</returns>
    public static Flow<TIn, IEnumerable<TOut>, TMat> GroupedWithin<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        int n, TimeSpan timeout)
    {
    ...
    ///     since the previously emitted group.
    ///     <para>
    ///         <paramref name="maxWeight" /> must be positive, <paramref name="maxNumber" /> must be positive, and
    ///         <paramref name="interval" /> must be greater than 0 seconds,
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, IEnumerable<TOut>, TMat> GroupedWeightedWithin<TIn, TOut, TMat>(
        this Flow<TIn, TOut, TMat> flow, long maxWeight, int maxNumber, TimeSpan interval, Func<TOut, long> costFn)
    {
        return (Flow<TIn, IEnumerable<TOut>, TMat>)InternalFlowOperations.GroupedWeightedWithin(flow, maxWeight,
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Delay<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, TimeSpan of,
    ...
    ///     be different than the input type. See <see cref="Conflate{TIn,TOut,TMat}" /> for a simpler version that does not
    ///     change types.
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TSeed, TMat> ConflateWithSeed<TIn, TOut, TMat, TSeed>(this Flow<TIn, TOut, TMat> flow,
        Func<TOut, TSeed> seed, Func<TSeed, TOut, TSeed> aggregate)
    {
    ...
    ///     <see cref="ConflateWithSeed{TIn,TOut,TMat,TSeed}" />
    ...
    /// <param name="aggregate">Takes the currently aggregated value and the current pending element to produce a new aggregate</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Conflate<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
    ...
    ///         Cancels when downstream cancels
    ///     </para>
    ///     See also <seealso cref="ConflateWithSeed{TIn,TOut,TMat,TSeed}" />,
    ///     <seealso cref="BatchWeighted{TIn,TOut,TOut2,TMat}" />
    /// </summary>
    /// <typeparam name="TIn">TBD</typeparam>
    /// <typeparam name="TOut">TBD</typeparam>
    /// <typeparam name="TOut2">TBD</typeparam>
    ...
    /// <param name="aggregate">Takes the currently batched value and the current pending element to produce a new aggregate</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat> BatchWeighted<TIn, TOut, TOut2, TMat>(this Flow<TIn, TOut, TMat> flow,
        long max, Func<TOut, long> costFunction,
        Func<TOut, TOut2> seed, Func<TOut2, TOut, TOut2> aggregate)
    {
    ...
    ///     subscriber.
    ///     Expand does not support <see cref="Supervision.Directive.Restart" /> and
    ///     <see cref="Supervision.Directive.Resume" />.
    ...
    /// </param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat> Expand<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow,
    ...
    /// <param name="strategy">Strategy that is used when incoming elements cannot fit inside the buffer</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Buffer<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, int size,
    ...
    public static Flow<TIn, TOut2, TMat> Transform<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow,
    ...
    /// <param name="n">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, (IImmutableList<TOut>, Source<TOut, NotUsed>), TMat> PrefixAndTail<TIn, TOut, TMat>(
        this Flow<TIn, TOut, TMat> flow, int n)
    {
        return (Flow<TIn, (IImmutableList<TOut>, Source<TOut, NotUsed>), TMat>)
            InternalFlowOperations.PrefixAndTail(flow, n);
    }
    ...
    ///     </para>
    ///     <para>
    ///         Function <paramref name="groupingFunc" /> MUST NOT return <c>null</c>. This will throw exception and trigger
    ///         supervision decision mechanism.
    ///     </para>
    ///     <para>
    ...
    /// <param name="allowClosedSubstreamRecreation">
    ///     Enables recreation of already closed substreams if elements with their
    ///     corresponding keys arrive after completion
    /// </param>
    /// <returns>TBD</returns>
    public static SubFlow<TOut, TMat, Sink<TIn, TMat>> GroupBy<TIn, TOut, TMat, TKey>(this Flow<TIn, TOut, TMat> flow,
        int maxSubstreams, Func<TOut, TKey> groupingFunc, bool allowClosedSubstreamRecreation)
    {
        return flow.GroupBy(maxSubstreams, groupingFunc, (f, s) => ((Flow<TIn, Source<TOut, NotUsed>, TMat>)f).To(s),
    ...
    /// </summary>
    public static SubFlow<TOut, TMat, Sink<TIn, TMat>> GroupBy<TIn, TOut, TMat, TKey>(this Flow<TIn, TOut, TMat> flow,
        int maxSubstreams, Func<TOut, TKey> groupingFunc)
    {
        return flow.GroupBy(maxSubstreams, groupingFunc, (f, s) => ((Flow<TIn, Source<TOut, NotUsed>, TMat>)f).To(s),
            false);
    }
    ...
    ///     }}}
    ///     The object returned from this method is not a normal <see cref="Source{TOut,TMat}" /> or
    ...
    ///     <see cref="SplitWhen{TIn,TOut,TMat}(Flow{TIn,TOut,TMat},SubstreamCancelStrategy,Func{TOut,bool})" />
    ...
    /// <param name="predicate">TBD</param>
    /// <returns>TBD</returns>
    public static SubFlow<TOut, TMat, Sink<TIn, TMat>> SplitWhen<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        SubstreamCancelStrategy substreamCancelStrategy, Func<TOut, bool> predicate)
    {
        return flow.SplitWhen(substreamCancelStrategy, predicate,
    ...
    ///     It is important to note that the substreams also propagate back-pressure as
    ///     any other stream, which means that blocking one substream will block the
    ///     <see cref="SplitAfter{TIn,TOut,TMat}(Flow{TIn,TOut,TMat},SubstreamCancelStrategy,Func{TOut,bool})" />
    ///     operator itself—and thereby all substreams—once all internal or
    ///     explicit buffers are filled.
    ///     If the split <paramref name="predicate" /> throws an exception and the supervision decision
    ///     is <see cref="Supervision.Directive.Stop" /> the stream and substreams will be completed
    ...
    /// <param name="predicate">TBD</param>
    /// <returns>TBD</returns>
    public static SubFlow<TOut, TMat, Sink<TIn, TMat>> SplitAfter<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        SubstreamCancelStrategy substreamCancelStrategy, Func<TOut, bool> predicate)
    {
        return flow.SplitAfter(substreamCancelStrategy, predicate,
            (f, s) => ((Flow<TIn, Source<TOut, NotUsed>, TMat>)f).To(s));
    }
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat> ConcatMany<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow,
    ...
    /// <param name="flatten">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat> MergeMany<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow,
        int breadth, Func<TOut1, IGraph<SourceShape<TOut2>, TMat>> flatten)
    {
    ...
    /// <param name="timeout">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> InitialTimeout<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        TimeSpan timeout)
    {
    ...
    /// <param name="timeout">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> CompletionTimeout<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        TimeSpan timeout)
    {
    ...
    /// <param name="timeout">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> BackpressureTimeout<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        TimeSpan timeout)
    {
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TInjected, TMat> KeepAlive<TIn, TOut, TInjected, TMat>(this Flow<TIn, TOut, TMat> flow,
        TimeSpan timeout, Func<TInjected> injectElement) where TOut : TInjected
    {
    ...
    /// </exception>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Throttle<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, int elements,
        TimeSpan per, int maximumBurst, ThrottleMode mode)
    {
    ...
    /// <param name="mode">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Throttle<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, int cost,
        TimeSpan per, int maximumBurst, Func<TOut, int> calculateCost, ThrottleMode mode)
    {
        return (Flow<TIn, TOut, TMat>)InternalFlowOperations.Throttle(flow, cost, per, maximumBurst, calculateCost,
            mode);
    }

    /// <summary>
    ///     Attaches the given <seealso cref="Sink{TIn,TMat}" /> to this <see cref="Flow{TIn,TOut,TMat}" />, meaning that
    ...
    /// <summary>
    ///     Attaches the given <seealso cref="Sink{TIn,TMat}" /> to this <seealso cref="Flow{TIn,TOut,TMat}" />, meaning that
    ///     elements that passes
    ///     through will also be sent to the <seealso cref="Sink{TIn,TMat}" />.
    ...
    /// <param name="that">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> AlsoTo<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
    ...
    ///     <para>Cancels when downstream cancels</para>
    /// </summary>
    public static Flow<TIn, TOut, TMat> WireTap<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        IGraph<SinkShape<TOut>, TMat> that)
    {
        return (Flow<TIn, TOut, TMat>)InternalFlowOperations.WireTap(flow, that);
    }
    ...
    ///     where appropriate instead of manually writing functions that pass through one of the values.
    /// </summary>
    public static Flow<TIn, TOut, TMat3> WireTapMaterialized<TIn, TOut, TMat, TMat2, TMat3>(
        this Flow<TIn, TOut, TMat> flow, IGraph<SinkShape<TOut>, TMat2> that,
        Func<TMat, TMat2, TMat3> materializerFunction)
    {
        return (Flow<TIn, TOut, TMat3>)InternalFlowOperations.WireTapMaterialized(flow, that, materializerFunction);
    }
    ...
    public static Flow<TIn, TOut, TMat3> DivertToMaterialized<TIn, TOut, TMat, TMat2, TMat3>(
        ...
        Func<TMat, TMat2, TMat3> materializerFunction)
    {
        return (Flow<TIn, TOut, TMat3>)InternalFlowOperations.DivertToMaterialized(flow, that, when,
    ...
    /// <param name="that">TBD</param>
    /// <param name="when">TBD</param>
    public static Flow<TIn, TOut, TMat> DivertTo<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        IGraph<SinkShape<TOut>, TMat> that, Func<TOut, bool> when)
    {
        return (Flow<TIn, TOut, TMat>)InternalFlowOperations.DivertTo(flow, that, when);
    }
    ...
    /// <param name="materializerFunction">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat2> WatchTermination<TIn, TOut, TMat, TMat2>(this Flow<TIn, TOut, TMat> flow,
    ...
    /// <summary>
    ///     Materializes to <see cref="IFlowMonitor" /> that allows monitoring of the the current flow. All events are
    ///     propagated
    ///     by the monitor unchanged. Note that the monitor inserts a memory barrier every time it processes an
    ///     event, and may therefor affect performance.
    ///     The <paramref name="combine" /> function is used to combine the <see cref="IFlowMonitor" /> with this flow's
    ///     materialized value.
    /// </summary>
    /// <typeparam name="TIn">TBD</typeparam>
    /// <typeparam name="TOut">TBD</typeparam>
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Log<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, string name,
        Func<TOut, object> extract = null, ILoggingAdapter log = null)
    {
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, (T1, T2), TMat> Zip<TIn, T1, T2, TMat>(this Flow<TIn, T1, TMat> flow,
    ...
    /// <param name="combine">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, T3, TMat> ZipWith<TIn, T1, T2, T3, TMat>(this Flow<TIn, T1, TMat> flow,
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, T2, TMat> Interleave<TIn, T1, T2, TMat>(this Flow<TIn, T1, TMat> flow,
    ...
    /// <summary>
    ///     Merge the given <see cref="Source{TOut,TMat}" /> to this <see cref="Flow{TIn,TOut,TMat}" />, taking elements as
    ///     they arrive from input streams,
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut2, TMat> Merge<TIn, TOut1, TOut2, TMat>(this Flow<TIn, TOut1, TMat> flow,
        IGraph<SourceShape<TOut2>, TMat> other, bool eagerComplete = false) where TOut1 : TOut2
    {
    ...
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> MergeSorted<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
    ...
    /// <summary>
    ///     Concatenate the given <see cref="Source{TOut,TMat}" /> to this <see cref="Flow{TIn,TOut,TMat}" />, meaning that
    ///     once this
    ///     Flow’s input is exhausted and all result elements have been generated,
    ///     the Source’s elements will be produced.
    ///     Note that the <see cref="Source{TOut,TMat}" /> is materialized together with this
    ///     <see cref="Flow{TIn,TOut,TMat}" /> and just kept
    ///     from producing elements by asserting back-pressure until its time comes.
    ///     If this <see cref="Flow{TIn,TOut,TMat}" /> gets upstream error - no elements from the given
    ...
    /// <param name="other">TBD</param>
    /// <returns>TBD</returns>
    public static Flow<TIn, TOut, TMat> Concat<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        IGraph<SourceShape<TOut>, TMat> other)
    {
    ...
    {
        return (Flow<T, T, TMat>)InternalFlowOperations.OrElse(flow, secondary);
    }
    ...
    /// <returns>TBD</returns>
    public static Flow<T, T, TMat3> OrElseMaterialized<T, TMat, TMat2, TMat3>(this Flow<T, T, TMat> flow,
        IGraph<SourceShape<T>, TMat2> secondary, Func<TMat, TMat2, TMat3> materializedFunction)
    {
        return (Flow<T, T, TMat3>)InternalFlowOperations.OrElseMaterialized(flow, secondary, materializedFunction);
    }
    ...
    {
        return (Flow<T, T, TMat>)InternalFlowOperations.Watch(flow, actorRef);
    }
    ...
    public static FlowWithContext<TIn, TCtxIn, TOut, TCtxOut, TMat> AsFlowWithContext<TIn, TCtxIn, TOut, TCtxOut, TMat,
        TIn2>(
    ...
    /// </summary>
    /// <param name="flow">The previous Flow stage in this stream.</param>
    /// <param name="onItemChanged">
    ///     A <see cref="Action{TOut, TOut}" /> function that allows the stage to perform clean-up operations when the
    ///     previously repeated
    ...
    /// </remarks>
    public static Flow<TIn, TOut, TMat> RepeatPrevious<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow,
        Action<TOut, TOut> onItemChanged)
    {
