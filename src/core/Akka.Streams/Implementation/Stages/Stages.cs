...
public static class DefaultAttributes
{
    ...
    public static readonly Attributes
        IODispatcher = ActorAttributes.CreateDispatcher(ActorAttributes.IODispatcher.Name);
    ...
    ///     TBD
    /// </summary>
    public static readonly Attributes UnfoldResourceSource =
        Attributes.CreateName("unfoldResourceSource").And(IODispatcher);

    /// <summary>
    ///     TBD
    /// </summary>
    public static readonly Attributes UnfoldResourceSourceAsync =
        Attributes.CreateName("unfoldResourceSourceAsync").And(IODispatcher);
    ...
    /// </summary>
    public static readonly Attributes
        OutputStreamSource = Attributes.CreateName("outputStreamSource").And(IODispatcher);
    ...
    ///     TBD
    /// </summary>
    public static readonly Attributes FirstSink =
        Attributes.CreateName("firstSink").And(Attributes.CreateInputBuffer(1, 1));

    /// <summary>
    ///     TBD
    /// </summary>
    public static readonly Attributes FirstOrDefaultSink =
        Attributes.CreateName("firstOrDefaultSink").And(Attributes.CreateInputBuffer(1, 1));
...
public sealed class SymbolicGraphStage<TIn, TOut> : PushPullGraphStage<TIn, TOut>
{
    ...
    public SymbolicGraphStage(ISymbolicStage<TIn, TOut> symbolicStage) : base(symbolicStage.Create,
