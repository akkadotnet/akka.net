...
public static class ActorSystemWithExtensions
{
    ...
    /// <summary>
    ///     Retrieves the extension specified by a given type, <typeparamref name="T" />, from a given actor system.
    ///     If the extension does not exist within the actor system, then the extension specified by
...
/// <summary>
///     This class represents the base provider implementation for creating, registering and retrieving extensions within
///     an <see cref="ActorSystem" />.
/// </summary>
