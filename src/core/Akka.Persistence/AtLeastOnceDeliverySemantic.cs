...
public sealed class AtLeastOnceDeliverySnapshot : IMessage, IEquatable<AtLeastOnceDeliverySnapshot>
{
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            var hashCode = CurrentDeliveryId.GetHashCode();
    ...
    {
        return
            $"AtLeastOnceDeliverySnapshot<currentDeliveryId: {CurrentDeliveryId}, unconfirmedDeliveries: {UnconfirmedDeliveries.Length}>";
    }
}
...
/// <summary>
///     This exception is thrown when the <see cref="AtLeastOnceDeliverySemantic.MaxUnconfirmedMessages" /> threshold has
///     been exceeded.
/// </summary>
public class MaxUnconfirmedMessagesExceededException : Exception
{
    ...
    public MaxUnconfirmedMessagesExceededException(string message, Exception innerException) : base(message,
        innerException)
    {
    }
    ...
    ///     destination.
    /// </param>
    protected MaxUnconfirmedMessagesExceededException(SerializationInfo info, StreamingContext context) : base(info,
        context)
    {
    }
}
...
public class AtLeastOnceDeliverySemantic
{
    ...
    public sealed class RedeliveryTick : INotInfluenceReceiveTimeout, IDeadLetterSuppression
    {
        ...
        public override int GetHashCode()
        {
            return nameof(RedeliveryTick).GetHashCode();
        }
    }
    ...
    private void StartRedeliverTask()
    {
        ...
        _redeliverScheduleCancelable = _context.System.Scheduler.ScheduleTellRepeatedlyCancelable(delay,
            RedeliverInterval, _context.Self,
