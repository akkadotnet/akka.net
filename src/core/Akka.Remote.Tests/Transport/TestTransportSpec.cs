...
public class TestTransportSpec : AkkaSpec
{
    ...
    public async Task TestTransport_must_associate_successfully_with_another_TestTransport()
    {
        ...
        //assert
        var associateAttempt =
            registry.LogSnapshot().Single(x => x is AssociateAttempt).AsInstanceOf<AssociateAttempt>();
    ...
    public async Task TestTransport_should_emulate_disassociation()
    {
        ...
        var msg = await ExpectMsgOfAsync(DefaultTimeout, "Expected Disassociated",
            o => o.AsInstanceOf<Disassociated>());
        ...
        var disassociateAttempt = registry.LogSnapshot().Single(x => x is DisassociateAttempt)
            .AsInstanceOf<DisassociateAttempt>();
