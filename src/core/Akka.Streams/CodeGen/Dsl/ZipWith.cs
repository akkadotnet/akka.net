...
public partial class ZipWith
{
    ...
    /// <param name="zipper">zipping-function from the input values to the output value</param>
    /// <returns>TBD</returns>
    public static ZipWith<TIn0, TIn1, TIn2, TIn3, TOut> Apply<TIn0, TIn1, TIn2, TIn3, TOut>(
    ...
    /// <param name="zipper">zipping-function from the input values to the output value</param>
    /// <returns>TBD</returns>
    public static ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TOut> Apply<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TOut>(
        Func<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TOut> zipper)
    {
    ...
    /// <param name="zipper">zipping-function from the input values to the output value</param>
    /// <returns>TBD</returns>
    public static ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TOut> Apply<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5,
        TIn6, TOut>(Func<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TOut> zipper)
    {
    ...
    /// <param name="zipper">zipping-function from the input values to the output value</param>
    /// <returns>TBD</returns>
    public static ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TOut> Apply<TIn0, TIn1, TIn2, TIn3, TIn4,
        TIn5, TIn6, TIn7, TOut>(Func<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TOut> zipper)
    {
        return new ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TOut>(zipper);
    }

    /// <summary>
    ///     Create a new <see cref="ZipWith{TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TIn8, TOut}" /> specialized for 1
    ///     inputs.
    /// </summary>
    /// <typeparam name="TIn0">TBD</typeparam>
    /// <typeparam name="TIn1">TBD</typeparam>
    ...
    /// <param name="zipper">zipping-function from the input values to the output value</param>
    /// <returns>TBD</returns>
    public static ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TIn8, TOut> Apply<TIn0, TIn1, TIn2, TIn3,
        TIn4, TIn5, TIn6, TIn7, TIn8, TOut>(Func<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TIn8, TOut> zipper)
    {
...
public class ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TOut> : GraphStage<FanInShape<TIn0, TIn1, TIn2, TIn3, TIn4, TOut>>
{
    ...
    private sealed class Logic : OutGraphStageLogic
    {
        ...
        {
            Push(_stage.Out,
                _stage.Zipper(Grab(_stage.In0), Grab(_stage.In1), Grab(_stage.In2), Grab(_stage.In3),
                    Grab(_stage.In4)));
            if (_willShutDown)
            {
                CompleteStage();
...
/// <typeparam name="TOut">TBD</typeparam>
public class
    ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TOut> : GraphStage<FanInShape<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TOut>>
{
    /// <summary>
    ///     TBD
    /// </summary>
    ...
    private sealed class Logic : OutGraphStageLogic
    {
        ...
        {
            Push(_stage.Out,
                _stage.Zipper(Grab(_stage.In0), Grab(_stage.In1), Grab(_stage.In2), Grab(_stage.In3), Grab(_stage.In4),
                    Grab(_stage.In5)));
            if (_willShutDown)
            {
                CompleteStage();
...
/// <typeparam name="TOut">TBD</typeparam>
public class
    ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TOut> : GraphStage<
    FanInShape<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TOut>>
{
    /// <summary>
    ///     TBD
    /// </summary>
    ...
    private sealed class Logic : OutGraphStageLogic
    {
        ...
        private void PushAll()
        {
            Push(_stage.Out,
                _stage.Zipper(Grab(_stage.In0), Grab(_stage.In1), Grab(_stage.In2), Grab(_stage.In3), Grab(_stage.In4),
                    Grab(_stage.In5), Grab(_stage.In6)));
            if (_willShutDown)
            {
                CompleteStage();
            }
...
/// <typeparam name="TOut">TBD</typeparam>
public class
    ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TOut> : GraphStage<
    FanInShape<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TOut>>
{
    /// <summary>
    ///     TBD
    /// </summary>
    ...
    private sealed class Logic : OutGraphStageLogic
    {
        ...
        private void PushAll()
        {
            Push(_stage.Out,
                _stage.Zipper(Grab(_stage.In0), Grab(_stage.In1), Grab(_stage.In2), Grab(_stage.In3), Grab(_stage.In4),
                    Grab(_stage.In5), Grab(_stage.In6), Grab(_stage.In7)));
            if (_willShutDown)
            {
                CompleteStage();
            }
...
/// <typeparam name="TOut">TBD</typeparam>
public class
    ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TIn8, TOut> : GraphStage<
    FanInShape<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TIn8, TOut>>
{
    /// <summary>
    ///     TBD
    /// </summary>
    ...
    private sealed class Logic : OutGraphStageLogic
    {
        ...
        public Logic(Shape shape, ZipWith<TIn0, TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TIn8, TOut> stage) :
            base(shape)
        {
            _stage = stage;
        ...
        private void PushAll()
        {
            Push(_stage.Out,
                _stage.Zipper(Grab(_stage.In0), Grab(_stage.In1), Grab(_stage.In2), Grab(_stage.In3), Grab(_stage.In4),
                    Grab(_stage.In5), Grab(_stage.In6), Grab(_stage.In7), Grab(_stage.In8)));
            if (_willShutDown)
            {
                CompleteStage();
            }
