...
public abstract class PersistenceTestKit : Akka.TestKit.Xunit2.TestKit
{
    ...
    {
        return WithJournalRecovery(behaviorSelector, () =>
        {
            if (execution == null) throw new ArgumentNullException(nameof(execution));
    ...
    {
        return WithJournalWrite(behaviorSelector, () =>
        {
            if (execution == null) throw new ArgumentNullException(nameof(execution));
    ...
    {
        return WithSnapshotSave(behaviorSelector, () =>
        {
            if (execution == null) throw new ArgumentNullException(nameof(execution));
    ...
    {
        return WithSnapshotLoad(behaviorSelector, () =>
        {
            if (execution == null) throw new ArgumentNullException(nameof(execution));
    ...
    {
        return WithSnapshotDelete(behaviorSelector, () =>
        {
            if (execution == null) throw new ArgumentNullException(nameof(execution));
    ...
    private static ActorSystemSetup GetConfig(ActorSystemSetup customConfig)
    {
        ...
        if (actorProvider.HasValue) newSetup = newSetup.WithActorRefProvider(actorProvider.Value);
    ...
    private static Config GetConfig(Config customConfig)
    {
        ...
        return defaultConfig.SafeWithFallback(customConfig);
    }
}