...
/// <typeparam name="T">TBD</typeparam>
[Serializable]
public sealed class LWWRegister<T> : IReplicatedData<LWWRegister<T>>, IReplicatedDataSerialization,
    IEquatable<LWWRegister<T>>, ILWWRegister
{
    /// <summary>
    ...
    {
        return Merge((LWWRegister<T>)other);
    }
    ...
    {
        return obj is LWWRegister<T> register && Equals(register);
    }
    ...
    {
        return $"LWWRegister(value={Value}, timestamp={Timestamp}, updatedBy={UpdatedBy})";
    }
}