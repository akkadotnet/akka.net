...
///     A <see cref="TestActorRef{TActor}" /> can be implicitly casted to an <see cref="IActorRef" /> or you can get the
///     actual
...
#pragma warning restore CS0660 // Type defines operator == or operator != but does not override Object.Equals(object o)
{
    ...
    public TestActorRef(ActorSystem system, Props actorProps, IActorRef supervisor = null, string name = null) : base(
        system, actorProps, supervisor, name)
    {
    }
