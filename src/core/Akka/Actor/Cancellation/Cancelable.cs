...
public class Cancelable : ICancelable, IDisposable
{
    ...
    public void CancelAfter(int millisecondsDelay)
    {
        if (millisecondsDelay < 0)
            throw new ArgumentOutOfRangeException(nameof(millisecondsDelay),
                $"The delay must be >0, it was {millisecondsDelay}");
    ...
    {
        return CreateLinkedCancelable(scheduler.Advanced, cancelables.Select(c => c.Token).ToArray());
    }
    ...
    {
        return CreateLinkedCancelable(scheduler, cancelables.Select(c => c.Token).ToArray());
    }

    public static ICancelable CreateLinkedCancelable(IScheduler scheduler,
        params CancellationToken[] cancellationTokens)
    {
        return CreateLinkedCancelable(scheduler.Advanced, cancellationTokens);
    }

    public static ICancelable CreateLinkedCancelable(IActionScheduler scheduler,
        params CancellationToken[] cancellationTokens)
    {
