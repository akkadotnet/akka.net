...
///     The interval between redelivery attempts can be defined with
///     <see cref="AtLeastOnceDeliverySemantic.RedeliverInterval" />.
///     After a number of delivery attempts a <see cref="UnconfirmedWarning" /> message will be sent to
///     <see cref="ActorBase.Self" />.
///     The re-sending will continue, but you may choose <see cref="AtLeastOnceDeliverySemantic.ConfirmDelivery" /> to
///     cancel re-sending.
...
///     <see cref="AtLeastOnceDeliverySemantic.ConfirmDelivery" /> invocations from your <see cref="PersistentActor" /> so
///     that
///     the state can be restored by calling the same methods during the recovery phase of the
///     <see cref="PersistentActor" />.
///     Sometimes these events can be derived from other business level events, and sometimes you must create separate
///     events.
///     During recovery calls to <see cref="AtLeastOnceDeliverySemantic.Deliver" /> will not send out the message, but it
///     will be sent
...
///     <see cref="AtLeastOnceDeliverySemantic.SetDeliverySnapshot" />. The <see cref="AtLeastOnceDeliverySnapshot" />
///     contains
...
public abstract class AtLeastOnceDeliveryActor : PersistentActor
{
    ...
    protected AtLeastOnceDeliveryActor(
        Func<PersistenceSettings.AtLeastOnceDeliverySettings, PersistenceSettings.AtLeastOnceDeliverySettings>
            overrideSettings)
    {
    ...
    public int WarnAfterNumberOfUnconfirmedAttempts =>
        _atLeastOnceDeliverySemantic.WarnAfterNumberOfUnconfirmedAttempts;
