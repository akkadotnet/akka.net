...
public class GetKeyIds
{
    ...
    {
        return obj is GetKeyIds;
    }


    public override int GetHashCode()
    {
        return nameof(GetKeyIds).GetHashCode();
    }
}
...
public sealed class GetKeysIdsResult : IEquatable<GetKeysIdsResult>
{
    ...
    public override bool Equals(object obj)
    {
        return obj is GetKeysIdsResult result && Equals(result);
    }
    ...
    {
        return $"GetKeysIdsResult({string.Join(", ", Keys)})";
    }
}
...
public sealed class Get : ICommand, IEquatable<Get>, IReplicatorMessage
{
    ...
    public override bool Equals(object obj)
    {
        return obj is Get get && Equals(get);
    }
    ...
    public override string ToString()
    {
        return $"Get({Key}:{Consistency}{(Request == null ? "" : ", req=" + Request)})";
    }
}
...
public sealed class GetSuccess : IGetResponse, IEquatable<GetSuccess>, IReplicatorMessage
{
    ...
    public T Get<T>(IKey<T> key) where T : IReplicatedData
    {
        ...
        throw new InvalidCastException(
            $"Response returned for key '{Key}' is of type [{Data?.GetType()}] and cannot be casted using key '{key}' to type [{typeof(T)}]");
    }


    public override bool Equals(object obj)
    {
        return obj is GetSuccess success && Equals(success);
    }
    ...
    public override string ToString()
    {
        return $"GetSuccess({Key}:{Data}{(Request == null ? "" : ", req=" + Request)})";
    }
}
...
public sealed class NotFound : IGetResponse, IEquatable<NotFound>, IReplicatorMessage
{
    ...
    public override bool Equals(object obj)
    {
        return obj is NotFound found && Equals(found);
    }


    public override string ToString()
    {
        return $"NotFound({Key}{(Request == null ? "" : ", req=" + Request)})";
    }
...
public sealed class GetFailure : IGetResponse, IEquatable<GetFailure>, IReplicatorMessage
{
    ...
    public T Get<T>(IKey<T> key) where T : IReplicatedData
    {
        throw new TimeoutException(
            $"A timeout occurred when trying to retrieve a value for key '{Key}' withing given read consistency");
    }


    public override bool Equals(object obj)
    {
        return obj is GetFailure failure && Equals(failure);
    }
    ...
    public override string ToString()
    {
        return $"GetFailure({Key}{(Request == null ? "" : ", req=" + Request)})";
    }
}
...
public sealed class Subscribe : IReplicatorMessage, IEquatable<Subscribe>
{
    ...
    public override bool Equals(object obj)
    {
        return obj is Subscribe subscribe && Equals(subscribe);
    }
...
public sealed class Unsubscribe : IEquatable<Unsubscribe>, IReplicatorMessage
{
    ...
    public override bool Equals(object obj)
    {
        return obj is Unsubscribe unsubscribe && Equals(unsubscribe);
    }
...
public sealed class Changed : IChanged, IEquatable<Changed>, IReplicatorMessage
{
    ...
    public override bool Equals(object obj)
    {
        return obj is Changed changed && Equals(changed);
    }
...
///     It is <see langword="null" /> if there is no value for the <see cref="Key" />, and otherwise <see cref="Request" />
///     . The function
...
{
    public Update(IKey key, IWriteConsistency consistency, Func<IReplicatedData, IReplicatedData> modify,
        object request = null)
    {
        Key = key;
        Consistency = consistency;
    ...
    /// </summary>
    public Update(IKey key, IReplicatedData initial, IWriteConsistency consistency,
        Func<IReplicatedData, IReplicatedData> modify, object request = null)
    {
        Key = key;
        Consistency = consistency;
        Request = request;
    ...
    private IReplicatedData ModifyWithInitial(IReplicatedData initial, Func<IReplicatedData, IReplicatedData> modifier,
        IReplicatedData data)
    {
        return modifier(data ?? initial);
    }


    public override string ToString()
    {
        return $"Update({Key}, {Consistency}{(Request == null ? "" : ", req=" + Request)})";
    }
}
...
///     <ul>
///         <li>
///             <see cref="UpdateSuccess" /> when update has finished successfully with given write consistency withing
///             provided time limit.
///         </li>
///         <li><see cref="ModifyFailure" /> if a <see cref="Update.Modify" /> delegate has thrown a failure.</li>
///         <li>
///             <see cref="UpdateTimeout" /> if a request couldn't complete withing given timeout and write consistency
///             constraints.
///         </li>
///     </ul>
/// </summary>
...
public sealed class UpdateSuccess : IUpdateResponse, IEquatable<UpdateSuccess>, INoSerializationVerificationNeeded
{
    ...
    public override bool Equals(object obj)
    {
        return obj is UpdateSuccess success && Equals(success);
    }
    ...
    public override string ToString()
    {
        return $"UpdateSuccess({Key}{(Request == null ? "" : ", req=" + Request)})";
    }
}
...
public sealed class UpdateTimeout : IUpdateFailure, IEquatable<UpdateTimeout>
{
    ...
    public Exception Cause =>
        new TimeoutException(
            $"An update for key '{Key}' didn't completed within given timeout and write consistency constraints.");
    ...
    public override bool Equals(object obj)
    {
        return obj is UpdateTimeout timeout && Equals(timeout);
    }


    public override string ToString()
    {
        return $"UpdateTimeout({Key}{(Request == null ? "" : ", req=" + Request)})";
    }
...
public sealed class ModifyFailure : IUpdateFailure
{
    ...
    public override string ToString()
    {
        return $"ModifyFailure({Key}, {Cause}{(Request == null ? "" : ", req=" + Request)})";
    }
}
...
public sealed class StoreFailure : IUpdateFailure, IDeleteResponse, IEquatable<StoreFailure>
{
    ...
    public override string ToString()
    {
        return $"StoreFailure({_key}{(Request == null ? "" : ", req=" + Request)})";
    }
...
///     given <see cref="Key" />. The <see cref="Replicator" /> will reply with one of the <see cref="IDeleteResponse" />
///     messages.
/// </summary>
[Serializable]
public sealed class Delete : ICommand, INoSerializationVerificationNeeded, IEquatable<Delete>
{
    ...
    public override bool Equals(object obj)
    {
        return obj is Delete delete && Equals(delete);
    }
    ...
    public override string ToString()
    {
        return $"Delete({Key}, {Consistency}{(Request == null ? "" : ", req=" + Request)})";
    }
}
...
public sealed class DeleteSuccess : IDeleteResponse, IEquatable<DeleteSuccess>
{
    ...
    public override bool Equals(object obj)
    {
        return obj is DeleteSuccess success && Equals(success);
    }
    ...
    public override string ToString()
    {
        return $"DeleteSuccess({Key}{(Request == null ? "" : ", req=" + Request)})";
    }
}
...
public sealed class ReplicationDeleteFailure : IDeleteResponse, IEquatable<ReplicationDeleteFailure>
{
    ...
    public override bool Equals(object obj)
    {
        return obj is ReplicationDeleteFailure failure && Equals(failure);
    }
    ...
    public override string ToString()
    {
        return $"ReplicationDeletedFailure({Key})";
    }
}
...
public sealed class DataDeleted : Exception, IDeleteResponse, IGetResponse, IUpdateResponse, IEquatable<DataDeleted>
{
    ...
    public override string ToString()
    {
        return $"DataDeleted({Key}{(Request == null ? "" : ", req=" + Request)})";
    }


    public override bool Equals(object obj)
    {
        return obj is DataDeleted deleted && Equals(deleted);
    }
...
public sealed class ReplicaCount : IEquatable<ReplicaCount>
{
    ...
    public bool Equals(ReplicaCount other)
    {
        return other != null && N == other.N;
    }


    public override bool Equals(object obj)
    {
        return obj is ReplicaCount count && Equals(count);
    }
