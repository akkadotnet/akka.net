...
namespace Akka.Actor
{
    ...
    public abstract class SupervisorStrategy : ISurrogated
    {
        ...
        protected virtual void LogFailure(IActorContext context, IActorRef child, Exception cause, Directive directive)
        {
            if (LoggingEnabled)
            {
                var message = cause is ActorInitializationException actorInitializationException && actorInitializationException.InnerException != null
                    ? actorInitializationException.InnerException.Message
                    : cause.Message;
    ...
    public class AllForOneStrategy : SupervisorStrategy, IEquatable<AllForOneStrategy>
    {
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as AllForOneStrategy);
    ...
    public class DeployableDecider : IDecider, IEquatable<DeployableDecider>
    {
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as DeployableDecider);
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                var hashCode = Pairs?.GetHashCode() ?? 0;
