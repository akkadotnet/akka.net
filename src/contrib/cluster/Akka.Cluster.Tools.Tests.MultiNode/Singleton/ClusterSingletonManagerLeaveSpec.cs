...
public class ClusterSingletonManagerLeaveSpec : MultiNodeClusterSpec
{
    ...
    protected ClusterSingletonManagerLeaveSpec(ClusterSingletonManagerLeaveSpecConfig config) : base(config,
        typeof(ClusterSingletonManagerLeaveSpec))
    {
        _config = config;
    ...
    private IActorRef CreateSingleton()
    {
        return Sys.ActorOf(ClusterSingletonManager.Props(
                ClusterSingletonManagerLeaveSpecConfig.Echo.Props(TestActor),
                "stop",
    ...
    public void Leaving_ClusterSingletonManager_must_handover_to_new_instance()
    {
        ...
        RunOn(() => { Cluster.Leave(Node(_config.First).Address); }, _config.Second);
        ...
        RunOn(() => { ExpectMsg("preStart"); }, _config.Second);
        ...
        RunOn(() => { ExpectMsg("preStart"); }, _config.Third);
