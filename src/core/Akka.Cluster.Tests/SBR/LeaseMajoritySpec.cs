...
public class LeaseMajoritySpec : AkkaSpec
{
    ...
    {
        new SplitBrainResolverSettings(_default).LeaseMajoritySettings.SafeLeaseName("sysName").Should()
            .Be("sysName-akka-sbr");
        new SplitBrainResolverSettings(_blank).LeaseMajoritySettings.SafeLeaseName("sysName").Should()
            .Be("sysName-akka-sbr");
        new SplitBrainResolverSettings(_named).LeaseMajoritySettings.SafeLeaseName("sysName").Should()
            .Be("shopping-cart-akka-sbr");
    }
}