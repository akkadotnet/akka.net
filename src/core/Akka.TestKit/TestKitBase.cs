...
public abstract partial class TestKitBase : IActorRefFactory
{
    private class TestState
    {
        ...
        // These properties are nullable during initialization but become non-null after InitializeTest
    ...
    private TimeSpan SingleExpectDefaultTimeout 
    { 
        get 
        { 
            if (_testState.TestKitSettings is null)
                throw new InvalidOperationException("TestKitSettings is not initialized. Ensure InitializeTest has been called.");
            return _testState.TestKitSettings.SingleExpectDefault; 
        } 
    }
    ...
    { 
        get 
        { 
            if (_testState.System is null)
                throw new InvalidOperationException("ActorSystem is not initialized. Ensure InitializeTest has been called.");
            return _testState.System; 
        } 
    }
    ...
    { 
        ...
        { 
            if (_testState.TestKitSettings is null)
                throw new InvalidOperationException("TestKitSettings is not initialized. Ensure InitializeTest has been called.");
            return _testState.TestKitSettings; 
        } 
    }
    ...
    { 
        get 
        { 
            if (_testState.Log is null)
                throw new InvalidOperationException("Log is not initialized. Ensure InitializeTest has been called.");
            return _testState.Log; 
        } 
    }
    ...
    /// </summary>
    public IActorRef TestActor 
    { 
        get 
        { 
            if (_testState.TestActor is null)
                throw new InvalidOperationException("TestActor is not initialized. Ensure InitializeTest has been called.");
            return _testState.TestActor; 
        } 
    }
    ...
    /// </summary>
    public EventFilterFactory EventFilter 
    { 
        get 
        { 
            if (_testState.EventFilterFactory is null)
                throw new InvalidOperationException("EventFilterFactory is not initialized. Ensure InitializeTest has been called.");
            return _testState.EventFilterFactory; 
        } 
    }
    ...
    public bool HasMessages
    {
        get 
        { 
            if (_testState.Queue is null)
                throw new InvalidOperationException("Queue is not initialized. Ensure InitializeTest has been called.");
            return _testState.Queue.Reader.Count > 0; 
        }
    }
    ...
    {
        TestActor.Tell(new TestActor.SetIgnore(m => shouldIgnoreMessage(m)));
    }
    ...
    {
        TestActor.Tell(new TestActor.SetIgnore(m => m is TMsg msg && shouldIgnoreMessage(msg)));
    }
    ...
    {
        await TestActor.Ask(new TestActor.Watch(actorToWatch), RemainingOrDefault);
        return actorToWatch;
    }
    ...
    {
        await TestActor.Ask(new TestActor.Unwatch(actorToUnwatch), RemainingOrDefault);
        return actorToUnwatch;
    }
    ...
    {
        TestActor.Tell(new TestActor.SetAutoPilot(pilot));
    }
    ...
    public TimeSpan Dilated(TimeSpan duration)
    {
        ...
        return new TimeSpan((long)(duration.Ticks * TestKitSettings.TestTimeFactor));
    }
    ...
    {
        return new TestLatch(Dilated, count, TestKitSettings.DefaultTimeout);
    }
    ...
    {
        return new TestBarrier(this, count, TestKitSettings.DefaultTimeout);
    }
}