...
public class ReplicatorPruningSpec : MultiNodeClusterSpec
{
        ...
        typeof(ReplicatorPruningSpec))
    {
        ...
        _replicator = Sys.ActorOf(Replicator.Props(ReplicatorSettings.Create(Sys)
                ...
                .WithPruning(TimeSpan.FromSeconds(1),
                    _maxPruningDissemination)),
            "replicator");
    ...
    public void Pruning_of_CRDT_should_move_data_from_removed_node()
    {
        ...
        oldSet.Elements.Should().BeEquivalentTo("c", "b", "a");
        ...
        RunOn(() =>
        {
            ...
            Within(TimeSpan.FromSeconds(5), () =>
            {
                AwaitAssert(() =>
                {
                    ...
                    set.Elements.Should().BeEquivalentTo("c", "b", "a");
        ...
        RunOn(() => UpdateAfterPruning(10), First);
        EnterBarrier("update-first-after-pruning");

        RunOn(() => UpdateAfterPruning(11), Second);
        ...
        RunOn(() => UpdateAfterPruning(12), First);
        EnterBarrier("update-first-after-tombstone");

        RunOn(() => UpdateAfterPruning(13), Second);
