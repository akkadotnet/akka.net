...
{
    public ReliableDeliveryWithEventSourcedProducerQueueChunkedSpec(ITestOutputHelper output) : base(output,
...
public class ReliableDeliveryWithEventSourcedProducerQueueSpec : AkkaSpec
{
    ...
    public ReliableDeliveryWithEventSourcedProducerQueueSpec(ITestOutputHelper output) : base(
        Config.WithFallback(RemoteConfigFactory.Default()), output)
    {
    }

    protected ReliableDeliveryWithEventSourcedProducerQueueSpec(ITestOutputHelper output, Config config) : base(
        config.WithFallback(Config).WithFallback(RemoteConfigFactory.Default()), output)
    {
    }
