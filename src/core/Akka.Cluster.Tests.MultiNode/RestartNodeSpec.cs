...
namespace Akka.Cluster.Tests.MultiNode
{
    ...
    public class RestartNodeSpec : MultiNodeClusterSpec
    {
        ...
        protected RestartNodeSpec(RestartNodeSpecConfig config) : base(config, typeof(RestartNodeSpec))
        {
            ...
            _secondRestartedSystem = new Lazy<ActorSystem>(() => ActorSystem.Create(Sys.Name, ConfigurationFactory.ParseString("akka.remote.classic.dot-netty.tcp.port=" + _secondUniqueAddress.Address.Port)
