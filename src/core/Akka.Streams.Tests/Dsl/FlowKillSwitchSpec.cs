...
public class FlowKillSwitchSpec : AkkaSpec
{
    ...
    [Fact]
    public async Task
        A_SharedKillSwitch_must_provide_a_flow_that_if_materialized_multiple_times_with_multiple_types_stops_all_streams_if_requested()
    {
        await this.AssertAllStagesStoppedAsync(async () =>
        {
            var killSwitch = KillSwitches.Shared("switch");
    ...
    [Fact]
    public async Task
        A_SharedKillSwitch_must_provide_a_flow_that_if_materialized_multiple_times_with_multiple_types_fails_all_streams_if_requested()
    {
        await this.AssertAllStagesStoppedAsync(async () =>
        {
            var killSwitch = KillSwitches.Shared("switch");
    ...
    public async Task A_CancellationToken_flow_must_stop_a_stream_if_requested()
    {
        await this.AssertAllStagesStoppedAsync(async () =>
        {
            ...
            var t = this.SourceProbe<int>()
                .Via(cancel.Token.AsFlow<int>(true))
                .ToMaterialized(this.SinkProbe<int>(), Keep.Both)
                .Run(Materializer);
            var upstream = t.Item1;
            var downstream = t.Item2;
    ...
    public async Task A_CancellationToken_flow_must_fail_a_stream_if_requested()
    {
        await this.AssertAllStagesStoppedAsync(async () =>
        {
            ...
            var t = this.SourceProbe<int>()
                .Via(cancel.Token.AsFlow<int>(false))
                .ToMaterialized(this.SinkProbe<int>(), Keep.Both)
                .Run(Materializer);
            var upstream = t.Item1;
            var downstream = t.Item2;
    ...
    [Fact]
    public async Task
        A_CancellationToken_flow_must_provide_a_flow_that_if_materialized_multiple_times_with_multiple_types_stops_all_streams_if_requested()
    {
        await this.AssertAllStagesStoppedAsync(async () =>
        {
            var cancel = new CancellationTokenSource();
            ...
            var t1 = this.SourceProbe<int>()
                ...
                .Run(Materializer);
            var t2 = this.SourceProbe<string>()
                .Via(cancel.Token.AsFlow<string>(true))
                .ToMaterialized(this.SinkProbe<string>(), Keep.Both)
                .Run(Materializer);
    ...
    [Fact]
    public async Task
        A_CancellationToken_flow_must_provide_a_flow_that_if_materialized_multiple_times_with_multiple_types_fails_all_streams_if_requested()
    {
        await this.AssertAllStagesStoppedAsync(async () =>
        {
            var cancel = new CancellationTokenSource();
            ...
            var t1 = this.SourceProbe<int>()
                ...
                .Run(Materializer);
            var t2 = this.SourceProbe<string>()
                .Via(cancel.Token.AsFlow<string>(false))
                .ToMaterialized(this.SinkProbe<string>(), Keep.Both)
                .Run(Materializer);
    ...
    [Fact]
    public async Task
        A_CancellationToken_flow_should_not_cause_problems_if_switch_is_shutdown_after_flow_completed_normally()
    {
        await this.AssertAllStagesStoppedAsync(() =>
        {
            var cancel = new CancellationTokenSource();
