...
public class ExternalShardAllocationStrategySpec : AkkaSpec
{
    ...
    public void ExternalShardAllocation_allocate_must_default_to_requester_if_query_times_out()
    {
        ...
        strat.AllocateShard(requester.Ref, "shard-1", ImmutableDictionary<IActorRef, IImmutableList<string>>.Empty)
    ...
    public void ExternalShardAllocation_allocate_must_default_to_requester_if_no_allocation()
    {
        ...
        var allocation = strat.AllocateShard(requester.Ref, "shard-1",
            ImmutableDictionary<IActorRef, IImmutableList<string>>.Empty);
    ...
    {
        var (strat, probe) = CreateStrategy();
        var rebalance = strat.Rebalance(ImmutableDictionary<IActorRef, IImmutableList<string>>.Empty,
