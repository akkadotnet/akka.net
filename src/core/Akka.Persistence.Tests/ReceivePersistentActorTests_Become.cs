...
public partial class ReceivePersistentActorTests
{
    ...
    [Fact]
    public void
        Given_persistent_actor_that_has_called_Become_When_it_calls_Unbecome_Then_it_switches_back_command_handler()
    {
        //Given
        var pid = "p-22";
        WriteEvents(pid, 1, 2, 3);
    ...
    [Fact]
    public void
        Given_persistent_actor_that_has_called_Become_at_construction_time_When_it_calls_Unbecome_Then_it_switches_back_command_handler()
    {
        //Given
        var pid = "p-23";
        WriteEvents(pid, 1, 2, 3);
