...
[!code-csharp[DeviceManager.cs](../../examples/Tutorials/Tutorial3/DeviceManager.cs?name=device-manager-msgs)]
...
[!code-csharp[Device.cs](../../examples/Tutorials/Tutorial3/Device.cs?name=device-with-register)]
...
[!code-csharp[DeviceSpec.cs](../../examples/Tutorials/Tutorial3/DeviceSpec.cs?name=device-registration-tests)]
...
[!code-csharp[DeviceGroup.cs](../../examples/Tutorials/Tutorial3/DeviceGroupInProgress.cs?name=device-group-register)]
...
[!code-csharp[DeviceGroupSpec.cs](../../examples/Tutorials/Tutorial3/DeviceGroupSpec.cs?name=device-group-test-registration)]
...
[!code-csharp[DeviceGroupSpec.cs](../../examples/Tutorials/Tutorial3/DeviceGroupSpec.cs?name=device-group-test3)]
...
Unfortunately, the `Terminated` message contains only the `IActorRef` of the child actor but we do not know
...
[!code-csharp[DeviceGroup.cs](../../examples/Tutorials/Tutorial3/DeviceGroupInProgress.cs?name=device-group-remove)]
...
[!code-csharp[DeviceGroup.cs](../../examples/Tutorials/Tutorial3/DeviceGroup.cs?name=device-group-full)]
...
[!code-csharp[DeviceGroupSpec.cs](../../examples/Tutorials/Tutorial3/DeviceGroupSpec.cs?name=device-group-list-terminate-test)]
...
[!code-csharp[DeviceManager.cs](../../examples/Tutorials/Tutorial3/DeviceManager.cs?name=device-manager-full)]
