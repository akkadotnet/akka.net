...
");
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 8, 1 Select and without GraphStages.Identity")]
    [TimingMeasurement]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 32, 1 Select and without GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 300)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 128, 1 Select and without GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 300)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 8, 1 Select and with GraphStages.Identity")]
    [TimingMeasurement]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 32, 1 Select and with GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 200)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 128, 1 Select and with GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 200)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 8, 5 Selects and without GraphStages.Identity")]
    [TimingMeasurement]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 32, 5 Selects and without GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 700)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 128, 5 Selects and without GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 700)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 8, 5 Selects and with GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 200)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 32, 5 Selects and with GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 200)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 128, 5 Selects and with GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 200)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 8, 10 Selects and without GraphStages.Identity")]
    [TimingMeasurement]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 32, 10 Selects and without GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 1200)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 128, 10 Selects and without GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 1200)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 8, 10 Selects and with GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 200)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 32, 10 Selects and with GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 200)]
    ...
    [PerfBenchmark(RunMode = RunMode.Iterations, TestMode = TestMode.Test, NumberOfIterations = 3,
        Description =
            "Test the performance of a Select flow with InputBufferSize of 128, 10 Selects and with GraphStages.Identity")]
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 200)]
    ...
    private static Source<TOut, TMat> MakeSelects<TOut, TMat>(Source<TOut, TMat> source, int count,
        Func<IGraph<FlowShape<TOut, TOut>, TMat>> flow)
    {
        var f = source;
