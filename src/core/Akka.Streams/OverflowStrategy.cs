...
{
    /// <summary>
    ///     If the buffer is full when a new element arrives, drops the oldest element from the buffer to make space for the
    ///     new element.
    /// </summary>
    DropHead = 2,

    /// <summary>
    ///     If the buffer is full when a new element arrives, drops the youngest element from the buffer to make space for the
    ///     new element.
    /// </summary>
    DropTail,

    /// <summary>
    ///     If the buffer is full when a new element arrives, drops all the buffered elements to make space for the new
    ///     element.
    /// </summary>
    DropBuffer,
...
/// <summary>
///     Represents a strategy that decides how to deal with a buffer of time based stage that is full but is about to
