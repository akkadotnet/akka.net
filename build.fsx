...
Target "RunTests" (fun _ ->    
    ...
    let runSingleProject project =
        let result = ExecProcess(fun info ->
            ...
            info.Arguments <- (sprintf "xunit -f net452 -c Release %s -nobuild -parallel none -teamcity -xml %s_xunit.xml" (if isMono then "-noappdomain" else "") (outputTests @@ fileNameWithoutExt project))) (TimeSpan.FromMinutes 30.)
