...
<div class="container">
  <div class="jumbotron">   
    ...
    <div class="options">
      ...
      <a class="btn btn-lg btn-primary" href="articles/intro/getting-started/tutorial-overview.md">Get Started Now</a>
      <a class="btn btn-lg btn-primary" href="articles/intro/what-is-akka.md">Read the Documentation</a>
    </div>
  </div>
</div>
