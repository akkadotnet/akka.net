...
public static class GracefulStopSupport
{
    ...
    ///     which should only be done outside of the <see cref="ActorSystem" /> as blocking inside <see cref="ActorBase" /> is
    ///     discouraged.
    ///     <remarks>
    ///         <c>IMPORTANT:</c> the actor being terminated and its supervisor being informed of the availability of the
    ///         deceased actor's name
    ...
    ///     If you want to invoke specialized stopping logic on your target actor instead of <see cref="PoisonPill" />, you can
    ///     pass your stop command as a parameter:
    ///     <code>
    ...
    ///     A custom message to use to shutdown target - by default the other overload uses
    ///     <see cref="PoisonPill" />.
    /// </param>
