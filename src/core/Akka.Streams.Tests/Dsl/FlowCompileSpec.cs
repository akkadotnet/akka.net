...
public class FlowCompileSpec : AkkaSpec
{
    ...
    [Fact]
    public void Flow_should_accept_Enumerable()
    {
        IntSeq.Via(Flow.Create<int>());
    }

    [Fact]
    public void Flow_should_accept_Future()
    {
        Source.FromTask(Task.FromResult(3)).Via(Flow.Create<int>());
    }
    ...
    public void Flow_should_append_Flow()
    {
        ...
        var closedSource = IntSeq.Via(open3);
        compiler = () => closedSource.Run(Materializer);
        compiler.Should().Throw<RuntimeBinderException>();

        var closedSink = open3.To(Sink.AsPublisher<int>(false));
    ...
    [Fact]
    public void Sink_should_accept_Source()
    {
        IntSeq.To(OpenSink);
    }
    ...
    [Fact]
    public void Source_should_accept_Sink()
    {
    ...
    [Fact]
    public void RunnableGraph_should_run()
    {
