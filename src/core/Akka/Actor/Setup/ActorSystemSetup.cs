...
/// <summary>
///     Marker base class for a setup part that can be put inside <see cref="ActorSystemSetup" />, if a specific concrete
///     setup
///     is not specified in the actor system setup that means defaults are used(usually from the config file) - no concrete
///     setup instance should be mandatory in the <see cref="ActorSystemSetup" /> that an <see cref="ActorSystem" /> is
///     created with.
/// </summary>
...
/// </summary>
/// <remarks>
///     The constructor is internal. Use <see cref="ActorSystemSetup.Create" /> or
///     <see cref="ActorSystemSetup.WithSetup{T}" />
///     to create instances.
/// </remarks>
