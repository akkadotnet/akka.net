...
internal static class ArrayExtensions
{
    ...
    /// <returns>
    ///     A slice of size <paramref name="count" /> beginning from position <sparamref name="startIndex" /> in
    ///     <paramref name="items" />.
    /// </returns>
    ...
    /// <summary>
    ///     Select all the items in this array beginning with <paramref name="startingItem" /> and up until the end of the
    ///     array.
    ///     <note>
    ///         If <paramref name="startingItem" /> is not found in the array, From will return an empty set.
    ///         If <paramref name="startingItem" /> is found at the end of the array, From will return the entire original
    ///         array.
    ///     </note>
    /// </summary>
    /// <typeparam name="T">TBD</typeparam>
