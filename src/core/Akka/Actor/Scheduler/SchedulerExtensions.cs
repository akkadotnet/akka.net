...
public static class SchedulerExtensions
{
    ...
    ///     OPTIONAL. An <see cref="ICancelable" /> used to cancel sending the message. Once the message
    ///     has been sent, it cannot be canceled.
    /// </param>
    public static void ScheduleTellOnce(this ITellScheduler scheduler, int millisecondsDelay, ICanTell receiver,
        object message, IActorRef sender, ICancelable cancelable = null)
    {
    ...
    ///     has been sent, it cannot be canceled.
    /// </param>
    public static void ScheduleTellRepeatedly(this ITellScheduler scheduler, int initialMillisecondsDelay,
        int millisecondsInterval, ICanTell receiver, object message, IActorRef sender, ICancelable cancelable = null)
    {
        scheduler.ScheduleTellRepeatedly(TimeSpan.FromMilliseconds(initialMillisecondsDelay),
            TimeSpan.FromMilliseconds(millisecondsInterval), receiver, message, sender, cancelable);
    }
    ...
    /// <param name="sender">The actor that sent the message.</param>
    /// <returns>
    ///     An <see cref="ICancelable" /> used to cancel sending the message. Once the message already has been sent, it
    ///     cannot be cancelled.
    /// </returns>
    public static ICancelable ScheduleTellOnceCancelable(this IScheduler scheduler, TimeSpan delay, ICanTell receiver,
    ...
    ///     cannot be cancelled.
    /// </returns>
    public static ICancelable ScheduleTellOnceCancelable(this IScheduler scheduler, int millisecondsDelay,
        ICanTell receiver, object message, IActorRef sender)
    {
        var cancelable = new Cancelable(scheduler);
    ...
    ///     cannot be cancelled.
    /// </returns>
    public static ICancelable ScheduleTellRepeatedlyCancelable(this IScheduler scheduler, TimeSpan initialDelay,
        TimeSpan interval, ICanTell receiver, object message, IActorRef sender)
    {
        var cancelable = new Cancelable(scheduler);
    ...
    ///     The interval, i.e. the time in milliseconds that has to pass between messages are
    ///     sent.
    /// </param>
    /// <param name="receiver">The actor that receives the message.</param>
    /// <param name="message">The message that is being sent.</param>
    ...
    ///     cannot be cancelled.
    /// </returns>
    public static ICancelable ScheduleTellRepeatedlyCancelable(this IScheduler scheduler, int initialMillisecondsDelay,
        int millisecondsInterval, ICanTell receiver, object message, IActorRef sender)
    {
        var cancelable = new Cancelable(scheduler);
        scheduler.ScheduleTellRepeatedly(initialMillisecondsDelay, millisecondsInterval, receiver, message, sender,
            cancelable);
        return cancelable;
    }
    ...
    ///     <remarks>
    ///         Note! It's considered bad practice to use concurrency inside actors, and very easy to get wrong so usage
    ///         is discouraged.
    ///     </remarks>
    /// </summary>
    ...
    /// <param name="cancelable">
    ///     OPTIONAL. A cancelable that can be used to cancel the action from being executed. Defaults to
    ///     <c>null</c>
    /// </param>
    public static void ScheduleOnce(this IActionScheduler scheduler, int millisecondsDelay, Action action,
    ...
    /// <param name="action">The action that is being scheduled.</param>
    /// <param name="cancelable">
    ///     OPTIONAL. A cancelable used to cancel the action from being executed. Defaults to <c>null</c>
    /// </param>
    public static void ScheduleRepeatedly(this IActionScheduler scheduler, int initialMillisecondsDelay,
        int millisecondsInterval, Action action, ICancelable cancelable = null)
    {
        scheduler.ScheduleRepeatedly(TimeSpan.FromMilliseconds(initialMillisecondsDelay),
    ...
    /// <param name="action">The action that is being scheduled.</param>
    /// <returns>A cancelable used to cancel the action from being executed.</returns>
    public static ICancelable ScheduleOnceCancelable(this IActionScheduler scheduler, int millisecondsDelay,
        Action action)
    {
        var cancelable = new Cancelable(scheduler);
    ...
    /// <param name="action">The action that is being scheduled.</param>
    /// <returns>A cancelable used to cancel the action from being executed.</returns>
    public static ICancelable ScheduleRepeatedlyCancelable(this IActionScheduler scheduler, TimeSpan initialDelay,
        TimeSpan interval, Action action)
    {
        var cancelable = new Cancelable(scheduler);
    ...
    /// <param name="action">The action that is being scheduled.</param>
    /// <returns>A cancelable used to cancel the action from being executed.</returns>
    public static ICancelable ScheduleRepeatedlyCancelable(this IActionScheduler scheduler,
        int initialMillisecondsDelay, int millisecondsInterval, Action action)
    {
        var cancelable = new Cancelable(scheduler);
