...
public static partial class GraphDsl
{
    ...
    /// <returns>TBD</returns>
    internal static Outlet<TOut> FindOut<TIn, TOut, T>(Builder<T> builder, UniformFanOutShape<TIn, TOut> junction,
        int n)
    {
    ...
    {
        /// <summary>
        ///     Returns an <see cref="Outlet{T}" /> that gives access to the materialized value of this graph. Once the graph is
        ///     materialized
        ...
        ///     It is possible to call this method multiple times to get multiple <see cref="Outlet{T}" /> instances if necessary.
        ///     All of
        ...
        ///     example to a <see cref="Sink.Aggregate{TIn,TOut}" /> that contributes to the materialized value) since that might
        ///     lead to an unresolvable
        ///     dependency cycle.
        /// </summary>
...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        /// <returns>TBD</returns>
        internal TShape Add<TShape, TMat1, TMat2, TMat3>(IGraph<TShape> graph, Func<TMat1, TMat2, TMat3> combine)
            where TShape : Shape
        {
            if (StreamLayout.IsDebug)
#pragma warning disable CS0162 // Unreachable code detected
...
public static class ForwardOps
{
    ...
    /// <param name="sink">TBD</param>
    /// <returns>TBD</returns>
    public static GraphDsl.Builder<TMat> To<TIn, TOut, TMat>(this GraphDsl.ForwardOps<TOut, TMat> ops,
        SinkShape<TIn> sink)
        where TIn : TOut
    {
        var b = ops.Builder;
    ...
    /// <param name="sink">TBD</param>
    /// <returns>TBD</returns>
    public static GraphDsl.Builder<TMat> To<TIn, TOut, TMat, TMat2>(this GraphDsl.ForwardOps<TOut, TMat> ops,
    ...
    /// <param name="junction">TBD</param>
    /// <returns>TBD</returns>
    public static GraphDsl.Builder<TMat> To<TIn, TOut1, TOut2, TMat>(this GraphDsl.ForwardOps<TOut1, TMat> ops,
    ...
    private static Outlet<TOut2> Bind<TIn, TOut1, TOut2, TMat>(GraphDsl.ForwardOps<TOut1, TMat> ops,
        UniformFanOutShape<TIn, TOut2> junction) where TIn : TOut1
    {
        var b = ops.Builder;
        b.AddEdge(ops.Out, junction.In);
    ...
    /// <param name="flow">TBD</param>
    /// <returns>TBD</returns>
    public static GraphDsl.ForwardOps<TOut2, TMat> Via<TIn, TOut1, TOut2, TMat>(
        this GraphDsl.ForwardOps<TOut1, TMat> ops, FlowShape<TIn, TOut2> flow)
        where TIn : TOut1
    {
        var b = ops.Builder;
        b.AddEdge(ops.Out, flow.Inlet);
    ...
    /// <returns>TBD</returns>
    public static GraphDsl.ForwardOps<TOut2, TMat> Via<TIn, TOut1, TOut2, TMat>(
        this GraphDsl.ForwardOps<TOut1, TMat> ops, IGraph<FlowShape<TIn, TOut2>, NotUsed> flow)
        where TIn : TOut1
    {
        var b = ops.Builder;
        var s = b.Add(flow);
    ...
    /// <returns>TBD</returns>
    public static GraphDsl.ForwardOps<TOut2, TMat> Via<TIn, TOut1, TOut2, TMat>(
        this GraphDsl.ForwardOps<TOut1, TMat> ops, UniformFanInShape<TIn, TOut2> junction)
        where TIn : TOut1
    {
    ...
    /// <returns>TBD</returns>
    public static GraphDsl.ForwardOps<TOut2, TMat> Via<TIn, TOut1, TOut2, TMat>(
        this GraphDsl.ForwardOps<TOut1, TMat> ops, UniformFanOutShape<TIn, TOut2> junction)
        where TIn : TOut1
    {
...
public static class ReverseOps
{
    ...
    /// <param name="outlet">TBD</param>
    /// <returns>TBD</returns>
    public static GraphDsl.Builder<TMat> From<TIn, TOut, TMat>(this GraphDsl.ReverseOps<TIn, TMat> ops,
        Outlet<TOut> outlet)
        where TIn : TOut
    {
        var b = ops.Builder;
    ...
    private static Inlet<TIn> Bind<TIn, TOut, TMat>(GraphDsl.ReverseOps<TIn, TMat> ops,
        UniformFanInShape<TIn, TOut> junction)
        where TIn : TOut
    {
        var b = ops.Builder;
    ...
    /// <exception cref="ArgumentException">TBD</exception>
    /// <returns>TBD</returns>
    public static GraphDsl.Builder<TMat> From<TIn, TOut1, TOut2, TMat>(this GraphDsl.ReverseOps<TIn, TMat> ops,
        UniformFanOutShape<TOut1, TOut2> junction)
        where TIn : TOut2
    {
        var b = ops.Builder;
        var count = junction.Outlets.Count();
    ...
    /// <param name="flow">TBD</param>
    /// <returns>TBD</returns>
    public static GraphDsl.ReverseOps<TOut1, TMat> Via<TIn, TOut1, TOut2, TMat>(this GraphDsl.ReverseOps<TIn, TMat> ops,
    ...
    /// <returns>TBD</returns>
    public static GraphDsl.ReverseOps<TOut1, TMat> Via<TIn, TOut1, TOut2, TMat>(this GraphDsl.ReverseOps<TIn, TMat> ops,
        IGraph<FlowShape<TOut1, TOut2>, TMat> flow)
        where TIn : TOut2
    {
        var b = ops.Builder;
        var f = b.Add(flow);
    ...
    /// <param name="junction">TBD</param>
    /// <returns>TBD</returns>
    public static GraphDsl.ReverseOps<TIn, TMat> Via<TIn, TOut, TMat>(this GraphDsl.ReverseOps<TIn, TMat> ops,
        UniformFanInShape<TIn, TOut> junction)
        where TIn : TOut
    {
    ...
    /// <returns>TBD</returns>
    public static GraphDsl.ReverseOps<TIn, TMat> Via<TIn, TOut, TMat>(this GraphDsl.ReverseOps<TIn, TMat> ops,
        UniformFanOutShape<TIn, TOut> junction)
        where TIn : TOut
    {
