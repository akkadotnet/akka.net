...
[Serializable]
public sealed class
    DeleteMessagesFailure : IEquatable<DeleteMessagesFailure>,
    INoSerializationVerificationNeeded //serialization verification temporary disabled because of Cause serialization issues
{
    /// <summary>
...
public sealed class DeleteMessagesTo : IJournalRequest, IEquatable<DeleteMessagesTo>
{
    ...
    ///     Sequence number where replay should end (inclusive). <see cref="long.MaxValue" /> may be
    ///     used to delete all persistent messages.
    /// </param>
    ...
    public DeleteMessagesTo(string persistenceId, long toSequenceNr, IActorRef persistentActor)
    {
        if (string.IsNullOrEmpty(persistenceId))
            throw new ArgumentNullException(nameof(persistenceId),
                "DeleteMessagesTo requires persistence id to be provided");
...
/// </summary>
[Serializable]
public sealed class WriteMessageRejected : IJournalResponse, INoSerializationVerificationNeeded,
    IEquatable<WriteMessageRejected>
{
    /// <summary>
...
/// </summary>
[Serializable]
public sealed class WriteMessageFailure : IJournalResponse, INoSerializationVerificationNeeded,
    IEquatable<WriteMessageFailure>
{
    /// <summary>
...
/// </summary>
[Serializable]
public sealed class LoopMessageSuccess : IJournalResponse, INoSerializationVerificationNeeded,
    IEquatable<LoopMessageSuccess>
{
    /// <summary>
...
public sealed class ReplayMessages : IJournalRequest, IEquatable<ReplayMessages>
{
    ...
    {
        return
            $"ReplayMessages<fromSequenceNr: {FromSequenceNr}, toSequenceNr: {ToSequenceNr}, max: {Max}, persistenceId: {PersistenceId}>";
    }
}

/// <summary>
///     Reply message to a <see cref="ReplayMessages" /> request. A separate reply is sent to the requester for each
///     replayed message.
/// </summary>
[Serializable]
public sealed class ReplayedMessage : IJournalResponse, IDeadLetterSuppression, INoSerializationVerificationNeeded,
    IEquatable<ReplayedMessage>
{
    /// <summary>
