...
public sealed class NullMessageEnvelope : MessageEnvelope
{
    ...
    /// </exception>
    public override object Message => throw new IllegalActorStateException("last receive did not dequeue a message");
    ...
    /// </exception>
    public override IActorRef Sender => throw new IllegalActorStateException("last receive did not dequeue a message");
