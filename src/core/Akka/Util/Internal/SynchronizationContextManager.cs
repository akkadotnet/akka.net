...
///     <para>
///         Does the same thing as .ConfigureAwait(false) but better - it should be written once only,
///         unlike .ConfigureAwait(false).
///     </para>
///     <para>
///         await SynchronizationContextManager.RemoveContext;
///         Should be used as a very first line inside async public API of the library code
///     </para>
/// </summary>
/// <example>
