...
internal abstract class SplitBrainResolverBase : ActorBase, IWithUnboundedStash, IWithTimers
{
    ...
    private TimeSpan ReleaseLeaseAfter => Strategy is LeaseMajority lm
        ? lm.ReleaseAfter
        : throw new InvalidOperationException(
            $"Unexpected use of releaseLeaseAfter for strategy [{Strategy?.GetType().Name}]");
    ...
    public void Exited(Member m)
    {
        ...
        MutateMemberInfo(true, () => { Strategy.Add(m); });
    }
