...
public class FailureDetectorRegistrySpec
{
    ...
    public void FailureDetectorRegistry_must_accept_some_configured_missing_heartbeats()
    {
        ...
        var fd =
            FailureDetectorSpecHelpers.CreateFailureDetectorRegistry(8.0d, 1000, TimeSpan.FromMilliseconds(100),
                TimeSpan.FromSeconds(3), //changed to 3 seconds
    ...
    [Fact]
    public void
        FailureDetectorRegistry_must_mark_node_as_available_after_explicit_removal_of_connection_and_receiving_heartbeat_again
        ()
    {
        var timeIntervals = new List<long>
        {
