...
public class
    ...
    ClusterShardingRememberEntitiesNewExtractorSpecConfig
{
...
public class
    DDataClusterShardingRememberEntitiesNewExtractorSpecConfig : ClusterShardingRememberEntitiesNewExtractorSpecConfig
{
...
public class PersistentClusterShardingRememberEntitiesNewExtractorSpec : ClusterShardingRememberEntitiesNewExtractorSpec
{
    public PersistentClusterShardingRememberEntitiesNewExtractorSpec()
        : base(new PersistentClusterShardingRememberEntitiesSpecNewExtractorConfig(),
            typeof(PersistentClusterShardingRememberEntitiesNewExtractorSpec))
    {
    }
}
...
public class DDataClusterShardingRememberEntitiesNewExtractorSpec : ClusterShardingRememberEntitiesNewExtractorSpec
{
    public DDataClusterShardingRememberEntitiesNewExtractorSpec()
        : base(new DDataClusterShardingRememberEntitiesNewExtractorSpecConfig(),
            typeof(DDataClusterShardingRememberEntitiesNewExtractorSpec))
    {
    }
}

public abstract class
    ClusterShardingRememberEntitiesNewExtractorSpec : MultiNodeClusterShardingSpec<
    ClusterShardingRememberEntitiesNewExtractorSpecConfig>
{
    [MultiNodeFact]
    ...
    private void Cluster_with_min_nr_of_members_using_sharding_must_start_up_first_cluster_and_sharding()
    {
        ...
        {
            StartPersistenceIfNeeded(Config.First, Config.Second, Config.Third);
            ...
            RunOn(() => { StartShardingWithExtractor1(); }, Config.Second, Config.Third);
        ...
        Cluster_with_min_nr_of_members_using_sharding_must_start_new_nodes_with_different_extractor_and_have_the_entities_running_on_the_right_shards()
    {
        Within(TimeSpan.FromSeconds(30), () =>
        {
            ...
            RunOn(() =>
            {
                ...
                if (PersistenceIsNeeded) SetStore(sys2, Config.First);
            ...
            RunOn(() => { EnterBarrier("verified"); }, Config.First);
    ...
    private sealed class MessageExtractor1 : IMessageExtractor
    {
        ...
        {
            return (int.Parse(entityId) % ShardCount).ToString();
        }
    }
    ...
    private sealed class MessageExtractor2 : IMessageExtractor
    {
        ...
        public string ShardId(string entityId, object messageHint = null)
        {
            return ((int.Parse(entityId) + 1) % ShardCount).ToString();
        }
    }
    ...
    protected ClusterShardingRememberEntitiesNewExtractorSpec(
        ClusterShardingRememberEntitiesNewExtractorSpecConfig config, Type type)
        : base(config, type)
    {
    }
