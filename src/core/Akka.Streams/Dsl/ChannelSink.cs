...
public static class ChannelSink
{
    ...
    /// <param name="isOwner">
    ///     Determines materialized graph should be responsible for completing given
    ...
    /// <returns></returns>
    public static Sink<T, ChannelReader<T>> AsReader<T>(int bufferSize, bool singleReader = false,
        BoundedChannelFullMode fullMode = BoundedChannelFullMode.Wait)
    {
        return Sink.FromGraph(new ChannelReaderSink<T>(bufferSize, singleReader));
    }
