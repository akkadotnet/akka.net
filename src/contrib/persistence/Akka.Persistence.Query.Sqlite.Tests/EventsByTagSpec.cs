...
{
    public class EventsByTagSpec : TestKit.Xunit2.TestKit
    {
        ...
        public static Config Config(int id) => ConfigurationFactory.ParseString($@"
            ...
            akka.persistence.journal.sqlite {{
                event-adapters {{
                  color-tagger  = ""Akka.Persistence.Query.Sqlite.Tests.ColorTagger, Akka.Persistence.Query.Sqlite.Tests""
                }}
        ...
        public EventsByTagSpec(ITestOutputHelper output) : base(Config(Counter.GetAndIncrement()), output: output)
        {
        ...
        [Fact]
        public void Sqlite_query_EventsByTag_should_implement_standard_EventsByTagQuery()
        {
            (_queries is IEventsByTagQuery).Should().BeTrue();
        }

        [Fact]
        public void Sqlite_query_EventsByTag_should_find_existing_events()
        {
            var a = SetupEmpty("a");
            var b = SetupEmpty("b");
        ...
        [Fact]
        public void Sqlite_query_EventsByTag_should_not_see_new_events_after_demand_request()
        {
            Sqlite_query_EventsByTag_should_find_existing_events();
        ...
        [Fact]
        public void Sqlite_query_EventsByTag_should_find_events_from_offset()
        {
            Sqlite_query_EventsByTag_should_not_see_new_events_after_demand_request();
        ...
        [Fact]
        public void Sqlite_query_EventsByTag_should_find_new_events()
        {
            var d = SetupEmpty("d");
        ...
        [Fact]
        public void Sqlite_live_query_EventsByTag_should_find_events_from_offset()
        {
