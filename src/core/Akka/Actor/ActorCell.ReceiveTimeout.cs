...
public partial class ActorCell
{
    ...
    public void CheckReceiveTimeout(bool reschedule = true)
    {
        if (_receiveTimeoutDuration != null)
        {
            ...
            if (reschedule || _pendingReceiveTimeout == null) RescheduleReceiveTimeout(_receiveTimeoutDuration.Value);
        }
        else
        {
    ...
    private void RescheduleReceiveTimeout(TimeSpan timeout)
    {
        ...
        _pendingReceiveTimeout =
            System.Scheduler.ScheduleTellOnceCancelable(timeout, Self, Akka.Actor.ReceiveTimeout.Instance, Self);
        _receiveTimeoutDuration = timeout;
    }
