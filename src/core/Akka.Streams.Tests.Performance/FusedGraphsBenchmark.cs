...
public class FusedGraphsBenchmark
{
    ...
    {
        return RunnableGraph.FromGraph(Fusing.Aggressive(graph));
    }
    ...
    public void Setup(BenchmarkContext context)
    {
        ...
        _broadcastZipBalanceMerge =
            Fuse(testSource.Via(broadcastZipFLow).Via(balanceMergeFlow).ToMaterialized(testSink, Keep.Right));
    }
    ...
    public void SingleIdentity()
    {
        _singleIdentity.Run(_materializer).Ready();
    }
    ...
    public void ChainOfIdentities()
    {
        _chainOfIdentities.Run(_materializer).Ready();
    }
    ...
    {
        _singleSelect.Run(_materializer).Ready();
    }
    ...
    public void ChainOfSelects()
    {
        _chainOfSelects.Run(_materializer).Ready();
    }
    ...
    {
        _singleBuffer.Run(_materializer).Ready();
    }
    ...
    public void ChainOfBuffers()
    {
        _chainOfBuffers.Run(_materializer).Ready();
    }
    ...
    public void RepeatTakeSelectAndAggregate()
    {
        _repeatTakeSelectAndAggregate.Run(_materializer).Ready();
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 100)]
    public void BroadcastZip()
    {
        _broadcastZip.Run(_materializer).Ready();
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 50)]
    public void BalanceMerge()
    {
        _balanceMerge.Run(_materializer).Ready();
    }
    ...
    [TimingMeasurement]
    [ElapsedTimeAssertion(MaxTimeMilliseconds = 100)]
    public void BroadcastZipBalanceMerge()
    {
        _broadcastZipBalanceMerge.Run(_materializer).Ready();
    }
    ...
    private sealed class CompletionLatch : GraphStageWithMaterializedValue<SinkShape<MutableElement>, TestLatch>
    {
        ...
        public override ILogicAndMaterializedValue<TestLatch> CreateLogicAndMaterializedValue(
