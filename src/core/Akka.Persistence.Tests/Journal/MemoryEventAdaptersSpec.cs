...
akka.persistence.journal {
  ...
  inmem {
    ...
    [Fact]
    public void EventAdapters_should_fail_with_useful_message_when_binding_to_not_defined_adapter()
    {
...
akka.persistence.journal.inmem {
  event-adapter-bindings {
    ...
    public void EventAdapters_should_allow_implementing_only_the_read_side_IReadEventAdapter()
    {
        ...
        readAdapter.FromJournal(readAdapter.ToJournal(new ReadMeEvent()), "").Events.First().Should()
            .Be("from-ReadMeEvent()");
    }
    ...
    public void EventAdapters_should_allow_implementing_only_the_write_side_IWriteEventAdapter()
    {
        ...
        writeAdapter.FromJournal(writeAdapter.ToJournal(new WriteMeEvent()), "").Events.First().Should()
            .Be("to-WriteMeEvent()");
    }
