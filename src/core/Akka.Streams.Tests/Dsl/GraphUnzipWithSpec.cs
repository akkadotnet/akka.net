...
public class GraphUnzipWithSpec : AkkaSpec
{
    ...
    private static void ValidateSubscriptionAndComplete(
        (TestSubscriber.ManualProbe<int>, TestSubscriber.ManualProbe<string>) subscribers)
    {
        subscribers.Item1.ExpectSubscriptionAndComplete();
        subscribers.Item2.ExpectSubscriptionAndComplete();
    }

    private static void ValidateSubscriptionAndError(
        (TestSubscriber.ManualProbe<int>, TestSubscriber.ManualProbe<string>) subscribers)
    {
