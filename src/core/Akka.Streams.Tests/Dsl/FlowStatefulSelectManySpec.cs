    ...
    public class FlowStatefulSelectManySpec : ScriptedTest
    {
        ...
        public void A_StatefulSelectMany_must_work_in_happy_case()
        {
            Func<Script<int, int>> script = () =>
            {
                var phases = new[]
                {
                    new (ICollection<int>, ICollection<int>)(new[] {2}, new int[0]),
                    new (ICollection<int>, ICollection<int>)(new[] {1}, new[] {1, 1}),
                    new (ICollection<int>, ICollection<int>)(new[] {3}, new[] {3}),
                    new (ICollection<int>, ICollection<int>)(new[] {6}, new[] {6, 6, 6})
                };
