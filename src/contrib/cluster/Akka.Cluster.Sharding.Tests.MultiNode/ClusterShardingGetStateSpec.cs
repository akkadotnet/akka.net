        ...
        RunOn(() =>
        {
            ...
            Within(TimeSpan.FromSeconds(10), () =>
            {
                AwaitAssert(() =>
                {
                    ...
                    foreach (var n in Enumerable.Range(1, 4)) region.Tell(new PingPongActor.Ping(n), pingProbe.Ref);
    ...
    private void Inspecting_cluster_sharding_state_must_get_shard_state()
    {
        Within(TimeSpan.FromSeconds(10), () =>
        {
            AwaitAssert(() =>
            {
                ...
                allEntityIds.Should().BeEquivalentTo("1", "2", "3", "4");
            });
        });
