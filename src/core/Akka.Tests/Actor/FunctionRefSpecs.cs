...
public class FunctionRefSpec : AkkaSpec
{
    ...
    private sealed class GetForwarder : IEquatable<GetForwarder>
    {
        ...
        {
            return obj is GetForwarder forwarder && Equals(forwarder);
        }

        public override int GetHashCode()
        {
            return ReplyTo != null ? ReplyTo.GetHashCode() : 0;
        }
    }
    ...
    private sealed class DropForwarder : IEquatable<DropForwarder>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is DropForwarder forwarder && Equals(forwarder);
        }
    ...
    private sealed class Forwarded : IEquatable<Forwarded>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is Forwarded forwarded && Equals(forwarded);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return ((Message != null ? Message.GetHashCode() : 0) * 397) ^
                       (Sender != null ? Sender.GetHashCode() : 0);
            }
        }
    }
    ...
    private sealed class Super : ReceiveActor, ILogReceive
    {
        public Super()
        {
            Receive<GetForwarder>(get =>
            {
                ...
                var fref = cell.AddFunctionRef((sender, msg) => { get.ReplyTo.Tell(new Forwarded(msg, sender)); });
    ...
    private sealed class SupSuper : ReceiveActor
    {
        public SupSuper()
        {
    ...
    private IActorRef SuperActor()
    {
        return Sys.ActorOf(Props.Create<Super>(), "super");
    }
    ...
    private IActorRef SupSuperActor()
    {
        return Sys.ActorOf(Props.Create<SupSuper>(), "supsuper");
    }
