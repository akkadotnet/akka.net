...
internal class Reachability
{
    ...
    ///     TBD
    /// </summary>
    public static readonly Reachability Empty = new(ImmutableList.Create<Record>(),
        ImmutableDictionary.Create<UniqueAddress, long>());
    ...
    private class Cache
    {
        ...
        public Cache(ImmutableList<Record> records)
        {
            ...
            else
            {
                ...
                {
                    var m = mapBuilder.TryGetValue(r.Observer, out var mR)
