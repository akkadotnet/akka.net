...
///     such as <see cref="IEventsByPersistenceIdQuery" />, <see cref="IPersistenceIdsQuery" /> and
///     <see cref="IEventsByTagQuery" />
...
public interface IEventsByPersistenceIdQuery : IReadJournal
{
    ...
    ///         or use <c>0L</c> and long.MaxValue respectively to retrieve all events.
    ///     </para>
...
public interface ICurrentEventsByPersistenceIdQuery : IReadJournal
{
    ...
    /// </summary>
    Source<EventEnvelope, NotUsed> CurrentEventsByPersistenceId(string persistenceId, long fromSequenceNr,
        long toSequenceNr);
}
