...
public class RollingUpdateShardAllocationSpecConfig : MultiNodeClusterShardingConfig
{
                ...
                }")
    {
        ...
        NodeConfig(new[] { First, Second },
            new[] { ConfigurationFactory.ParseString("akka.cluster.app-version = 1.0.0") });
        NodeConfig(new[] { Third, Fourth },
            new[] { ConfigurationFactory.ParseString("akka.cluster.app-version = 1.0.1") });
    }
...
public class RollingUpdateShardAllocationSpec : MultiNodeClusterShardingSpec<RollingUpdateShardAllocationSpecConfig>
{
    ...
    private void ClusterSharding_must_complete_a_rolling_upgrade()
    {
        ...
        RunOn(() => { AwaitAssert(() => { UpMembers.Count().Should().Be(3); }); }, Config.Second, Config.Third,
            Config.Fourth);
