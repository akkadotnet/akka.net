...
{
    public sealed class Get<T> : ICommand<T>
    {
        readonly Key<T> _key;
    ...
    public sealed class GetSuccess<T> : IGetResponse<T>
    {
        readonly Key<T> _key;
        readonly Object _request;
        readonly T _data;
    ...
    public sealed class NotFound<T> : IGetResponse<T>
    {
        readonly Key<T> _key;
        readonly object _request;
    ...
    public sealed class GetFailure<T> : IGetResponse<T>
    {
        private Key<T> _key;
