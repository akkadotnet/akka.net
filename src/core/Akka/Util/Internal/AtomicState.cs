...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
    ...
    protected async Task NotifyTransitionListeners()
    {
        ...
        await Task
            ...
            (
                () =>
                {
                    foreach (var listener in _listeners) listener.Invoke();
                }
    ...
    /// <summary>
    ///     Invoked on the transitioned-to state during transition. Notifies listeners after invoking subclass template method
    ///     _enter
    /// </summary>
...
/// <summary>
///     This interface represents the parts of the internal circuit breaker state; the behavior stack, watched by, watching
///     and termination queue
/// </summary>
