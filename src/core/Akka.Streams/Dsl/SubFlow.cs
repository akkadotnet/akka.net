...
///     <see cref="Akka.Streams.Implementation.Fusing.GroupBy{T,TKey}" />.
...
public abstract class SubFlow<TOut, TMat, TClosed> : IFlow<TOut, TMat>
{
    ...
    /// <returns>TBD</returns>
    public abstract IFlow<T2, TMat3> ViaMaterialized<T2, TMat2, TMat3>(IGraph<FlowShape<TOut, T2>, TMat2> flow,
