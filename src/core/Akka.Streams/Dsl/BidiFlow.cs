...
public static class BidiFlow
{
    ...
    /// <summary>
    ///     Wraps two Flows to create a <see cref="BidiFlow{TIn1,TOut1,TIn2,TOut2,TMat}" />. The materialized value of the
    ///     resulting BidiFlow is determined
    ...
    /// <summary>
    ///     Create a <see cref="BidiFlow{TIn1,TOut1,TIn2,TOut2,TMat}" /> where the top and bottom flows are just one simple
    ///     mapping
    ...
    /// <returns>TBD</returns>
    public static BidiFlow<TIn1, TOut1, TIn2, TOut2, NotUsed> FromFunction<TIn1, TOut1, TIn2, TOut2>(
        Func<TIn1, TOut1> outbound, Func<TIn2, TOut2> inbound)
    {
...
public class BidiFlow<TIn1, TOut1, TIn2, TOut2, TMat> : IGraph<BidiShape<TIn1, TOut1, TIn2, TOut2>, TMat>
{
    ...
    /// <returns>TBD</returns>
    public BidiFlow<TIn1, TOut12, TIn21, TOut2, TMat> Atop<TOut12, TIn21, TMat2>(
    ...
    /// <param name="combine">TBD</param>
    /// <returns>TBD</returns>
    public BidiFlow<TIn1, TOut12, TIn21, TOut2, TMat3> AtopMat<TOut12, TIn21, TMat2, TMat3>(
        BidiFlow<TOut1, TOut12, TIn21, TIn2, TMat2> bidi, Func<TMat, TMat2, TMat3> combine)
    {
        ...
        return new BidiFlow<TIn1, TOut12, TIn21, TOut2, TMat3>(Module
            ...
            .ReplaceShape(new BidiShape<TIn1, TOut12, TIn21, TOut2>(Shape.Inlet1, (Outlet<TOut12>)outs[0],
                (Inlet<TIn21>)ins[1], Shape.Outlet2)));
    }
    ...
    /// <param name="combine">TBD</param>
    /// <returns>TBD</returns>
    public Flow<TIn1, TOut2, TMat3> JoinMat<TMat2, TMat3>(Flow<TOut1, TIn2, TMat2> flow,
        Func<TMat, TMat2, TMat3> combine)
    {
        ...
        return new Flow<TIn1, TOut2, TMat3>(Module
            ...
            .ReplaceShape(new FlowShape<TIn1, TOut2>((Inlet<TIn1>)Shape.Inlets.First(),
                (Outlet<TOut2>)Shape.Outlets.ElementAt(1))));
    }
}