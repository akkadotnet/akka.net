...
/// </summary>
internal sealed class MessageBuffer : IEnumerable<(object Message, IActorRef Ref)>,
    IReadOnlyCollection<(object Message, IActorRef Ref)>
{
...
internal sealed class MessageBufferMap<TId> : IEnumerable<KeyValuePair<TId, MessageBuffer>>,
    IReadOnlyCollection<KeyValuePair<TId, MessageBuffer>>
{
    ...
    {
        return _bufferMap.ContainsKey(id);
    }
