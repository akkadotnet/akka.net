...
public class Switch
{
    ...
    /// </value>
    public bool IsOn => _switch.Value;
    ...
    /// </value>
    public bool IsOff => !_switch.Value;
    ...
    /// <summary>
    ///     Executes the provided action if the lock is on. This is done under a lock so be _very_ careful with
    ///     longrunning/blocking operations in it.
    ...
    /// <summary>
    ///     Executes the provided action if the lock is off. This is done under a lock so be _very_ careful with
    ///     longrunning/blocking operations in it.
    ...
    /// <summary>
    ///     Executes the provided action and returns if the action was executed or not, if the switch is on, waiting for any
    ///     pending changes to happen before (locking)
    ...
    /// <summary>
    ///     Executes the provided action and returns if the action was executed or not, if the switch is off, waiting for any
    ///     pending changes to happen before (locking)
    ///     Be careful of longrunning or blocking within the provided action as it can lead to deadlocks or bad performance
    /// </summary>
    /// <param name="action">TBD</param>
