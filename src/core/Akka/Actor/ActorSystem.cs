...
/// <summary>
///     Core bootstrap settings for the <see cref="ActorSystem" />, which can be created using one of the static factory
///     methods
///     on this class.
/// </summary>
public sealed class BootstrapSetup : Setup.Setup
{
    ...
    /// <summary>
    ///     Configuration to use for the <see cref="ActorSystem" />. If no <see cref="Config" /> is given, the default
    ///     reference
