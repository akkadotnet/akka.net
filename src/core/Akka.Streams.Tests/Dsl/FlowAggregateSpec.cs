...
public class FlowAggregateSpec : AkkaSpec
{
    ...
    [Fact]
    public async Task
        A_Aggregate_must_resume_with_the_accumulated_state_when_the_aggregating_funtion_throws_and_the_supervisor_strategy_decides_to_resume()
    {
        await this.AssertAllStagesStoppedAsync(async () =>
        {
    ...
    [Fact]
    public async Task
        A_Aggregate_must_resume_and_reset_the_state_when_the_aggregating_funtion_throws_and_the_supervisor_strategy_decides_to_restart()
    {
        await this.AssertAllStagesStoppedAsync(async () =>
        {
            var error = new Exception("boom");
