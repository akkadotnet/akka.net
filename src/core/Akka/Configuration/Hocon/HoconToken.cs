...
public class Token
{
    ...
    {
        return new Token { Type = TokenType.Key, Value = key };
    }
    ...
    {
        return new Token { Type = TokenType.Substitute, Value = path };
    }
    ...
    {
        return new Token { Type = TokenType.LiteralValue, Value = value };
    }

    internal static Token Include(string path)
    {
        return new Token { Value = path, Type = TokenType.Include };
    }
}