...
public class EntityTerminationSpec : AkkaSpec
{
    ...
    [Fact]
    public void
        Sharding_when_an_entity_terminates_must_automatically_restart_a_terminating_entity_not_passivating_if_remembering_entities()
    {
        var sharding = ClusterSharding.Get(Sys).Start(
            "remembering",
            StoppingActor.Props(),
    ...
    private class StoppingActor : ActorBase
    {
        ...
        {
            return Actor.Props.Create(() => new StoppingActor());
        }
