...
public class MatchExpressionBuilder_BuildLambdaExpression_Tests
{
    ...
    public void Build_one_action_and_predicate()
    {
        ...
        var handler = PredicateAndHandler.CreateAction(action, predicate);
        stringHandler.Handlers.Add(handler);
        typeHandlers.Add(stringHandler);
        var builder = new MatchExpressionBuilder<object>();
    ...
    public void Build_two_actions_and_predicate_for_same_type()
    {
        ...
        var handler1 = PredicateAndHandler.CreateAction(action1, predicate1);
        ...
        var handler2 = PredicateAndHandler.CreateAction(action2, predicate2);
        ...
        //Compile the expression and test it
        var lambda =
            (Func<object, Action<string>, Predicate<string>, Action<string>, Predicate<string>, bool>)result
    ...
    public void Build_two_actions_and_predicate_for_different_types()
    {
        ...
        //Compile the expression and test it
        var lambda =
            (Func<object, Action<string>, Predicate<string>, Action<int>, Predicate<int>, bool>)result.LambdaExpression
                .Compile();
        lambda("short", action1, predicate1, action2, predicate2);
        Assert.Null(updatedValue);
        lambda("longer value", action1, predicate1, action2, predicate2);
    ...
    public void Build_three_funcs_for_two_different_types()
    {
        ...
        //Compile the expression and test it
        var lambda =
            (Func<object, Func<string, bool>, Func<int, bool>, Func<string, bool>, bool>)
    ...
    public void Build_with_exactly_15_arguments()
    {
        ...
        for (var i = 0; i < 7; i++)
            stringHandler.Handlers.Add(PredicateAndHandler.CreateAction(actionString, predicateString));
        typeHandlers.Add(stringHandler);
        ...
        //Compile the expression and test it
        var lambda =
            (Func<object, Action<string>, Predicate<string>, Action<string>, Predicate<string>, Action<string>,
                Predicate<string>, Action<string>, Predicate<string>, Action<string>, Predicate<string>, Action<string>,
                Predicate<string>, Action<string>, Predicate<string>, Action<int>, bool>)
            result.LambdaExpression.Compile();

        lambda("some value", actionString, predicateString, actionString, predicateString, actionString,
            predicateString, actionString, predicateString, actionString, predicateString, actionString,
            predicateString, actionString, predicateString, actionInt);
        Assert.Null(updatedValue);
        lambda(4711, actionString, predicateString, actionString, predicateString, actionString, predicateString,
            actionString, predicateString, actionString, predicateString, actionString, predicateString, actionString,
            predicateString, actionInt);
    ...
    public void Build_with_more_than_15_arguments()
    {
        ...
        var handler2 = PredicateAndHandler.CreateAction(actionInt, predicateInt);
        intHandler.Handlers.Add(handler2);
        typeHandlers.Add(intHandler);
        ...
        var lambda =
            (Func<object, Action<string>, Predicate<string>, Action<string>, Predicate<string>, Action<string>,
                Predicate<string>, Action<string>, Predicate<string>, Action<string>, Predicate<string>, Action<string>,
                Predicate<string>, Action<string>, Predicate<string>, object[], bool>)
            result.LambdaExpression.Compile();

        lambda("some value", actionString, predicateString, actionString, predicateString, actionString,
            predicateString, actionString, predicateString, actionString, predicateString, actionString,
            predicateString, actionString, predicateString, extraParamsArray);
        Assert.Null(updatedValue);
        lambda(4711, actionString, predicateString, actionString, predicateString, actionString, predicateString,
            actionString, predicateString, actionString, predicateString, actionString, predicateString, actionString,
            predicateString, extraParamsArray);
        Assert.Null(updatedValue);
        lambda(42, actionString, predicateString, actionString, predicateString, actionString, predicateString,
            actionString, predicateString, actionString, predicateString, actionString, predicateString, actionString,
            predicateString, extraParamsArray);
    ...
    public void Build_one_action_that_expects_base_type()
    {
        ...
        var typeHandlers = new List<TypeHandler>();
        var stringHandler = new TypeHandler(typeof(string));
        Action<object> action = s => { updatedValue = s is string s1 ? "WasString:" + s1 : "WasNotString" + s; };
    ...
    public void Build_one_action_and_predicate_that_expects_base_type()
    {
        ...
        var handler = PredicateAndHandler.CreateAction(action, predicate, true);
        stringHandler.Handlers.Add(handler);
        typeHandlers.Add(stringHandler);
        var builder = new MatchExpressionBuilder<object>();
