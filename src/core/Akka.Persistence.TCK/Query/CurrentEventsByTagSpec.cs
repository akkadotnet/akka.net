...
namespace Akka.Persistence.TCK.Query
{
    public abstract class CurrentEventsByTagSpec : Akka.TestKit.Xunit2.TestKit
    {
        ...
        public virtual void ReadJournal_query_CurrentEventsByTag_should_find_existing_events()
        {
            ...
            var greenSrc = queries.CurrentEventsByTag("green", offset: new Sequence(0L));
            ...
            var blackSrc = queries.CurrentEventsByTag("black", offset: new Sequence(0L));
            ...
            var appleSrc = queries.CurrentEventsByTag("apple", offset: new Sequence(0L));
        ...
        public virtual void ReadJournal_query_CurrentEventsByTag_should_complete_when_no_events()
        {
            ...
            var greenSrc = queries.CurrentEventsByTag("pink", offset: new Sequence(0L));
            var probe = greenSrc.RunWith(this.SinkProbe<EventEnvelope>(), Materializer);
        ...
        public virtual void ReadJournal_query_CurrentEventsByTag_should_find_events_from_offset()
        {
            ...
            var greenSrc1 = queries.CurrentEventsByTag("green", offset: new Sequence(0L));
            ...
            var greenSrc = queries.CurrentEventsByTag("green", offset: new Sequence(offs.Value));
