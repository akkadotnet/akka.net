...
public static class GSet
{
    ...
    {
        return new GSet<T>(ImmutableHashSet.Create(elements));
    }
    ...
    IReplicatedDelta
{
    ...
    {
        return MergeDelta((GSet<T>)delta);
    }
    ...
    {
        return Delta == null ? this : AssignAncestor(new GSet<T>(Elements));
    }
    ...
    {
        return obj is GSet<T> set && Equals(set);
    }
    ...
    public override int GetHashCode()
    {
        ...
        {
            var hashCode = 0;
            foreach (var element in Elements) hashCode = (hashCode * 397) ^ (element?.GetHashCode() ?? 0);
            return hashCode;
        }
    }
