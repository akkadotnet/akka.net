// -----------------------------------------------------------------------
//  <copyright file="RecoveryBenchmark.cs" company="Akka.NET Project">
...
public class RecoveryBenchmark
{
    ...
    public async Task GlobalSetup()
    {
        ...
        {
            var myRef = _sys1.ActorOf(
                Props.Create(() => new PerformanceTestActor(i.ToString(), _doneActor, WriteMsgCount)), i.ToString());
    ...
    public void Cleanup()
    {
        foreach (var a in _persistentActors) _sys1.Stop(a);
