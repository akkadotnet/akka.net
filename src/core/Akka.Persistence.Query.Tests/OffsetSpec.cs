...
public class OffsetSpec
{
    ...
    public void TimeBasedUuid_offset_must_be_ordered_correctly()
    {
        var uuid1 = new TimeBasedUuid(
            TimeUuid.Parse("49225740-2019-11ea-a6f0-a0a60c2ef4ff")); //2019-12-16T15:32:36.148Z[UTC]            
        var uuid2 = new TimeBasedUuid(
            TimeUuid.Parse("91be23d0-2019-11ea-a752-ffae2393b6e4")); //2019-12-16T15:34:37.965Z[UTC]
        var uuid3 = new TimeBasedUuid(
            TimeUuid.Parse("91f95810-2019-11ea-a752-ffae2393b6e4")); //2019-12-16T15:34:38.353Z[UTC]
