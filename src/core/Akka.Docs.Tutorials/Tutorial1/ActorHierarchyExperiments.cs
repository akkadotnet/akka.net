...
{
    private readonly IActorRef child = Context.ActorOf(Props.Create<SupervisedActor>(), "supervised-actor");
...
public class SupervisedActor : UntypedActor
{
    protected override void PreStart()
    {
        Console.WriteLine("supervised actor started");
    }

    protected override void PostStop()
    {
        Console.WriteLine("supervised actor stopped");
    }
