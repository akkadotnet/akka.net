...
{
    private const string user1 = "{\"username\":\"john\",\"password\":\"coltrane\"}";
    private const string user2 = "{\"username\":\"sonny\",\"password\":\"rollins\"}";
    private const string user3 = "{\"username\":\"charlie\",\"password\":\"parker\"}";
    private const string user4 = "{\"username\":\"charles\",\"password\":\"mingus\"}";
