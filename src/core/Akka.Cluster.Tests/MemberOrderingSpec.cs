...
public class MemberOrderingSpec
{
    ...
    public void MemberOrdering_must_work_pick_member_with_legal_transition()
    {
        ...
        var s2 = ImmutableSortedSet.Create(TestMember.Create(address1, MemberStatus.Up, ImmutableHashSet<string>.Empty,
            upNumber: 2));
    ...
    public void MemberAgeOrdering_must_order_members_by_ascending_UpNumber()
    {
        ...
        var m2 = TestMember.Create(address.WithPort(7000), MemberStatus.Up, ImmutableHashSet<string>.Empty,
            upNumber: 2);
        var m3 = TestMember.Create(address.WithPort(3000), MemberStatus.Up, ImmutableHashSet<string>.Empty,
            upNumber: 3);
        var m4 = TestMember.Create(address.WithPort(6000), MemberStatus.Up, ImmutableHashSet<string>.Empty,
            upNumber: 4);
        var m5 = TestMember.Create(address.WithPort(2000), MemberStatus.Up, ImmutableHashSet<string>.Empty,
            upNumber: 5);
        ...
        sortedMembers.Should().BeEquivalentTo(new List<Member>
        {
            m1,
            m2,
            m3,
