...
#pragma warning disable CS0618 // Type or member is obsolete
        : this(CreateProducer(type, args), deploy,
            args) // have to preserve the "CreateProducer" call here to preserve backwards compat with Akka.DI.Core
#pragma warning restore CS0618 // Type or member is obsolete
    {
    }

    /// <summary>
    ///     Initializes a new instance of the <see cref="Props" /> class using a specified
    ///     <see cref="IIndirectActorProducer" />.
    /// </summary>
    /// <remarks>
    ///     This API is meant for advanced use cases, such as Akka.DependencyInjection.
    /// </remarks>
    /// <param name="producer">
    ///     The type of <see cref="IIndirectActorProducer" /> that will be used to instantiate
    ///     <see cref="Type" />
    /// </param>
    /// <param name="deploy">The configuration used to deploy the actor.</param>
    /// <param name="args">The arguments needed to create the actor.</param>
...
#pragma warning restore CS0162
    ...
    {
        return new Props(new ActivatorProducer(typeof(TActor), NoArgs), DefaultDeploy, NoArgs)
        {
            SupervisorStrategy = supervisorStrategy
        };
    }
