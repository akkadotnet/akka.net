...
public class Config
{
    ...
    ///     This exception is thrown if the given <paramref name="root" /> value is
    ///     undefined.
    /// </exception>
    ...
    ///     if true returns string with current config combined with fallback key-values else only
    ...
    ///     This exception is thrown if the given <paramref name="fallback" /> is a reference
    ///     to this instance.
    /// </exception>
    ...
    {
        return Contains(other.Root.GetObject().Items, "");
    }
