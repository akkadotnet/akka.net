...
namespace Akka.Actor
{
    ...
    public sealed class CompleteTaskReentrant : IAutoReceivedMessage
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="CompleteTaskReentrant" /> class.
        /// </summary>
        /// <param name="state"></param>
        /// <param name="action">The action.</param>
        public CompleteTaskReentrant(AmbientState state, Action action)
        {
            State = state;
            SetResult = action;
        }
        ...
        public override string ToString()
        {
            return "CompleteTaskReentrant - AmbientState: " + State;
        }
    }
