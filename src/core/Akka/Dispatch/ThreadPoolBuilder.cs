...
internal static class DedicatedThreadPoolConfigHelpers
{
    ...
    /// </summary>
    internal static readonly DedicatedThreadPoolSettings DefaultSingleThreadPoolSettings =
        new(1, "DefaultSingleThreadPool");
...
public class ThreadPoolConfig
{
    ...
    ///     TBD
    /// </summary>
    public int PoolSizeMin => _config.GetInt("pool-size-min");

    /// <summary>
    ///     TBD
    /// </summary>
    public double PoolSizeFactor => _config.GetDouble("pool-size-factor");

    /// <summary>
    ///     TBD
    /// </summary>
    public int PoolSizeMax => _config.GetInt("pool-size-max");
