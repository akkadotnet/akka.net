...
public class TestFSMRef<TActor, TState, TData> : TestActorRefBase<TActor> where TActor : FSM<TState, TData>
{
    ...
    public TestFSMRef(ActorSystem system, Props props, IActorRef supervisor = null, string name = null,
    ...
    public TState StateName => UnderlyingActor.StateName;

    /// <summary>Get current state data of this FSM.</summary>
    public TData StateData => UnderlyingActor.StateData;
    ...
    public void SetState(TState stateName, TData stateData, TimeSpan? timeout = null, FSMBase.Reason stopReason = null)
    {
        ...
        InternalRef.Cell.UseThreadContext(() =>
            fsm.ApplyState(new FSMBase.State<TState, TData>(stateName, stateData, timeout, stopReason)));
    }
