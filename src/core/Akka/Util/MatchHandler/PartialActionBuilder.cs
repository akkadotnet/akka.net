...
internal class PartialActionBuilder : IPartialActionBuilder
{
    ...
    ///     16 is the maximum number of args in a Func, see
    ...
    {
        typeof(PartialHandlerArgumentsCapture<>), typeof(PartialHandlerArgumentsCapture<,>),
        typeof(PartialHandlerArgumentsCapture<,,>), typeof(PartialHandlerArgumentsCapture<,,,>),
        typeof(PartialHandlerArgumentsCapture<,,,,>), typeof(PartialHandlerArgumentsCapture<,,,,,>),
        typeof(PartialHandlerArgumentsCapture<,,,,,,>), typeof(PartialHandlerArgumentsCapture<,,,,,,,>),
        typeof(PartialHandlerArgumentsCapture<,,,,,,,,>), typeof(PartialHandlerArgumentsCapture<,,,,,,,,,>),
    ...
    ///     <para>
    ///         If the number of arguments are 0, the delegate should be a
    ///         <see cref="Func{T}">Func&lt;<typeparamref name="T" />,bool&gt;</see>
    ///     </para>
    ///     <para>
    ///         If the number of arguments are 1, the delegate should be a
    ///         <see cref="Func{T,T1}">Func&lt;<typeparamref name="T" />,T1,bool&gt;</see>
    ///     </para>
    ///     <para>...</para>
    ///     <para>
    ///         If the number of arguments are n, the delegate should be a Func&lt;<typeparamref name="T" />,T1,...,Tn,bool
    ///         &gt;
    ///     </para>
    ///     <para>
    ///         The maximum number of arguments i.e. n in the above example is therefore
    ///         <see cref="PartialActionBuilder.MaxNumberOfArguments" />=14
    ///     </para>
    ///     <para>
    ///         Given a delegate deleg of type Func&lt;<typeparamref name="T" />,T1,...,Tn,bool&gt; and args [a_1,...a_n] then
    ...
    /// <param name="handlerAndArgs">
    ///     The handler, i.e. a Func&lt;<typeparamref name="T" />,T1,...,Tn,bool&gt; and arguments
    ///     [a_1,...a_n].
    /// </param>
    /// <returns>
    ...
    ///     This exception is thrown if the number of arguments in the given <paramref name="handlerAndArgs" /> exceeds the
    ///     configured <see cref="MaxNumberOfArguments" />.
    /// </exception>
    public PartialAction<T> Build<T>(CompiledMatchHandlerWithArguments handlerAndArgs)
    {
        ...
        if (numberOfArguments > MaxNumberOfArguments)
            throw new ArgumentException($"Too many arguments. Max {MaxNumberOfArguments} arguments allowed.",
                nameof(handlerAndArgs));
