        ...
        public sealed class Metric : IEquatable<Metric>
        {
            ...
            public static Option<Metric> Create(string name, AnyNumber value)
            {
                return Defined(value)
                    ? new Metric(name, value, CreateEWMA(value, Option<double>.None))
                    : Option<Metric>.None;
            }
            ...
            {
                return Defined(value)
                    ? new Metric(name, value, CreateEWMA(value, decayFactor))
                    : Option<Metric>.None;
            }
            ...
            {
                return value.IsSuccess ? Create(name, value.Success.Value, decayFactor) : Option<Metric>.None;
            }
            ...
            {
                return decayFactor.HasValue ? new EWMA(value.DoubleValue, decayFactor.Value) : Option<EWMA>.None;
            }
            ...
            public static bool Defined(AnyNumber value)
            {
                ...
                if (n is Left<long, double> left)
                    return left.Value >= 0;
                if (n is Right<long, double> right)
