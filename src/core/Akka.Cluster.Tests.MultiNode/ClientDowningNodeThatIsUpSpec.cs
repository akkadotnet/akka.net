...
internal class ClientDowningNodeThatIsUpWithFailureDetectorPuppetMultiNode : ClientDowningNodeThatIsUpSpec
{
    public ClientDowningNodeThatIsUpWithFailureDetectorPuppetMultiNode() : base(true,
        typeof(ClientDowningNodeThatIsUpWithFailureDetectorPuppetMultiNode))
    {
    }
}

internal class ClientDowningNodeThatIsUpWithAccrualFailureDetectorMultiNode : ClientDowningNodeThatIsUpSpec
{
    public ClientDowningNodeThatIsUpWithAccrualFailureDetectorMultiNode() : base(false,
        typeof(ClientDowningNodeThatIsUpWithAccrualFailureDetectorMultiNode))
    {
    }
}
...
public abstract class ClientDowningNodeThatIsUpSpec : MultiNodeClusterSpec
{
    ...
    public void Client_of_4_node_cluster_must_be_able_to_DOWN_a_node_that_is_UP()
    {
        ...
        RunOn(() => { EnterBarrier("down-third-node"); }, _config.Third);
