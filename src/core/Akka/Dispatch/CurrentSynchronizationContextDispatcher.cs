...
/// <summary>
///     Behaves like a <see cref="PinnedDispatcher" /> and always executes using
///     <see cref="CurrentSynchronizationContextExecutorServiceFactory" />
/// </summary>
public sealed class CurrentSynchronizationContextDispatcher : Dispatcher
{
    ...
    private sealed class NoTask : IRunnable
    {
        public void Run()
        {
        }
