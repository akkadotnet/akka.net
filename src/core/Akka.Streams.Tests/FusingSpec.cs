...
public class FusingSpec : AkkaSpec
{
    ...
    [Fact]
    public async Task
        A_SubFusingActorMaterializer_must_use_multiple_actors_when_there_are_asynchronous_boundaries_in_the_subflows_manual()
    {
    ...
    [Fact]
    public async Task
        A_SubFusingActorMaterializer_must_use_multiple_actors_when_there_are_asynchronous_boundaries_in_the_subflows_combinator()
    {
        string RefFunc()
        {
            var bus = (BusLogging)GraphInterpreter.Current.Log;
