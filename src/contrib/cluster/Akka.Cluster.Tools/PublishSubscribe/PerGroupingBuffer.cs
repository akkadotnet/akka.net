...
using Akka.Actor;
using BufferedMessages =
    System.Collections.Generic.List<System.Collections.Generic.KeyValuePair<object, Akka.Actor.IActorRef>>;
...
internal class PerGroupingBuffer
{
    ...
    {
        messages.ForEach(c => { recipient.Tell(c.Key, c.Value); });
    }
}