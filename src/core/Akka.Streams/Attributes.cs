...
public sealed class Attributes
{
    ...
    public IEnumerable<TAttr> GetAttributeList<TAttr>() where TAttr : IAttribute
    {
        return _attributes.Length == 0
            ...
            : _attributes.Where(a => a is TAttr).Cast<TAttr>();
    }
    ...
    {
        return GetAttribute<TAttr>() ?? defaultIfNotFound;
    }
    ...
    {
        return GetFirstAttribute<TAttr>() ?? defaultIfNotFound;
    }
    ...
    {
        return _attributes.LastOrDefault(attr => attr is TAttr) as TAttr;
    }
    ...
    {
        return _attributes.FirstOrDefault(attr => attr is TAttr) as TAttr;
    }
    ...
    {
        return new Attributes(_attributes.Concat(new[] { other }).ToArray());
    }
    ...
    /// <returns>TBD</returns>
    public bool Contains<TAttr>(TAttr attribute) where TAttr : IAttribute
    {
    ...
    {
        return string.IsNullOrEmpty(name) ? None : new Attributes(new Name(Uri.EscapeUriString(name)));
    }
    ...
    ///     <see cref="Akka.Event.LogLevel.DebugLevel" /> for <paramref name="onElement" /> and <paramref name="onFinish" />,
    ///     and <see cref="Akka.Event.LogLevel.ErrorLevel" /> for <paramref name="onError" />.
    /// </summary>
    ...
    {
        return $"Attributes({string.Join(", ", _attributes as IEnumerable<IAttribute>)})";
    }
    ...
    public sealed class Name : IAttribute, IEquatable<Name>
    {
        ...
        public Name(string value)
        {
            if (string.IsNullOrEmpty(value))
                throw new ArgumentNullException(nameof(value), "Name attribute cannot be empty");
            Value = value;
        }

        public bool Equals(Name other)
        {
            return !ReferenceEquals(other, null) && Equals(Value, other.Value);
        }
    ...
    public sealed class InputBuffer : IMandatoryAttribute, IEquatable<InputBuffer>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is InputBuffer buffer && Equals(buffer);
        }
        ...
        public override string ToString()
        {
            return $"InputBuffer(initial={Initial}, max={Max})";
        }
    }
    ...
    public sealed class LogLevels : IAttribute, IEquatable<LogLevels>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is LogLevels levels && Equals(levels);
        }
        ...
        public override string ToString()
        {
            return $"LogLevel(element={OnElement}, finish={OnFinish}, failure={OnFailure})";
        }
    }
    ...
    public sealed class AsyncBoundary : IAttribute, IEquatable<AsyncBoundary>
    {
        ...
        public bool Equals(AsyncBoundary other)
        {
            return other is AsyncBoundary;
        }

        public override bool Equals(object obj)
        {
            return obj is AsyncBoundary;
        }
    ...
    public sealed class CancellationStrategy : IMandatoryAttribute
    {
        ...
        ///     outlets, a race starts whether the cancellation or the error arrives first.If the error arrives first, that's
        ///     usually
        ///     good because then the error can be propagated both on inlets and outlets.However, if the cancellation arrives
        ///     first,
        ...
        ///     such signal is received and cancellation is invoked later on. In streams with many stages that all apply this
        ///     strategy,
        ///     this strategy might significantly delay the propagation of a cancellation signal because each upstream stage might
        ///     impose
        ///     such a delay. During this time, the stream will be mostly "silent", i.e. it cannot make progress because of
        ///     backpressure,
...
public static class ActorAttributes
{
    ...
    {
        return new Attributes(new SupervisionStrategy(strategy));
    }
    ...
    {
        return new Attributes(new DebugLogging(enabled));
    }
    ...
    {
        return new Attributes(new StreamSubscriptionTimeout(timeout, mode));
    }
    ...
    {
        return new Attributes(new OutputBurstLimit(limit));
    }
    ...
    {
        return new Attributes(new FuzzingMode(enabled));
    }
    ...
    {
        return new Attributes(new MaxFixedBufferSize(size));
    }
    ...
    {
        return new Attributes(new SyncProcessingLimit(limit));
    }
    ...
    public sealed class Dispatcher : Attributes.IMandatoryAttribute, IEquatable<Dispatcher>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is Dispatcher dispatcher && Equals(dispatcher);
        }
        ...
        IEquatable<DebugLogging>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is DebugLogging attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"DebugLogging(enabled={Enabled})";
        }
    }
        ...
        IEquatable<StreamSubscriptionTimeout>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is StreamSubscriptionTimeout attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"StreamSubscriptionTimeout(timeout={Timeout.TotalMilliseconds}ms, mode={Mode})";
        }
    }
        ...
        IEquatable<OutputBurstLimit>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is OutputBurstLimit attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"OutputBurstLimit(limit={Limit})";
        }
    }
        ...
        IEquatable<FuzzingMode>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is FuzzingMode attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"FuzzingMode(enabled={Enabled})";
        }
    }
        ...
        IEquatable<MaxFixedBufferSize>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is MaxFixedBufferSize attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"MaxFixedBufferSize(size={Size})";
        }
    }
        ...
        IEquatable<SyncProcessingLimit>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is SyncProcessingLimit attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"SyncProcessingLimit(limit={Limit})";
        }
    }
}
...
public static class StreamRefAttributes
{
    ...
    {
        return new Attributes(new SubscriptionTimeout(timeout));
    }
    ...
    {
        return new Attributes(new BufferCapacity(capacity));
    }
    ...
    {
        return new Attributes(new DemandRedeliveryInterval(timeout));
    }
    ...
    {
        return new Attributes(new FinalTerminationSignalDeadline(timeout));
    }
    ...
    public sealed class SubscriptionTimeout : IStreamRefAttribute, IEquatable<SubscriptionTimeout>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is SubscriptionTimeout attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"SubscriptionTimeout(timeout={Timeout.TotalMilliseconds}ms)";
        }
    }
    ...
    public sealed class BufferCapacity : IStreamRefAttribute, IEquatable<BufferCapacity>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is BufferCapacity attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"BufferCapacity(capacity={Capacity})";
        }
    }
    ...
    public sealed class DemandRedeliveryInterval : IStreamRefAttribute, IEquatable<DemandRedeliveryInterval>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is DemandRedeliveryInterval attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"DemandRedeliveryInterval(timeout={Timeout.TotalMilliseconds}ms)";
        }
    }
    ...
    public sealed class FinalTerminationSignalDeadline : IStreamRefAttribute, IEquatable<FinalTerminationSignalDeadline>
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is FinalTerminationSignalDeadline attr && Equals(attr);
        }
        ...
        public override string ToString()
        {
            return $"FinalTerminationSignalDeadline(timeout={Timeout.TotalMilliseconds}ms)";
        }
    }
}