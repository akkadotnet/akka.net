...
public static partial class TestSubscriber
{
    public partial class ManualProbe<T>
    {
        ...
        {
            return new SubscriberFluentBuilder<T>(this);
        }

        /// <summary>
        ///     Fluent DSL. Expect and return <see cref="ISubscriberEvent" /> (any of: <see cref="OnSubscribe" />,
        ///     <see cref="OnNext" />, <see cref="OnError" /> or <see cref="OnComplete" />).
        /// </summary>
        ...
        ///     FluentDSL. Expect multiple stream elements in arbitrary order during specified timeout.
        /// </summary>
        public ManualProbe<T> ExpectNextUnordered(TimeSpan? timeout, CancellationToken cancellationToken,
            params T[] elems)
        {
        ...
        /// <summary>
        ///     Fluent DSL. Expect subscription followed by immediate stream completion. By default single demand will be signaled
        ///     in order to wake up a possibly lazy upstream
        /// </summary>
