...
public class ShardedDaemonProcessMultiNode : ShardedDaemonProcessSpec
{
    ...
    protected ShardedDaemonProcessMultiNode(ShardedDaemonProcessSpecConfig config) : base(config,
        typeof(ShardedDaemonProcessMultiNode))
    {
    }
}
...
internal class ProcessActor : UntypedActor
{
    ...
    {
        return Actor.Props.Create(() => new ProcessActor(id, probe));
    }
