...
public class LocalConcurrencySpec : TestKit.Xunit2.TestKit
{
    ...
    public sealed class Updater : ReceiveActor, IWithUnboundedStash
    {
        ...
        public Updater()
        {
            ...
            Receive<string>(s =>
            {
                var update = Dsl.Update(Key, ORSet<string>.Empty, WriteLocal.Instance,
                    old => old.Add(cluster.SelfUniqueAddress, s));
