//-----------------------------------------------------------------------
// <copyright file="CommonQueryMapper.cs" company="Akka.NET Project">
...
{
    internal class CommonQueryMapper : ISnapshotQueryMapper
    {
        private readonly Akka.Serialization.Serialization _serialization;

        public CommonQueryMapper(Akka.Serialization.Serialization serialization)
        {
