...
public abstract class ReceiveActor : UntypedActor, IInitializableActor
{
    ...
    ///     <remarks>The actor will be suspended until the task returned by <paramref name="handler" /> completes.</remarks>
    ///     <remarks>
    ///         This method may only be called when constructing the actor or from <see cref="Become(Action)" /> or
    ///         <see cref="BecomeStacked" />.
    ///     </remarks>
    ///     <remarks>
    ///         Note that handlers registered prior to this may have handled the message already.
    ...
    ///     This exception is thrown if this method is called outside of the actor's
    ///     constructor or from <see cref="Become(Action)" />.
    /// </exception>
