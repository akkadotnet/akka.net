...
public abstract class TokenBucket
{
    ...
    /// <summary>
    ///     The current time in ticks. The returned value is monotonic, might wrap over and has no relationship with
    ///     wall-clock.
    /// </summary>
    ...
    ///     be delayed longer in nanoseconds than what can be represented as a positive Long then an undefined value is
    ///     returned.
