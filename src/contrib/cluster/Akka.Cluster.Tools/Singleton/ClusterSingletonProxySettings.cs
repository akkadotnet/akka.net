...
public sealed class ClusterSingletonProxySettings : INoSerializationVerificationNeeded
{
    ...
    ///     <see cref="ClusterSingletonManager" />.
    /// </param>
    ...
    public static ClusterSingletonProxySettings Create(Config config, bool considerAppVersion)
    {
        ...
        return new ClusterSingletonProxySettings(
            config.GetString("singleton-name"),
            role,
            config.GetTimeSpan("singleton-identification-interval"),
            config.GetInt("buffer-size"),
            considerAppVersion);
    }

    /// <summary>
    ///     Creates a new <see cref="ClusterSingletonProxySettings" /> setting with the specified
    ///     <paramref name="singletonName" />.
    ///     <note>
    ...
    /// <summary>
    ///     Creates a new <see cref="ClusterSingletonProxySettings" /> setting with the specified
    ///     <paramref name="singletonIdentificationInterval" />.
    ///     <note>
    ///         This method is immutable and returns a new instance of the setting.
    ///     </note>
    /// </summary>
