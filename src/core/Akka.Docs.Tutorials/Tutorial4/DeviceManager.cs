...
public static partial class MainDeviceGroup
{
    ...
    {
        private readonly Dictionary<IActorRef, string> actorToGroupId = new();
        private readonly Dictionary<string, IActorRef> groupIdToActor = new();
        ...
        {
            return Akka.Actor.Props.Create<DeviceManager>();
        }
    }
}