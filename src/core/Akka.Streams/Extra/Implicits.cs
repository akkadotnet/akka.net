...
public static class TimedSourceDsl
{
    ...
    {
        return TimedOps.Timed(source, measuredOps, onComplete);
    }
    ...
    {
        return (Source<TIn, TMat>)TimedIntervalBetweenOps.TimedIntervalBetween(source, matching, onInterval);
    }
}
...
public static class TimedFlowDsl
{
    ...
    {
        return TimedOps.Timed(flow, measuredOps, onComplete);
    }
    ...
    {
        return (Flow<TIn, TOut, TMat>)TimedIntervalBetweenOps.TimedIntervalBetween(flow, matching, onInterval);
    }
}