...
public class WeightedRouteesSpec : AkkaSpec
{
    ...
    private readonly Address _a1 = new(Protocol, "sys", "a1", 2551);
    private readonly Address _b1 = new(Protocol, "sys", "b1", 2551);
    private readonly Address _c1 = new(Protocol, "sys", "c1", 2551);
    private readonly Address _d1 = new(Protocol, "sys", "d1", 2551);
    ...
    {
        var weights = new Dictionary<Address, int> { [_a1] = 1, [_b1] = 3, [_c1] = 10 }.ToImmutableDictionary();
    ...
    public void WeightedRoutees_should_check_boundaries()
    {
        ...
        var empty2 = new WeightedRoutees(ImmutableArray.Create<Routee>(_routeeA), _a1,
            ImmutableDictionary<Address, int>.Empty.Add(_a1, 0));
    ...
    {
        var weights = new Dictionary<Address, int> { [_a1] = 1, [_b1] = 7 }.ToImmutableDictionary();
        var weighted = new WeightedRoutees(_routees, _a1, weights);
    ...
    {
        var weights = new Dictionary<Address, int> { [_a1] = 2, [_b1] = 1, [_c1] = 10 }.ToImmutableDictionary();
    ...
    {
        var weights = new Dictionary<Address, int> { [_a1] = 0, [_b1] = 2, [_c1] = 10 }.ToImmutableDictionary();
        var weighted = new WeightedRoutees(_routees, _a1, weights);
