...
public class MatchBuilderSignatureTests
{
    ...
    {
        var obj = new object();
        var signature1 = new MatchBuilderSignature(new[] { 4711, "42", obj });
        var signature2 = new MatchBuilderSignature(new[] { 4711, "42", obj });
        Assert.True(signature1.Equals(signature2));
        Assert.True(signature2.Equals(signature1));
    }
    ...
    {
        var signature1 = new MatchBuilderSignature(new object[] { 4711, "42", new() });
