...
{
    private static readonly Regex _nameReplaceRegex = new("[^a-zA-Z0-9]", RegexOptions.Compiled);
    ...
    private static ActorSystemSetup FromActorSystemSetup(ActorSystemSetup setup)
    {
        ...
        bootstrap = bootstrap.WithConfigFallback(AkkaSpecConfig);
    ...
    {
        return ExpectMsgOfAsync(timeout, hint, this, function, cancellationToken)
    ...
    protected async Task<T> ExpectMsgOfAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return await ExpectMsgOfAsync(timeout, hint, this, function, cancellationToken)
    ...
    protected T ExpectMsgOf<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return ExpectMsgOfAsync(timeout, hint, probe, function, cancellationToken)
            .ConfigureAwait(false).GetAwaiter().GetResult();
    }
    ...
    protected async Task<T> ExpectMsgOfAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return await ExpectMsgOfAsync(timeout, hint, probe, o => Task.FromResult(function(o)), cancellationToken)
            .ConfigureAwait(false);
    }
    ...
    protected T ExpectMsgOf<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return ExpectMsgOfAsync(hint, probe, pf, cancellationToken)
            .ConfigureAwait(false).GetAwaiter().GetResult();
    }
    ...
    protected async Task<T> ExpectMsgOfAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return await ExpectMsgOfAsync(hint, probe, o => Task.FromResult(pf(o)), cancellationToken)
            .ConfigureAwait(false);
    }
    ...
    protected T ExpectMsgOf<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return ExpectMsgOfAsync(hint, this, pf, cancellationToken)
            .ConfigureAwait(false).GetAwaiter().GetResult();
    }
    ...
    protected async Task<T> ExpectMsgOfAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return await ExpectMsgOfAsync(hint, this, pf, cancellationToken)
            .ConfigureAwait(false);
    }
    ...
    ///         about the thrown exception other than its type. The recommended usage is to use
    ///         <seealso cref="AssertThrows{T}" />
    ...
    ///     If the passed action does not complete abruptly with an exception that's an instance
