...
public class ORMultiDictionarySpec
{
    ...
    [Fact]
    public void
        ORMultiDictionary_must_be_able_to_have_its_entries_correctly_merged_with_another_ORMultiDictionary_with_other_entries()
    {
    ...
    [Fact]
    public void
        ORMultiDictionary_must_be_able_to_have_its_entries_correctly_merged_with_another_ORMultiDictionary_with_overlaping_entries()
    {
        var m1 = ORMultiValueDictionary<string, string>.Empty
            .AddItem(_node1, "a", "A1")
            .AddItem(_node1, "b", "B1")
    ...
    [Fact]
    public void
        ORMultiDictionary_must_be_able_to_have_its_entries_correctly_merged_with_another_ORMultiDictionary_with_overlaping_entries_2()
    {
        var m1 = ORMultiValueDictionary<string, string>.Empty
            .AddItem(_node1, "b", "B1");
    ...
    [Fact]
    public void
        ORMultiDictionary_must_be_able_to_get_all_bindings_for_an_entry_and_then_reduce_them_upon_putting_them_back()
    {
        var m = ORMultiValueDictionary<string, string>.Empty
            .AddItem(_node1, "a", "A1")
            .AddItem(_node1, "a", "A2")
    ...
    [Fact]
    public void
        ORMultiDictionary_must_work_with_tombstones_for_ORMutliValueDictionary_WithValueDeltas_and_its_delta_delta_operations()
    {
        {
