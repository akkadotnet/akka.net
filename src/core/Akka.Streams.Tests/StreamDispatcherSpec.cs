...
public class StreamDispatcherSpec : AkkaSpec
{
    [Fact]
    public void
        The_default_blocking_io_dispatcher_for_streams_must_be_the_same_as_the_default_blocking_io_dispatcher_for_actors()
    {
    ...
    [Fact]
    public void
        The_deprecated_default_stream_io_dispatcher_must_be_the_same_as_the_default_blocking_io_dispatcher_for_actors()
    {
        var materializer = ActorMaterializer.Create(Sys);
