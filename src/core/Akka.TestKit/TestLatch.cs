...
/// <summary>
///     <para>
///         A count down latch that initially is closed. In order for it to become open <see cref="CountDown" /> must be
///         called.
///         By default one call is enough, but this can be changed by specifying the count in the constructor.
///     </para>
...
///         timeout from <see cref="TestKitSettings.DefaultTimeout" /> is used and all timeouts are dilated, i.e.
///         multiplied by
...
public class TestLatch
{
    ...
    /// </summary>
    public bool IsOpen => _latch.CurrentCount == 0;
