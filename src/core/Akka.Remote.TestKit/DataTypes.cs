...
public sealed class RoleName : IEquatable<RoleName>
{
    ...
    {
        return obj is RoleName role && Equals(role);
    }
...
internal interface IToClient
{
    object Msg { get; }
}

internal class ToClient<T> : IToClient where T : IClientOp, INetworkOp
{
...
internal sealed class BarrierResult : IUnconfirmedClientOp, INetworkOp
{
    ...
    private bool Equals(BarrierResult other)
    {
...
internal sealed class Throttle : ICommandOp
{
    ...
    private bool Equals(Throttle other)
    {
        return Equals(Node, other.Node) && Equals(Target, other.Target) && Equals(Direction, other.Direction) &&
               RateMBit.Equals(other.RateMBit);
    }
...
internal sealed class ThrottleMsg : IConfirmedClientOp, INetworkOp
{
    ...
    private bool Equals(ThrottleMsg other)
    {
...
internal sealed class Disconnect : ICommandOp
{
    ...
    private bool Equals(Disconnect other)
    {
...
internal sealed class DisconnectMsg : IConfirmedClientOp, INetworkOp
{
    ...
    private bool Equals(DisconnectMsg other)
    {
...
internal sealed class Terminate : ICommandOp
{
    ...
    private bool Equals(Terminate other)
    {
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            return ((Node != null ? Node.GetHashCode() : 0) * 397) ^
                   (ShutdownOrExit != null ? ShutdownOrExit.GetHashCode() : 0);
        }
    }
...
internal sealed class TerminateMsg : IConfirmedClientOp, INetworkOp
{
    ...
    private bool Equals(TerminateMsg other)
    {
...
internal sealed class GetAddress : IServerOp, INetworkOp
{
    ...
    private bool Equals(GetAddress other)
    {
...
internal sealed class AddressReply : IUnconfirmedClientOp, INetworkOp
{
    ...
    private bool Equals(AddressReply other)
    {
...
internal sealed class Remove : ICommandOp
{
    ...
    private bool Equals(Remove other)
    {
        return Equals(Node, other.Node);
    }
