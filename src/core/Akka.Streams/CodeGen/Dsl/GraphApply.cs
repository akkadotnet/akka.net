...
{
    /// <summary>
    ///     Creates a new <see cref="IGraph{TShape, TMat}" /> by passing a <see cref="Builder{TMat}" /> to the given create
    ///     function.
    /// </summary>
    ...
    public static IGraph<TShape, NotUsed> Create<TShape>(Func<Builder<NotUsed>, TShape> buildBlock)
        where TShape : Shape
    {
        return CreateMaterialized(buildBlock);
    }
    ...
    public static IGraph<TShape, TMat> CreateMaterialized<TShape, TMat>(Func<Builder<TMat>, TShape> buildBlock)
        where TShape : Shape
    {
    ...
    /// <param name="buildBlock">Graph construction function.</param>
    /// <returns>A graph with materialized value.</returns>
    public static IGraph<TShapeOut, TMat> Create<TShapeOut, TMat, TShape1>(IGraph<TShape1, TMat> g1,
        Func<Builder<TMat>, TShape1, TShapeOut> buildBlock)
    ...
    /// <summary>
    ///     Creates a new <see cref="IGraph{TShape, TMat}" /> by importing the given graphs and passing their
    ///     <see cref="Shape" />s
    ...
    /// <param name="combineMaterializers">
    ///     Function used to determine output materialized value based on the materialized
    ///     values of the passed graphs.
    /// </param>
        ...
        where TShape2 : Shape
    {
        ...
        var shape0 =
            builder.Add<TShape0, TMat0, Func<TMat1, Func<TMat2, TMatOut>>>(g0,
                m0 => m1 => m2 => combineMaterializers(m0, m1, m2));
        var shape1 =
            builder.Add<TShape1, Func<TMat1, Func<TMat2, TMatOut>>, TMat1, Func<TMat2, TMatOut>>(g1, (f, m1) => f(m1));
    ...
    /// <param name="buildBlock">A graph constructor function.</param>
    /// <returns>A graph with materialized value.</returns>
    public static IGraph<TShapeOut, TMatOut> Create<TShapeOut, TMatOut, TMat0, TMat1, TMat2, TMat3, TShape0, TShape1,
        TShape2, TShape3>(
        ...
        where TShape3 : Shape
    {
        ...
        var shape0 = builder.Add<TShape0, TMat0, Func<TMat1, Func<TMat2, Func<TMat3, TMatOut>>>>(g0,
            m0 => m1 => m2 => m3 => combineMaterializers(m0, m1, m2, m3));
        var shape1 =
            builder
                .Add<TShape1, Func<TMat1, Func<TMat2, Func<TMat3, TMatOut>>>, TMat1, Func<TMat2, Func<TMat3, TMatOut>>>(
                    g1, (f, m1) => f(m1));
        var shape2 =
            builder.Add<TShape2, Func<TMat2, Func<TMat3, TMatOut>>, TMat2, Func<TMat3, TMatOut>>(g2, (f, m2) => f(m2));
    ...
    /// <param name="buildBlock">A graph constructor function.</param>
    /// <returns>A graph with materialized value.</returns>
    public static IGraph<TShapeOut, TMatOut> Create<TShapeOut, TMatOut, TMat0, TMat1, TMat2, TMat3, TMat4, TShape0,
        TShape1, TShape2, TShape3, TShape4>(
        IGraph<TShape0, TMat0> g0, IGraph<TShape1, TMat1> g1, IGraph<TShape2, TMat2> g2, IGraph<TShape3, TMat3> g3,
        ...
        where TShape4 : Shape
    {
        ...
        var shape0 = builder.Add<TShape0, TMat0, Func<TMat1, Func<TMat2, Func<TMat3, Func<TMat4, TMatOut>>>>>(g0,
            m0 => m1 => m2 => m3 => m4 => combineMaterializers(m0, m1, m2, m3, m4));
        var shape1 =
            builder
                .Add<TShape1, Func<TMat1, Func<TMat2, Func<TMat3, Func<TMat4, TMatOut>>>>, TMat1,
                    Func<TMat2, Func<TMat3, Func<TMat4, TMatOut>>>>(g1, (f, m1) => f(m1));
        var shape2 =
            builder
                .Add<TShape2, Func<TMat2, Func<TMat3, Func<TMat4, TMatOut>>>, TMat2, Func<TMat3, Func<TMat4, TMatOut>>>(
                    g2, (f, m2) => f(m2));
        var shape3 =
            builder.Add<TShape3, Func<TMat3, Func<TMat4, TMatOut>>, TMat3, Func<TMat4, TMatOut>>(g3, (f, m3) => f(m3));
